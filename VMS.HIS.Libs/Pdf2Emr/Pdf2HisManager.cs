...
namespace VMS.HIS.Bus
{
    public class Pdf2HisManager
    {
        ...
        public void AddItems(Pdf2emrItem _newItem)
        {
            try
            {
        ...
        public void AddItems2Queu(Pdf2emrItem _newItem)
        {
            try
            {
                queue.Enqueue(_newItem);
        ...
        void _BackgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                while (true)
                {
                    ...
                    if (queue.Count > 0)
                    {
                        Pdf2emrItem item = queue.Dequeue() as Pdf2emrItem;
                        item.DoPdf(log);
        ...
        void Try2ClearItems(Pdf2emrItem item)
        {
            try
            {
