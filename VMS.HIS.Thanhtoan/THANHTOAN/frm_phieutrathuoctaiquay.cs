...
{
    public partial class frm_phieutrathuoctaiquay : Form
    {
        ...
        public frm_phieutrathuoctaiquay()
        {
            InitializeComponent();
            Utility.SetVisualStyle(this);
            setProperties();
            this.KeyDown+=new KeyEventHandler(frm_phieutrathuoctaiquay_KeyDown);
        ...
        {
            new INPHIEU_THANHTOAN_NGOAITRU().InBienlaiPhieuChiTralaiThuoc(true, v_Payment_Id,-1, objLuotkham, Utility.ByteDbnull(objLuotkham.Noitru, 0));
        }

        void cmdInBienlai_Click(object sender, EventArgs e)
        {
            //new INPHIEU_THANHTOAN_NGOAITRU().InBienlaiPhieuChi(false, v_Payment_Id, objLuotkham,0);

            new INPHIEU_THANHTOAN_NGOAITRU().InBienlaiPhieuChiTralaiThuoc(false, v_Payment_Id,-1, objLuotkham, Utility.ByteDbnull(objLuotkham.Noitru, 0));
        }
        ...
        /// <param name="e"></param>
        private void frm_phieutrathuoctaiquay_Load(object sender, EventArgs e)
        {
        ...
        {
            m_dtPaymentDetail = _THANHTOAN.Laychitietphieuchiquaythuoc(v_Payment_Id, (byte)1);
       ...
       public decimal Chuathanhtoan = 0m;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_phieutrathuoctaiquay_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cmdPrint_Click(object sender, EventArgs e)
        {
            ...
            if (objPayment != null)
            {
                ...
                {
                    frm_Chondanhmucdungchung _Chondanhmucdungchung = new frm_Chondanhmucdungchung("LYDOHUYTRALAITIEN", "Hủy trả lại tiền Bệnh nhân", "Nhập lý do hủy trả lại tiền trước khi thực hiện...", "Lý do hủy trả lại tiền",false);
