...
namespace VNS.HIS.UI.THANHTOAN
{
    public partial class frm_PhanbotientheoPTTT : Form
    {
        ...
        void cmdAccept_Click(object sender, EventArgs e)
        {
            ...
            string errMsg = "";
            if (_THANHTOAN.UpdateTienphanbotheoPttt(arrDr, objLuotkham, id_thanhtoan, id_phieuthu, id_tamung, txtPttt_chung.MyCode,autoNganhangchung.Enabled? autoNganhangchung.myCode:"-1", ref errMsg) != ActionResult.Success)
            {
        ...
        private void GetData()
        {
            try
            {
                m_dtData = _THANHTOAN.KcbThanhtoanLaydulieuphanbothanhtoanTheoPttt(id_thanhtoan,id_phieuthu,id_tamung);
                BoDulieuPTTTPhanBo();
                m_dtData.AcceptChanges();
