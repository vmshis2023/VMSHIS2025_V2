    ...
    public partial class frm_THANHTOAN_NOITRU_V1 : Form
    {
        ...
        void InitEvents()
        {
          ...
          //  cmdChuyenCLS.Click += new EventHandler(cmdChuyenCLS_Click);
            ...
            cboChuongtrinhKM.SelectedIndexChanged += cboChuongtrinhKM_SelectedIndexChanged;
            ...
            try
            {
                ...
                if (cmdHoanung.Tag.ToString() == "0")//Hoàn ứng
                {
                    ...
                    string maphieu = THU_VIEN_CHUNG.SinhmaVienphi("HKQ");
                        SPs.NoitruHoanung(-1,-1l,maphieu, objLuotkham.MaLuotkham, objLuotkham.IdBenhnhan, dtPaymentDate.Value,
                ...
                else
                {
                    ...
                    SPs.NoitruHuyhoanung(objLuotkham.MaLuotkham, objLuotkham.IdBenhnhan, -1,-1l, (byte)1).Execute();
                    cmdHoanung.Tag = "0";
        ...
        void cmdInBienlaiTonghop_Click(object sender, EventArgs e)
        {
          ...
          new INPHIEU_THANHTOAN_NGOAITRU().InBienlai(true, _Payment_ID,-1,objLuotkham,1);
        }
        ...
        void cmdInBienlai_Click(object sender, EventArgs e)
        {
            ...
            if (kieuthanhtoan == 0 || kieuthanhtoan == 5)
            {
                if (chkIntonghop.Visible && chkIntonghop.Checked)
                    ...
                    new INPHIEU_THANHTOAN_NGOAITRU().InBienlai(false, _Payment_ID,-1, objLuotkham, 1);
            }
        ...
        private void ModifyCommand()
        {
            try
            {
                ...
                if (cauhinhtaichinhduyet)
                    pnlTaichinhxetduyet.Enabled = objLuotkham!=null && objLuotkham.TrangthaiNoitru >= 3 && objLuotkham.TthaiThopNoitru >= 1 && objLuotkham.TrangthaiNoitru <= 5;//Chưa thanh toán
                else
                    pnlTaichinhxetduyet.Enabled = false;

                bool taichinhxetduyet = cauhinhtaichinhduyet && objLuotkham != null && objLuotkham.TrangthaiNoitru == 5;
        ...
        private void KiemTraDaInPhoiBhyt()
        {
            SqlQuery sqlQuery = new Select().From(KcbPhieuDct.Schema)
                ...
                .And(KcbPhieuDct.Columns.KieuThanhtoan).IsEqualTo(Utility.Int32Dbnull(KieuThanhToan.NoiTru));
        ...
        private void SetSumTotalProperties_bak()
        {
            try
            {
                if (objLuotkham == null)
        ...
        private void SetSumTotalProperties_bak240901()
        {
            try
            {
                if (objLuotkham == null)
                ...
                //    }
                //}
                txtPtramBHChiTra.Text = Ptram_bhyt_cu.ToString();
                foreach (DataRowView drv in m_dtChiPhiThanhtoan.DefaultView)
                {
                    if (Utility.Int32Dbnull(drv["tinh_chiphi"], 0) == 1 && Utility.Int32Dbnull(drv["trangthai_huy"], 0) == 0 && Utility.Int32Dbnull(drv["tthai_tamthu"], 0) == 0)
                    {
                ...
                {
                    ptram_BHYT_moi = THU_VIEN_CHUNG.BHYT_TinhlaiPhantramTheoTongchiPhi(objLuotkham, tt);
                    if (Ptram_bhyt_cu != ptram_BHYT_moi)
                    {
                        txtPtramBHChiTra.Text = ptram_BHYT_moi.ToString();
                        tt_bhyt = tt * ptram_BHYT_moi;
                        tt_bn_cct = tt_bhyt - tt_khac;
                        if (ptram_BHYT_moi == 100)
                            tt_bn_ttt = 0;
                        if (THU_VIEN_CHUNG.Laygiatrithamsohethong("BHYT_CACHTINH_TONGTIEN_BN_PHAITRA", "1", true) == "1")
                            TT_BN = tt - tt_bhyt - tt_nguonkhac;//Hoặc =tt_bn_cct+tt_phuthu+tt_tutuc
                        else
                            TT_BN = tt_bn_cct + tt_phuthu + tt_tutuc;
                    }
                }
                txtTongChiPhi.Text = Utility.sDbnull(tt);
                txtTongtienDCT.Text = !THU_VIEN_CHUNG.IsBaoHiem(objLuotkham.IdLoaidoituongKcb) ? "0" : Utility.sDbnull(tt_bhyt);
        ...
        private void cboChuongtrinhKM_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                GoiDanhsach objCTKM = GoiDanhsach.FetchByID(Utility.Int32Dbnull(cboChuongtrinhKM.SelectedValue, -1));
        ...
        private void LaydanhsachLichsuthanhtoan_phieuchi()
        {
            try
            {
             ...
             DataTable   dtData =
                    _THANHTOAN.LaythongtinCacLanthanhtoan(Utility.sDbnull(txtPatient_Code.Text, ""),
                        Utility.Int32Dbnull(txtPatient_ID.Text, -1), -1, v_bytNoitru, 0,
             ...
             DataRow[] arrDR = dtData.Select("Kieu_ThanhToan = 0");
                ...
                decimal tongtien_tralai = m_dtPhieuChi == null || m_dtPhieuChi.Columns.Count <= 0 ? 0m : Utility.DecimaltoDbnull(m_dtPhieuChi.Compute("SUM(THUC_THU)", "noi_tru=1"), 0);
                        ...
                        case ActionResult.Success:
                            ...
                            if (IN_HOADON && chkTudonginhoadonsauthanhtoan.Checked)
                            {
                                ...
                                if (kcbThanhtoanKieuinhoadon == 2 || kcbThanhtoanKieuinhoadon == 3)
                                    new INPHIEU_THANHTOAN_NGOAITRU().InBienlai(false, v_Payment_ID,-1, objLuotkham, 1);
                            }
        ...
        void ModifyHoanUngButtons()
        {
            ...
            if (objLuotkham != null) objTamung = new Select().From(NoitruTamung.Schema)
            ...
            //}
            cmdHoanung.Text = objLuotkham!=null && objTamung == null ? "Hoàn ứng" : "Hủy hoàn ứng";
            cmdHoanung.Tag = objLuotkham != null && objTamung == null ? "0" : "1";
        ...
        private KcbThanhtoan TaophieuThanhtoan()
        {
            ...
            objPayment.MaVoucher = Utility.sDbnull(txtMaVoucher.Text, "");
            objPayment.IdCtrinhKhuyenmai = Utility.Int32Dbnull(cboChuongtrinhKM.SelectedValue, -1);
            objPayment.TienChietkhauVoucher = Utility.DecimaltoDbnull(txtTienKhuyenmai.Text, 0);
            objPayment.MucHuongBhyt = objLuotkham.MucHuongBhyt;
            ...
            objPayment.ThuaThieu = tongtien_thuathieu;
            return objPayment;
        }
        ...
        private bool IsValidata()
        {
            ...
            if (THU_VIEN_CHUNG.Laygiatrithamsohethong("THANHTOAN_CHOPHEP_0_DONG", true) == "0")
            {
                ...
                {
                    Utility.ShowMsg("Hệ thống chỉ cho phép thanh toán khi số tiền thu phải > 0 (THANHTOAN_CHOPHEP_0_DONG). Mời bạn kiểm tra lại", "Thông báo", MessageBoxIcon.Warning);
                    return false;
                }
            }
            ...
            {
                Utility.ShowMsg("Bệnh nhân chưa được duyệt thanh toán nội trú (NOITRU_TAICHINH_DUYET_TRUOCKHITHANHTOAN = 1) nên không thể thanh toán. Đề nghị bạn kiểm tra lại");
                return false;
            }
            ...
            if (THU_VIEN_CHUNG.Laygiatrithamsohethong("NOITRU_TUDONGHOANUNG_KHITHANHTOANNOITRU", "0", false) == "0")
            {
                ...
                if (objTamung != null)
                {
                    Utility.ShowMsg("Bạn cần thực hiện thao tác hoàn ứng bằng tay (hoặc đặt NOITRU_TUDONGHOANUNG_KHITHANHTOANNOITRU=1) cho bệnh nhân trước khi thực hiện thanh toán nội trú");
                    return false;
                }
            }
        ...
        private void grdPayment_ColumnButtonClick(object sender, ColumnActionEventArgs e)
        {
            try
            {
                ...
                else if (e.Column.Key == "cmdHUY_PHIEUTHU")
                {
                    ...
                    {
                        tabThongTinCanThanhToan.SelectedTab = TabPageTamung;
                    }
                    else
                    {
            ...
            //    else
            //    {
            //        if (kieu_thanhtoan == "10" || kieu_thanhtoan == "20")
            //        {
            //            Utility.ShowMsg("Chức năng Hủy này chỉ được áp dụng cho chứng từ thanh toán(Phiếu thu). Đề nghị bạn chọn lại");
            //            return;
            //        }
            //        else
            //        {
        ...
        string ma_lydohuy = "";
        string lydo_huy = "";
        private void HuyThanhtoan(KcbThanhtoan objPayment)
        {
            try
            {
                ma_lydohuy = "";
        ...
        private void InPhoiBhyt()
        {
            try
            {
                if (new BHYT_InPhieu().InPhoiBHYT(objLuotkham, pnlSuangayinphoi.Visible ? dtNgayInPhoi.Value : dtPaymentDate.Value, "BHYT_InPhoi_02"))
                {
                    cbomayinphoiBHYT.Text = PropertyLib._MayInProperties.TenMayInBienlai;
                    // LaydanhsachLichsuthanhtoan_phieuchi();
                    KiemTraDaInPhoiBhyt();
            ...
            try
            {
                ...
                else//Thực hiện hoàn ứng và in phiếu hoàn ứng
                {
                    ...
                    if (Utility.AcceptQuestion(string.Format("Bạn có chắc chắn muốn hoàn ứng cho người bệnh {0}", txtTenBenhNhan.Text), "Thông báo", true))
                    {
                        ...
                        if (objTT != null)
                        {
                            SPs.NoitruHoanung(-1,id_thanhtoan, maphieu, objLuotkham.MaLuotkham, objLuotkham.IdBenhnhan, objTT.NgayThanhtoan,
                        globalVariables.gv_intIDNhanvien, globalVariables.UserName,
                        Utility.Int32Dbnull(objLuotkham.IdKhoanoitru, -1), Utility.Int64Dbnull(objLuotkham.IdRavien, -1),
                        Utility.Int32Dbnull(objLuotkham.IdBuong, -1), Utility.Int32Dbnull(objLuotkham.IdGiuong, -1),
                        (byte)1, "TM", "").Execute();
        ...
        private void mnuInchiphichuathanhtoan_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dtData = SPs.NoitruTonghopChiphiRavien(objLuotkham.MaLuotkham, (int)objLuotkham.IdBenhnhan, 1, "-1", "-1",0).GetDataSet().Tables[0];
        ...
        private void ctxHuyChietkhau_Opening(object sender, CancelEventArgs e)
        {

        }

        private void mnu_capnhat_tendichvu_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void mnu_baocao_congno_phaithu_Click(object sender, EventArgs e)
        {
        ...
        private void mnu_Inbangke_vtth_Click(object sender, EventArgs e)
        {
        ...
        private void mnu_inbangkechiphi_donthuocravien_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dtData = SPs.NoitruTonghopChiphiRavien(objLuotkham.MaLuotkham, (int)objLuotkham.IdBenhnhan, 0, "-1", "-1", 1).GetDataSet().Tables[0];
                new INPHIEU_THANHTOAN_NGOAITRU().Inbienlai_DichvuChuathanhtoan(dtData, true, 1);
            }
            catch (Exception ex)
            {
        ...
        private void mnu_phieucongkhai_vtth_Click(object sender, EventArgs e)
        {
            try
            {
