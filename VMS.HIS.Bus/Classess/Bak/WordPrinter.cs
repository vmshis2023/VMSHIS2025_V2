 ...
 namespace VMS.HIS.Bus
{
    public class WordPrinter
    {
            ...
            try
            {
               ...
               Utility.CreateMergeFields(dtData);
                ...
                if ((drData != null) && File.Exists(PathDoc))
                {
                    ...
                    if (returnFile)
                    {
                        //Chuyển file này thành PDF để có mã vạch
                        Microsoft.Office.Interop.Word.Application word = new Microsoft.Office.Interop.Word.Application();
                        Microsoft.Office.Interop.Word.Document doc1 = word.Documents.Open(fileKetqua);
                        fileKetqua = fileKetqua.Replace(".doc", ".pdf");
                        doc1.Activate();
                        doc1.SaveAs2(fileKetqua, Microsoft.Office.Interop.Word.WdSaveFormat.wdFormatPDF);
                        doc1.Close();
                      return fileKetqua;
                    }
        ...
        class HandleMergeBarcode : IFieldMergingCallback
        {
            ...
            {
                if (e.FieldName.ToUpper() == "MA_LUOTKHAM")
                {
                    ...
                    //barcode.LabelFont = new System.Drawing.Font("Arial", 10); // Font của text dưới
                    //barcode.Alignment = AlignmentPositions.CENTER;
                    //barcode.Width = 150; // Chiều rộng (px)
                    //barcode.Height = 50; // Chiều cao (px)
                    //barcode.Encode(TYPE.CODE39, ma);
                    ...
                    //    Shape image = builder.InsertImage(stream);

                    //    // Tùy chỉnh kích thước ảnh
                    //    image.Width = 100;  // nhỏ lại cho vừa
                    //    image.Height = 40;
                    //}
