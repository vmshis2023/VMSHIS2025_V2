  ...
  public  class CommonLoadDuoc
    {
     ...
     /// 
     /// </summary>
      /// <param name="noitru_ngoaitru">"TATCA,NOITRU,NGOAITRU"</param>
      /// <param name="kieuthuoc_vt">,"THUOC,THUOCVT,VT"</param>
      /// <param name="chan_le">"LE,CHANLE,CHAN"</param>
     /// <param name="trang_thai"></param>
     /// <returns></returns>
      public static DataTable LAYDANHMUCKHOTHEOTANG(Int16 idkhoadieutri, Int16 idphongdieutri, string noitru_ngoaitru, string kieuthuoc_vt, string chan_le, byte LaTuthuoc, byte laquaythuoc, byte trang_thai)
      {
          try
          {
              
              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtth(idkhoadieutri, idphongdieutri,noitru_ngoaitru, kieuthuoc_vt, chan_le, LaTuthuoc, laquaythuoc, trang_thai, Utility.Bool2byte(globalVariables.IsAdmin), globalVariables.gv_intIDNhanvien,100, globalVariables.UserName, "ALL").GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception)
          {
      ...
      public static DataTable LAYDANHMUCKHO_THEOKHOA(Int16 idkhoadieutri, Int16 idphongdieutri, string noitru_ngoaitru, string kieuthuoc_vt, byte LaTuthuoc, byte Laquaythuoc, byte capcuu, string ma_doituongkcb)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtthTheokhoa(idkhoadieutri, idphongdieutri, noitru_ngoaitru, kieuthuoc_vt, LaTuthuoc, Laquaythuoc, capcuu, ma_doituongkcb).GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception ex)
          {
      ...
      /// 
      /// </summary>
      /// <param name="idkhoadieutri"></param>
      /// <param name="idphongdieutri"></param>
      /// <param name="noitru_ngoaitru"></param>
      /// <param name="kieuthuoc_vt"></param>
      /// <param name="LaTuthuoc"></param>
      /// <param name="capcuu"></param>
      /// <returns></returns>
      public static DataTable LAYDANHMUCKHO_THEOKHOA(Int16 idkhoadieutri, Int16 idphongdieutri, string noitru_ngoaitru, string kieuthuoc_vt, byte LaTuthuoc, byte capcuu)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtthTheokhoa(idkhoadieutri, idphongdieutri, noitru_ngoaitru, kieuthuoc_vt, LaTuthuoc, 100, capcuu, "ALL").GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception ex)
          {
      ...
      public static DataTable LAYDANHMUCKHO_THEOKHOA(Int16 idkhoadieutri, Int16 idphongdieutri, string noitru_ngoaitru, string kieuthuoc_vt, byte LaTuthuoc, byte capcuu, string ma_doituongkcb)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtthTheokhoa(idkhoadieutri, idphongdieutri, noitru_ngoaitru, kieuthuoc_vt, LaTuthuoc, 100, capcuu, ma_doituongkcb).GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception ex)
          {
      ...
      public static DataTable LAYDANHMUCKHO_THEOKHOA(Int16 idkhoadieutri, Int16 idphongdieutri, string kieuthuoc_vt, byte LaTuthuoc, byte capcuu, string ma_doituongkcb)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtthTheokhoa(idkhoadieutri, idphongdieutri, "ALL", kieuthuoc_vt, LaTuthuoc, 100, capcuu, ma_doituongkcb).GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception ex)
          {
      ...
      public static DataTable LAYDANHMUCKHO_THEOKHOA(Int16 idkhoadieutri, Int16 idphongdieutri, string kieuthuoc_vt, byte LaTuthuoc, byte Laquaythuoc, byte capcuu,string ma_doituongkcb)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtthTheokhoa(idkhoadieutri, idphongdieutri, "ALL", kieuthuoc_vt, LaTuthuoc, Laquaythuoc, capcuu, ma_doituongkcb).GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception ex)
          {
      ...
      public static DataTable LAYDANHMUCKHO(Int16 idkhoadieutri, string noitru_ngoaitru, string kieuthuoc_vt, string chan_le, byte LaTuthuoc, byte laquaythuoc, byte trang_thai)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtth(idkhoadieutri, -1, noitru_ngoaitru, kieuthuoc_vt, chan_le, LaTuthuoc, laquaythuoc, trang_thai, Utility.Bool2byte(globalVariables.IsAdmin), globalVariables.gv_intIDNhanvien, 100, globalVariables.UserName, "ALL").GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception)
          {
      ...
      public static DataTable LAYDANHMUCKHO(Int16 idkhoadieutri, string noitru_ngoaitru, string kieuthuoc_vt, string chan_le, byte LaTuthuoc, byte laquaythuoc, byte trang_thai,byte capcuu)
      {
          try
          {

              DataTable dtData = SPs.ThuocLaydanhmucKhothuocvtth(idkhoadieutri, -1, noitru_ngoaitru, kieuthuoc_vt, chan_le, LaTuthuoc, laquaythuoc, trang_thai, Utility.Bool2byte(globalVariables.IsAdmin), globalVariables.gv_intIDNhanvien, capcuu, globalVariables.UserName, "ALL").GetDataSet().Tables[0];
              return dtData;
          }
          catch (Exception)
          {
      ...
      public static DataTable LAYTHONGTIN_QUAYTHUOC()
      {
          ...
          //if (!globalVariables.IsAdmin)//Có thể bỏ đối với quầy thuốc
          //{
      ...
      /// </summary>
      /// <returns></returns>
      public static DataTable LAYTHONGTIN_KHOVTTH_LE_NOITRU()
      {
          DataTable m_dtKhoThuoc = new DataTable();
          SqlQuery sqlQuery = new Select().From(TDmucKho.Schema);
          if (!globalVariables.IsAdmin)
      ...
      /// </summary>
      /// <returns></returns>
      public static DataTable LAYTHONGTIN_KHOTHUOC_LE_TUTRUC_NOITRU(string kieuthuoc_vt)
      {
          DataTable m_dtKhoThuoc = new DataTable();
          SqlQuery sqlQuery = new Select().From(TDmucKho.Schema);
          if (!globalVariables.IsAdmin)
      ...
      /// </summary>
      /// <returns></returns>
      public static DataTable LAYTHONGTIN_KHOVTTH_LE_NGOAITRU()
      {
          DataTable m_dtKhoThuoc = new DataTable();
          SqlQuery sqlQuery = new Select().From(TDmucKho.Schema);
          if (!globalVariables.IsAdmin)
      ...
      public static DataTable LayThongTinThuoc(string KieuThuocVT)
      {
          ...
          if (KieuThuocVT == "ALL")
              dataTable = new Select().From(VDmucThuoc.Schema).Where(VDmucThuoc.Columns.TrangThai).IsEqualTo(1).ExecuteDataSet().Tables[0];
          else
              dataTable = new Select().From(VDmucThuoc.Schema).Where(VDmucThuoc.Columns.KieuThuocvattu).IsEqualTo(KieuThuocVT).And(VDmucThuoc.Columns.TrangThai).IsEqualTo(1).ExecuteDataSet().Tables[0];
          return dataTable;
      }
      ...
      /// <returns></returns>
      public static decimal SoLuongTonTrongKho( long id_donthuoc,int idkho, int id_thuoc,long id_thuockho, int? Kiemtrachoxacnhan,byte noitru)
      {
          decimal soluongton = 0;

          StoredProcedure sp = SPs.ThuocKiemtrasoluongTonkho2023(id_donthuoc,id_thuoc, idkho,id_thuockho, Kiemtrachoxacnhan,noitru, soluongton, 0);
          sp.Execute();
          soluongton = Utility.DecimaltoDbnull(sp.OutputValues[0], 0m);


          return soluongton;
      }
        public static decimal SoLuongTonTrongKho_phatthuoc(long id_donthuoc, int idkho, int id_thuoc, long id_thuockho, int? Kiemtrachoxacnhan, byte noitru)
        {
            decimal soluongton = 0;

            StoredProcedure sp = SPs.ThuocKiemtrasoluongTonkho2023(id_donthuoc, id_thuoc, idkho, id_thuockho, Kiemtrachoxacnhan, noitru, soluongton, 1);
            sp.Execute();
            soluongton = Utility.DecimaltoDbnull(sp.OutputValues[0], 0m);
