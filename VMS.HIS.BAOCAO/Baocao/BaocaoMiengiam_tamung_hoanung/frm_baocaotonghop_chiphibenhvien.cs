...
{
    public partial class frm_baocaotonghop_chiphibenhvien : Form
    {
        ...
        string args = "ALL";
        public frm_baocaotonghop_chiphibenhvien(string args)
        {
            InitializeComponent();
        ...
        void Initevents()
        {
            this.KeyDown += new KeyEventHandler(frm_baocaotonghop_chiphibenhvien_KeyDown);
            ...
            this.Load += new System.EventHandler(this.frm_baocaotonghop_chiphibenhvien_Load);
           
        }

       
       
        private void frm_baocaotonghop_chiphibenhvien_Load(object sender, EventArgs eventArgs)
        {
            try
            {
                baocaO_TIEUDE1.Init("baocao_tonghopchiphi_benhvien");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocaotonghop_chiphibenhvien_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cmdInPhieuXN_Click(object sender, EventArgs e)
        {
            ...
            _dtData = BAOCAO_NGOAITRU.BaocaoTonghopchiphiBenhvien(Utility.Int16Dbnull(txtNhanvien.MyID, -1), 
            ...
            THU_VIEN_CHUNG.CreateXML(_dtData, "baocao_tonghopchiphi_benhvien.xml");
            ...
            var crpt = Utility.GetReport("baocao_tonghopchiphi_benhvien", ref tieude, ref reportname);
            if (crpt == null) return;
            ...
            try
            {
                ...
                objForm.mv_sReportCode = "baocao_tonghopchiphi_benhvien";
                ...
                Utility.SetParameterValue(crpt, "Tongtien_chu", new MoneyByLetter().sMoneyToLetter(_dtData.Compute("SUM(TONG_CHIPHI)", "1=1").ToString()));
