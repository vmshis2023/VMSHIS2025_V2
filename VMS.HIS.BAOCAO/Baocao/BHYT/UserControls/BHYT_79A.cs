...
namespace VNS.HIS.UI.FORMs.BAOCAO.BHYT.UserControls
{
    public partial class BHYT_79A : UserControl
    {
        ...
        {
            baocaO_TIEUDE1.Init(rad79A.Checked ? "BHYT_79A_TH" : "BHYT_80A_TH");
        }

        void optChitiet_CheckedChanged(object sender, EventArgs e)
        {
            baocaO_TIEUDE1.Init(rad79A.Checked ? "BHYT_79A_CT" : "BHYT_80A_CT");
        }
        public void Init()
        {
        ...
        void cmdExcel_Click(object sender, EventArgs e)
        {
            if (optChitiet.Checked)
            {
                if (radTheo3360.Checked)
                {
                    ...
                    saveFileDialog1.FileName = rad79A.Checked ? "BaoCaoBHYT-79a.xls" : "BaoCaoBHYT-80a.xls";
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    if (i == 0)
                    {
                        ...
                        //sheet[idxRow, idxColSh + 7].SetValue(
                        ...
                        sheet[idxRow, idxColSh + 8].SetValue(
                    ...
                    sheet[idxRow, idxColSh + 7].SetValue(Convert.ToString(dt.Rows[i]["ngay_ketthuc"]), HamDungChung.styleStringLeft(book));
                    sheet[idxRow, idxColSh + 8].SetValue(Convert.ToDecimal(dt.Rows[i]["tongcong"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 9].SetValue(Convert.ToDecimal(dt.Rows[i]["xn"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 10].SetValue(Convert.ToDecimal(dt.Rows[i]["cdha"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 11].SetValue(Convert.ToDecimal(dt.Rows[i]["thuoc"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 12].SetValue(Convert.ToDecimal(dt.Rows[i]["mau"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 13].SetValue(Convert.ToDecimal(dt.Rows[i]["pttt"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 14].SetValue(Convert.ToDecimal(dt.Rows[i]["vtyt"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 15].SetValue(Convert.ToDecimal(dt.Rows[i]["t_dvkt_tyle"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 16].SetValue(Convert.ToDecimal(dt.Rows[i]["t_thuoc_tyle"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 17].SetValue(Convert.ToDecimal(dt.Rows[i]["t_vtyt_tyle"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 18].SetValue(Convert.ToDecimal(dt.Rows[i]["tiencong"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 19].SetValue(Convert.ToDecimal(dt.Rows[i]["VanChuyen"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 20].SetValue(Convert.ToDecimal(dt.Rows[i]["bnct"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 21].SetValue(Convert.ToDecimal(dt.Rows[i]["bhct"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    sheet[idxRow, idxColSh + 22].SetValue(Convert.ToDecimal(dt.Rows[i]["qds"]), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                    idxRow = idxRow + 1;
                }
                sheet[idxRow, idxColSh].SetValue(Convert.ToString("TỔNG CỘNG: "), HamDungChung.styleStringLeft_Bold(book));
                //sheet[idxRow, idxColSh + 7].SetValue(Convert.ToDecimal(dt.Compute("sum(songay_dieutri)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 8].SetValue(Convert.ToDecimal(dt.Compute("sum(tongcong)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 9].SetValue(Convert.ToDecimal(dt.Compute("sum(xn)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 10].SetValue(Convert.ToDecimal(dt.Compute("sum(cdha)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 11].SetValue(Convert.ToDecimal(dt.Compute("sum(thuoc)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 12].SetValue(Convert.ToDecimal(dt.Compute("sum(mau)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 13].SetValue(Convert.ToDecimal(dt.Compute("sum(pttt)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 14].SetValue(Convert.ToDecimal(dt.Compute("sum(vtyt)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 15].SetValue(Convert.ToDecimal(dt.Compute("sum(t_dvkt_tyle)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 16].SetValue(Convert.ToDecimal(dt.Compute("sum(t_thuoc_tyle)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 17].SetValue(Convert.ToDecimal(dt.Compute("sum(t_vtyt_tyle)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 18].SetValue(Convert.ToDecimal(dt.Compute("sum(tiencong)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 19].SetValue(Convert.ToDecimal(dt.Compute("sum(VanChuyen)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 20].SetValue(Convert.ToDecimal(dt.Compute("sum(bnct)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 21].SetValue(Convert.ToDecimal(dt.Compute("sum(bhct)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                sheet[idxRow, idxColSh + 22].SetValue(Convert.ToDecimal(dt.Compute("sum(qds)", "1=1")), HamDungChung.styleDecimalBoldAllBorder_Money(book));
                idxRow = idxRow + 1;
                string getdate = string.Format("Ngày {0} tháng {1} năm {2}", dtCreateDate.Value.Day,
                  dtCreateDate.Value.Month, dtCreateDate.Value.Year);
                sheet[idxRow + 2, 21].SetValue(getdate, HamDungChung.styleStringCenter_UnBorder(book));

                sheet[idxRow + 3, 2].SetValue("NGƯỜI LẬP BẢNG", HamDungChung.styleStringCenter_UnBorder(book));
                sheet[idxRow + 3, 7].SetValue("PHÒNG KẾ HOẠCH TỔNG HỢP",
                HamDungChung.styleStringCenter_UnBorder(book));
                sheet[idxRow + 3, 12].SetValue("PHÒNG TÀI CHÍNH KẾ TOÁN",
                    HamDungChung.styleStringCenter_UnBorder(book));
                sheet[idxRow + 3, 20].SetValue("GIÁM ĐỐC BỆNH VIỆN", HamDungChung.styleStringCenter_UnBorder(book));
        ...
        void PrintReport(bool view)
        {
            try
            {
                if (_mdtReport != null)
                {
                    ...
                    if (optChitiet.Checked)
                    {
                        reportCode = rad79A.Checked ? "BHYT_79A_CT" : "BHYT_80A_CT";
                    ...
                    {
                        reportCode = rad79A.Checked ? "BHYT_79A_TH" : "BHYT_80A_TH";
                        ReportDocument crpt = Utility.GetReport(reportCode, ref tieude, ref reportname);
                        if (crpt == null) return;
        ...
        void SearchData()
        {
            try
            {
                _mdtReport =  new BAOCAO_BHYT().BHYT_79A(dtpFromDate.Value, dtpToDate.Value, "BHYT");
