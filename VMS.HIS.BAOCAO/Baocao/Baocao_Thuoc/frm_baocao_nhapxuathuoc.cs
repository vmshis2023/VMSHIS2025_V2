...
{
    public partial class frm_baocao_nhapxuathuoc : Form
    {
        ...
        string KieuKho = "";
        public frm_baocao_nhapxuathuoc(string args)
        {
            InitializeComponent();
            ...
            this.Load+=new EventHandler(frm_baocao_nhapxuathuoc_Load);
            cmdBaoCao.Click+=new EventHandler(cmdBaoCao_Click);
            this.KeyDown+=new KeyEventHandler(frm_baocao_nhapxuathuoc_KeyDown);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_nhapxuathuoc_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_baocao_nhapxuathuoc_KeyDown_1(object sender, KeyEventArgs e)
        {
