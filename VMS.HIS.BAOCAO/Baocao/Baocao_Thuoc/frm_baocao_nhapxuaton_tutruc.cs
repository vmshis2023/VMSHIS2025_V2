...
{
    public partial class frm_baocao_nhapxuaton_tutruc : Form
    {
        ...
        string KieuKho = "";
        public frm_baocao_nhapxuaton_tutruc(string args)
        {
            InitializeComponent();
            ...
            this.Load+=new EventHandler(frm_baocao_nhapxuaton_tutruc_Load);
            cmdBaoCao.Click+=new EventHandler(cmdBaoCao_Click);
            this.KeyDown+=new KeyEventHandler(frm_baocao_nhapxuaton_tutruc_KeyDown);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_nhapxuaton_tutruc_Load(object sender, EventArgs e)
        {
            ...
            try
            {
              ...
              if(radXuatnhapton.Checked)
              {
                  ...
                  thuoc_baocao.BaocaoNhapxuattonTheoquy(m_dtReport, cboReportType.SelectedValue.ToString(), KIEU_THUOC_VT, baocaO_TIEUDE1.TIEUDE, _tondau, _toncuoi,
                                                                                        dtNgayIn.Value, FromDateToDate,
                                                                                        Utility.sDbnull(cboKho.Text), chkTheoNhomThuoc.Checked,0);
              }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_nhapxuaton_tutruc_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_baocao_nhapxuaton_tutruc_KeyDown_1(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                if (radXuatnhapton.Checked)
                {
                    m_dtReport = BAOCAO_THUOC.ThuocBaocaonhapxuatton(fromdate,
                                      todate,
                                     lstStockID, nhomthuoc, Utility.Int32Dbnull(cbo_thuoc.SelectedValue, -1), chkBiendong.Checked ? 1 : 0, 0);
