...
{
    public partial class frm_baocao_xuatvacxin_tuyenhuyen : Form
    {
        string KIEU_THUOC_VT = "THUOC";
        /// <summary>
        /// hàm thực hiện việc nhập kho chi tiết
        /// </summary>
        public frm_baocao_xuatvacxin_tuyenhuyen(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_xuatvacxin_tuyenhuyen_KeyDown(object sender, KeyEventArgs e)
        {
