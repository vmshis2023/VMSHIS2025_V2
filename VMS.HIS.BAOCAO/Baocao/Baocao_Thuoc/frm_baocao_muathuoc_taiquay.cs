...
{
    public partial class frm_baocao_muathuoc_taiquay : Form
    {
        ...
        string KieuKho = "";
        public frm_baocao_muathuoc_taiquay(string args)
        {
            InitializeComponent();
            ...
            this.Load+=new EventHandler(frm_baocao_muathuoc_taiquay_Load);
          
            this.KeyDown+=new KeyEventHandler(frm_baocao_muathuoc_taiquay_KeyDown);
            optThang.CheckedChanged += _CheckedChanged;
            optNam.CheckedChanged += _CheckedChanged;
            gridEXExporter1.GridEX = grd_tonghop;
            CauHinh();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_muathuoc_taiquay_Load(object sender, EventArgs e)
        {
            InitData();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_muathuoc_taiquay_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cmd_TimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsData = SPs.ThuocBaoCaoCapPhatThuocTaiQuay(tu_ngay, den_ngay, Utility.Int32Dbnull(cbo_kho.SelectedValue)
        ...
        private void cboReportType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Utility.sDbnull(cboReportType.SelectedValue) == "0")
                {
                    ...
                    Utility.SetDataSourceForDataGridEx(grd_tonghop, dsData.Tables[0], true, true, "1=1", "ten_thuoc");
        ...
        private void cmdBaoCao_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                THU_VIEN_CHUNG.CreateXML(dsData.Tables[1], "thuoc_baocao_capphatthuoc_taiquay_chitiet.xml");
                THU_VIEN_CHUNG.CreateXML(dsData.Tables[0], "thuoc_baocao_capphatthuoc_taiquay_tonghop.xml");

                DataTable dtData = report_code == "thuoc_baocao_capphatthuoc_taiquay_tonghop" ? dsData.Tables[0] : dsData.Tables[1];
