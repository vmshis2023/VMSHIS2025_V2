...
{
    public partial class frm_baocao_tonkho_nhathuoc : Form
    {
        ...
        string KieuKho = "";
        public frm_baocao_tonkho_nhathuoc(string args)
        {
            InitializeComponent();
            ...
            this.Load+=new EventHandler(frm_baocao_tonkho_nhathuoc_Load);
          
            this.KeyDown+=new KeyEventHandler(frm_baocao_tonkho_nhathuoc_KeyDown);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_tonkho_nhathuoc_Load(object sender, EventArgs e)
        {
            InitData();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_tonkho_nhathuoc_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Escape) cmdExit.PerformClick();
            if (e.KeyCode == Keys.F4) cmdBaoCao.PerformClick();
        }
        string report_code = "thuoc_baocao_tonkho_nhathuoc";
