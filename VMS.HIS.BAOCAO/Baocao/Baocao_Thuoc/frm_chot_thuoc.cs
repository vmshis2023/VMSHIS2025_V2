...
{
    public partial class frm_chot_thuoc : Form
    {
        ...
        string KieuKho = "";
        public frm_chot_thuoc(string args)
        {
            InitializeComponent();
            ...
            this.Load+=new EventHandler(frm_chot_thuoc_Load);
            cmdBaoCao.Click+=new EventHandler(cmdBaoCao_Click);
            this.KeyDown+=new KeyEventHandler(frm_chot_thuoc_KeyDown);
        ...
        void modifyTieude()
        {
            if (KIEU_THUOC_VT == "THUOC")
            {
                ...
                {
                    baocaO_TIEUDE1.Init("thuoc_baocao_bangcandoi");
                    grdbangcandoi.BringToFront();
                }
            }
            else
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_chot_thuoc_Load(object sender, EventArgs e)
        {
            ...
            try
            {
              ...
              if(radCandoikho.Checked)
              {
                  m_dtReport = BAOCAO_THUOC.ThuocBaocaonhapxuattontheokho(fromdate,
                                   todate,
                                  lstStockID, nhomthuoc, Utility.Int32Dbnull(cbo_thuoc.SelectedValue, -1), chkBiendong.Checked ? 1 : 0);
              ...
              if(radXuatnhapton.Checked)
              {
                        ...
                        m_dtReport = BAOCAO_THUOC.ThuocBaocaonhapxuatton(fromdate,
                                          todate,
                                         lstStockID, nhomthuoc, Utility.Int32Dbnull(cbo_thuoc.SelectedValue, -1), chkBiendong.Checked ? 1 : 0,Utility.Bool2byte(chkBaocaotheolohandung.Checked));
                  ...
                  thuoc_baocao.BaocaoNhapxuattonTheoquy(m_dtReport, cboReportType.SelectedValue.ToString(), KIEU_THUOC_VT, baocaO_TIEUDE1.TIEUDE, _tondau, _toncuoi,
                                                                                        dtNgayIn.Value, FromDateToDate,
                                                                                        Utility.sDbnull(cboKho.Text), chkTheoNhomThuoc.Checked, Utility.Bool2byte(chkBaocaotheolohandung.Checked));
              }
               if(radBienbankiemke.Checked)
               {
                   m_dtReport = BAOCAO_THUOC.ThuocBaocaonhapxuatton(fromdate,
                                   todate,
                                  lstStockID, nhomthuoc, Utility.Int32Dbnull(cbo_thuoc.SelectedItem, -1), chkBiendong.Checked ? 1 : 0,0);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_chot_thuoc_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_chot_thuoc_KeyDown_1(object sender, KeyEventArgs e)
        {
        ...
        private void chkBangCanDoi_CheckedChanged(object sender, EventArgs e)
        {
            modifyTieude();
        }

        private void grdbangcandoi_FormattingRow(object sender, Janus.Windows.GridEX.RowLoadEventArgs e)
        {

        }

        private void dtNgayIn_ValueChanged(object sender, EventArgs e)
        {
