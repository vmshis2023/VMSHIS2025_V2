...
namespace VNS.HIS.UI.Baocao
{
    public partial class frm_baocaoluu : Form
    {
        ...
        private void cmdInPhieuXN_Click(object sender, EventArgs e)
        {
            ...
            _dtData =
               BAOCAO_NGOAITRU.BaocaoLuu(
                chkByDate.Checked ? fromdate : "01/01/1900",
                chkByDate.Checked ? todate : globalVariables.SysDate.ToString("dd/MM/yyyy"),
                Utility.Int32Dbnull(txtLoaiDV.MyID, -1), Utility.Int32Dbnull(txtDvu.MyID, -1),txtBSthuchien.MyCode,Utility.ByteDbnull(cboTrangthai.SelectedValue));
            THU_VIEN_CHUNG.CreateXML(_dtData, "baocao_Luu.xml");
            Utility.SetDataSourceForDataGridEx(grdTonghop, _dtData, true, true, "1=1", "");
