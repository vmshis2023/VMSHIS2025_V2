        ...
        private void frm_baocaothutientheokhoaphong_Load(object sender, EventArgs e)
        {
            try
            {
               ...
               cboNhomdichvuCLS.DropDownDataSource = dtNhomdichvu;
                ...
                DataBinding.BindDataCombobox(cboPhong, THU_VIEN_CHUNG.LaydanhmucPhong(-1,"NGOAI","PHONG"), DmucKhoaphong.Columns.MaKhoaphong, DmucKhoaphong.Columns.TenKhoaphong, "Chọn phòng thực hiện", true);
                m_blnhasLoaded = true;
            }
            catch (Exception ex)
            {
