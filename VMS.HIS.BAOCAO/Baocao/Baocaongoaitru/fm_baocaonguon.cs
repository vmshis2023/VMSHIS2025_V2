...
namespace VNS.HIS.UI.Baocao
{
    public partial class fm_baocaonguon : Form
    {
        ...
        private void cmdInPhieuXN_Click(object sender, EventArgs e)
        {
            ...
            _dtData =
               BAOCAO_NGOAITRU.BaocaoNguon(
                chkByDate.Checked ? fromdate : "01/01/1900",
                chkByDate.Checked ? todate : globalVariables.SysDate.ToString("dd/MM/yyyy"),
                Utility.sDbnull(cboDoituongKCB.SelectedValue, -1), txtNguonGthieu.myCode,txtDoitac.MyCode, Utility.sDbnull(cboKhoa.SelectedValue, -1), Utility.Bool2byte(chkChitiet.Checked));
