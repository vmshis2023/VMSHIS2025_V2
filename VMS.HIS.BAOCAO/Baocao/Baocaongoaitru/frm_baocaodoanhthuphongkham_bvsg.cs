...
{
    public partial class frm_baocaodoanhthuphongkham_bvsg : Form
    {
        public DataTable _dtData = new DataTable();
        bool m_blnhasLoaded = false;
        string tieude = "", reportname = "";
        decimal tong_tien = 0m;
        public frm_baocaodoanhthuphongkham_bvsg()
        {
            InitializeComponent();
        ...
        void BaocaoChung()
        {
            ...
            //            Utility.ByteDbnull(cboLoaidieutri.SelectedValue, 2), Utility.sDbnull(cboKhoa.SelectedValue, -1));
            ...
            try
            {
                ...
                _dtData = BAOCAO_NGOAITRU.BaocaoDoanhthuphongkhamBvsg(tungay, dengay, maDoituongKCB, manhanvien, noitrungoaitru, khoa, txtPttt.myCode, autoNganhang.myCode, Utility.Int32Dbnull(txtLoaiDV.MyID, -1), Utility.Int32Dbnull(txtDvu.MyID, -1), Utility.Bool2byte(optTonghop.Checked));
