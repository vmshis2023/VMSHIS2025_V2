...
{
    public partial class frm_themmoi_phieuxuathaophi_khoanoitru : Form
    {
        ...
        string SplitterPath = "";
        public frm_themmoi_phieuxuathaophi_khoanoitru()
        {
            InitializeComponent();
            this.Shown += frm_themmoi_phieuxuathaophi_khoanoitru_Shown;
            this.FormClosing += frm_themmoi_phieuxuathaophi_khoanoitru_FormClosing;
        ...
        void frm_themmoi_phieuxuathaophi_khoanoitru_FormClosing(object sender, FormClosingEventArgs e)
        {
            Utility.SaveValue2Lines(SplitterPath, new List<string>() { splitContainer1.SplitterDistance.ToString() });
        }

        void frm_themmoi_phieuxuathaophi_khoanoitru_Shown(object sender, EventArgs e)
        {
            Try2Splitter();
        }
        void Try2Splitter()
        ...
        void InitEvents()
        {
            ...
            this.Load += new System.EventHandler(this.frm_themmoi_phieuxuathaophi_khoanoitru_Load);
            ...
            this.KeyDown += new KeyEventHandler(frm_themmoi_phieuxuathaophi_khoanoitru_KeyDown);
        ...
        void cmdAddDetail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Utility.isValidGrid(grdKhoXuat))
                {
                    ...
                    {
                        Utility.SetMsg(lblMsg, string.Format("Số lượng xuất hao phí nội trú {0} phải <= Số lượng có {1}", txtSoluongdutru.Text, slkhachuyen.ToString()), true);
        ...
        bool isValidDetailData()
        {
            ...
            {
                Utility.SetMsg(lblMsg, "Bạn phải chọn thuốc xuất hao phí nội trú",true);
            ...
            {
                Utility.SetMsg(lblMsg, "Bạn phải nhập số lượng xuất hao phí nội trú",true);
            ...
            //{
            //    Utility.SetMsg(lblMsg, "Bạn phải nhập lý do xuất hao phí nội trú)", true);
            //    errorProvider1.SetError(txtLydohuy, lblMsg.Text);
            //    txtLydohuy.Focus();
            //    return false;
            //}
            return true;
        ...
        void frm_themmoi_phieuxuathaophi_khoanoitru_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cmdInPhieuNhap_Click(object sender, EventArgs e)
        {
            ...
            {
                VNS.HIS.UI.Baocao.thuoc_phieuin_nhapxuat.InphieuHuythuoc(IDPhieuNhap, "BIÊN BẢN xuất hao phí nội trú THUỐC", globalVariables.SysDate);
            }
        ...
        private void InitData()
        {
            ...
            {
                m_dtKhohuy = CommonLoadDuoc.LAYDANHMUCKHO(-1, "ALL", "THUOC,THUOCVT", "ALL", 100, 100, 1); // CommonLoadDuoc.LAYTHONGTIN_KHOTHUOC_TATCA();
            }
            else
            {
                m_dtKhohuy = CommonLoadDuoc.LAYDANHMUCKHO(-1, "ALL", "VT,THUOCVT", "ALL", 100, 100, 1); // CommonLoadDuoc.LAYTHONGTIN_KHOVATTU_TATCA();
            }
            cboNhanVien.SelectedValue = globalVariables.gv_intIDNhanvien;
            DataBinding.BindDataCombobox(cboKhohuy, m_dtKhohuy,
                                       TDmucKho.Columns.IdKho, TDmucKho.Columns.TenKho, "---Kho xuất---", false);
        }
        ...
        private void frm_themmoi_phieuxuathaophi_khoanoitru_Load(object sender, EventArgs e)
        {
            txtLydohuy.Init();
            InitData();
            getData();
        ...
        private TPhieuNhapxuatthuoc CreatePhieuNhapKho()
        {
            ...
            objTPhieuNhapxuatthuoc.LoaiPhieu = (byte)LoaiPhieu.PhieuXuatHaophi;
            objTPhieuNhapxuatthuoc.TenLoaiphieu = Utility.TenLoaiPhieu(LoaiPhieu.PhieuXuatHaophi);
        ...
        private bool isValidData()
        {
            ...
            {
                Utility.SetMsg(lblMsg, "Bạn phải chọn kho xuất hao phí nội trú", true);
                errorProvider1.SetError(cboKhohuy, lblMsg.Text);
                cboKhohuy.Focus();
                return false;
            }
            ...
            //    errorProvider1.SetError(txtHoidong, lblMsg.Text);
            //    txtHoidong.Focus();
            //    return false;
            //}
            //if (Utility.DoTrim(txtMotathem.Text) == "")
            //{
            //    Utility.SetMsg(lblMsg, "Bạn phải nhập ghi chú(lý do xuất hao phí VTTH)", true);
            //    errorProvider1.SetError(txtMotathem, lblMsg.Text);
            //    txtMotathem.Focus();
            //    return false;
            //}
            return true;
        ...
        private void grdKhoXuat_UpdatingCell(object sender, UpdatingCellEventArgs e)
        {
            if(e.Column.Key=="SO_LUONG_CHUYEN")
            {
                ...
                if(soluongchuyen<0)
                {
                    Utility.ShowMsg("Số lượng thuốc cần xuất hao phí nội trú phải >=0","Thông báo",MessageBoxIcon.Warning);
                    e.Cancel = true;
                }else
                {
                    if(soluongchuyen>soluongthat)
                    {
                        Utility.ShowMsg("Số lượng thuốc cần xuất hao phí nội trú phải <= số lượng thuốc có trong kho", "Thông báo", MessageBoxIcon.Warning);
        ...
        private void RemoveDetails()
        {
            ...
            {
                Utility.ShowMsg("Lỗi khi xuất hao phí nội trú chuyển thuốc:\n"+ex.Message);
            }
        }
        private void RemoveDetails(GridEXRow gridExRow)
        {
            ...
            {
                Utility.CatchException(string.Format("Lỗi khi xuất hao phí nội trú xuất hao phí nội trú thuốc {0}:\n", ten_thuoc), ex);
            }
        }
