...
{
    public partial class frm_PhieuThanhlythuoc : Form
    {
        ...
        public frm_PhieuThanhlythuoc(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        void setquyen()
        {
            try
            {
                cmdThemPhieuNhap.Visible = Utility.Coquyen("thuoc_phieuthanhly_themmoi");
                cmdUpdatePhieuNhap.Visible = Utility.Coquyen("thuoc_phieuthanhly_sua");
                cmdXoaPhieuNhap.Visible = Utility.Coquyen("thuoc_phieuthanhly_xoa");
                cmdNhapKho.Visible = Utility.Coquyen("thuoc_phieuthanhly_xacnhan");
                cmdHuychuyenkho.Visible = Utility.Coquyen("thuoc_phieuthanhly_huyxacnhan");
            }
            catch (Exception ex)
            {
        ...
        void InitEvents()
        {
            ...
            this.Load += new System.EventHandler(this.frm_PhieuThanhlythuoc_Load);
            this.KeyDown += new KeyEventHandler(frm_PhieuThanhlythuoc_KeyDown);
        ...
        /// <param name="e"></param>
        private void frm_PhieuThanhlythuoc_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            m_dtDataNhapKho =
                new THUOC_NHAPKHO().Laydanhsachphieunhapkho(chkByDate.Checked ? dtFromdate.Value.ToString("dd/MM/yyyy") :"01/01/1900",
                                            ...
                                            -1, Utility.Int32Dbnull(cboKhohuy.SelectedValue, -1),
                                             ...
                                             -1, "-1", Utility.sDbnull(txtSoPhieu.Text), TRANG_THAI, (int)LoaiPhieu.PhieuThanhly, MaKho, 2, KIEU_THUOC_VT);
        ...
        private void cmdXoaPhieuNhap_Click(object sender, EventArgs e)
        {
            ...
            if (Utility.AcceptQuestion(string.Format("Bạn có muốn xóa thông tin phiếu thanh lý thuốc với mã phiếu {0}\n hay không?", IdPhieu), "Thông báo", true))
            {
                ...
                switch (actionResult)
                {
                    case ActionResult.Success:
                        ...
                        Utility.SetMsg(uiStatusBar2.Panels["MSG"], "Bạn xóa thông tin phiếu nhập kho thành công", false);
                        break;
        ...
        private void frm_PhieuThanhlythuoc_Load(object sender, EventArgs e)
        {
            InitData();
            AutocompleteThuoc();
            TIMKIEM_THONGTIN();
        ...
        private void InitData()
        {
            ...
            {
                m_dtKhoXuat = CommonLoadDuoc.LAYDANHMUCKHO(-1,"ALL", "THUOC,THUOCVT", "ALL", 0, 100, 1); //CommonLoadDuoc.LAYTHONGTIN_KHOTHUOC_TATCA();
            }
            else
            {
                m_dtKhoXuat = CommonLoadDuoc.LAYDANHMUCKHO(-1,"ALL", "VT,THUOCVT", "ALL", 0, 100, 1); //CommonLoadDuoc.LAYTHONGTIN_KHOVATTU_TATCA();
            }
        ...
        private void cmdInPhieuNhapKho_Click(object sender, EventArgs e)
        {
            ...
            {
                VNS.HIS.UI.Baocao.thuoc_phieuin_nhapxuat.InphieuThanhly(id_PhieuNhap, "BIÊN BẢN THANH LÝ", globalVariables.SysDate);
            }
        ...
        private void cmdThemPhieuNhap_Click(object sender, EventArgs e)
        {
            try
            {
                frm_themmoi_phieuthanhlythuoc frm = new frm_themmoi_phieuthanhlythuoc();
                    ...
                    if (objTPhieuNhapxuatthuoc != null)
                    {
                        ...
                        switch (actionResult)
                        {
                            ...
                            case ActionResult.notExists:
                                Utility.ShowMsg("Không tìm thấy id thuốc kho thanh lý để cộng số lượng thanh lý. Vui lòng kiểm tra lại\n" + errMsg, "Thông báo lỗi", MessageBoxIcon.Error);
                                break;
                            case ActionResult.Error:
                                break;
                        }
