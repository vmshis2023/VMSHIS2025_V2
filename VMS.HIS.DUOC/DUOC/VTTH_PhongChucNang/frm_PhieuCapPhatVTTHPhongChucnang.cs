...
{
    public partial class frm_PhieuCapPhatVTTHPhongChucnang : Form
    {
        ...
        public frm_PhieuCapPhatVTTHPhongChucnang(string param)
        {
            InitializeComponent();
        ...
        private void InitData()
        {
            try
            {
                ...
                {
                    m_dtDataDepartment = THU_VIEN_CHUNG.Laydanhmuckhoa("ALL", 1);
                    //log.Info("Lay thong tin khoa noi tru cua admin");
                }
                else
                {
                    m_dtDataDepartment =THU_VIEN_CHUNG.LaydanhsachKhoatheoUser(globalVariables.UserName, Utility.Bool2byte(globalVariables.IsAdmin),100);// THU_VIEN_CHUNG.Laydanhmuckhoa(globalVariablesPrivate.objKhoaphong.IdKhoaphong);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_PhieuCapPhatVTTHPhongChucnangQ_Load(object sender, EventArgs e)
        {
        ...
        private void TimKiemDuLieu()
        {
            try
            {
                ...
                dtList = SPs.ThuocNoitruTimkiemphieutonghopthuocnoitru(Utility.Int32Dbnull(txtID_CAPPHAT.Text, -1), 4, chkByDate.Checked ? dtpFromDate.Value.ToString("dd/MM/yyyy") : "01/01/1900", chkByDate.Checked ? dtpToDate.Value.ToString("dd/MM/yyyy") : "01/01/1900",
        ...
        {
            frm_AddCapPhatVTTHPhongChucnang frm = new frm_AddCapPhatVTTHPhongChucnang(KIEU_THUOC_VT, loaiphieu);
            ...
            try
            {
                ...
                if (grdList.CurrentRow != null && grdList.RecordCount > 0)
                {
                    if (grdList.CurrentRow.RowType == RowType.Record)
                    {
                        ...
                        short IDKhoa = Utility.Int16Dbnull(grdList.CurrentRow.Cells[TPhieuCapphatNoitru.Columns.IdKhoaLinh].Value, -1);
                        ...
                        //Load kho theo khoa trên phiếu lĩnh VTTH khoa phòng chức năng
                        Load_Dmuckho_theokhoaphongchucnang(IDKhoa);
                        //Load kho theo phiếu lĩnh VTTH đang chọn
        ...
        void Load_Dmuckho_theokhoaphongchucnang(short IDKhoa)
        {
            DataTable _newTable = CommonLoadDuoc.LAYDANHMUCKHO_THEOKHOA(IDKhoa, -1, "TATCA,NOITRU,NGOAITRU", KIEU_THUOC_VT, 100, 100);
        ...
        private void frm_PhieuCapPhatVTTHPhongChucnangQ_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void frm_PhieuCapPhatVTTHPhongChucnangQ_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void mnuUpdateIDThuockho_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _capnhat_idthuockho.so_luong = Utility.Int32Dbnull(grdChitiedonthuoc.GetValue("so_luong"), -1);
