...
namespace VNS.HIS.UI.THUOC
{
    public partial class frm_themmoi_PhieutrathuocNhacungcap : Form
    {
        ...
        {
            InitializeComponent();
            this.Shown += frm_themmoi_PhieutrathuocNhacungcap_Shown;
            this.FormClosing += frm_themmoi_PhieutrathuocNhacungcap_FormClosing;
        ...
        void frm_themmoi_PhieutrathuocNhacungcap_FormClosing(object sender, FormClosingEventArgs e)
        {
            Utility.SaveValue2Lines(SplitterPath, new List<string>() { splitContainer1.SplitterDistance.ToString() });
        }

        void frm_themmoi_PhieutrathuocNhacungcap_Shown(object sender, EventArgs e)
        {
            Try2Splitter();
        }
        void Try2Splitter()
        ...
        private bool IsValidData()
        {
            ...
            if (Utility.DoTrim(txtNhacungcap.Text) == "" )
            {
                ...
                errorProvider1.SetError(txtNhacungcap, "Bạn phải nhập nhà cung cấp cần trả thuốc");
                txtNhacungcap.Focus();
                return false;
            }
            ...
            if (Utility.DoTrim(txtNhacungcap.Text) == "")
            {
                ...
                errorProvider1.SetError(txtLyDoNhap, "Bạn phải nhập lý do trả thuốc");
                txtLyDoNhap.Focus();
                return false;
            }
            return true;
