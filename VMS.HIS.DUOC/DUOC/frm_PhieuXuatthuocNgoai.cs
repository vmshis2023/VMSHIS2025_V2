...
{
    public partial class frm_PhieuXuatthuocNgoai : Form
    {
        ...
        private string FileName = string.Format("{0}/{1}", Application.StartupPath, string.Format("SplitterDistancefrm_PhieuXuatthuocNgoai.txt"));
        private int SplitterDistance
        {
            get { return Distance; }
            set { Distance = value; }
        }
        public frm_PhieuXuatthuocNgoai(string KIEU_THUOC_VT)
        {
            InitializeComponent();
            ...
            this.KeyDown += new KeyEventHandler(frm_PhieuXuatthuocNgoai_KeyDown);
        ...
        void setquyen()
        {
            try
            {
                cmdThemPhieuNhap.Visible = Utility.Coquyen("thuoc_phieutrathuocnhacungcap_themmoi");
                cmdUpdatePhieuNhap.Visible = Utility.Coquyen("thuoc_phieutrathuocnhacungcap_sua");
                cmdXoaPhieuNhap.Visible = Utility.Coquyen("thuoc_phieutrathuocnhacungcap_xoa");
                cmdNhapKho.Visible = Utility.Coquyen("thuoc_phieutrathuocnhacungcap_xacnhan");
                cmdHuychuyenkho.Visible = Utility.Coquyen("thuoc_phieutrathuocnhacungcap_huyxacnhan");
            }
            catch (Exception ex)
            {
        ...
        /// <param name="e"></param>
        private void frm_PhieuXuatthuocNgoai_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void TIMKIEM_THONGTIN()
        {
            ...
            m_dtDataNhapKho =
                new THUOC_NHAPKHO().Laydanhsachphieunhapkho(chkByDate.Checked ? dtFromdate.Value.ToString("dd/MM/yyyy") : "01/01/1900",
                                             ...
                                             -1, Utility.sDbnull(cboNoinhan.SelectedValue), Utility.sDbnull(txtSoPhieu.Text), TRANG_THAI, (int)LoaiPhieu.PhieuXuatNgoai, MaKho, 2, KIEU_THUOC_VT);
        ...
        private void frm_PhieuXuatthuocNgoai_Load(object sender, EventArgs e)
        {
            InitData();
            TIMKIEM_THONGTIN();
            ModifyCommand();
        ...
        private void cmdThemPhieuNhap_Click(object sender, EventArgs e)
        {
            try
            {
                frm_themmoi_PhieuxuatNgoai frm = new frm_themmoi_PhieuxuatNgoai(KIEU_THUOC_VT);
