...
namespace VNS.QMS
{
    public partial class frm_QMSTiepdon_Layso_V1 : Form
    {
        private QMSProperties _QMSProperties;
        bool hasLoaded = false;
        private string loaisoqms = "";
        public frm_QMSTiepdon_Layso_V1()
        {
            ...
            this.KeyDown += new KeyEventHandler(frm_QMSTiepdon_Layso_V1_KeyDown);
            Utility.InitSubSonic(new ConnectionSQL().KhoiTaoKetNoi(), "ORM");
            this.Load+=new EventHandler(frm_QMSTiepdon_Layso_V1_Load);
            CauHinh();
            ...
            chkLaythemsoYC._Oncheck += chkLaythemsoYC__Oncheck;
            chkLaythemsouutien._Oncheck += chkLaythemsouutien__Oncheck;
            chkLaythemsothuong._Oncheck += chkLaythemsothuong__Oncheck;
        ...
        void chkLaythemsouutien__Oncheck()
        {
            nmrLaythemsoUutien.Enabled = chkLaythemsouutien.IsChecked;
            lblHelpUutien.Visible = chkLaythemsouutien.IsChecked;
            if (chkLaythemsouutien.IsChecked)
            {
        ...
        void chkLaythemsoYC__Oncheck()
        {
            nmrLaythemsoYC.Enabled = chkLaythemsoYC.IsChecked;
            lblHelpsoYC.Visible = chkLaythemsoYC.IsChecked;
            if (chkLaythemsoYC.IsChecked)
            {
        ...
        void chkLaythemsothuong__Oncheck()
        {
            nmrLaythemsothuong.Enabled = chkLaythemsothuong.IsChecked;
            lblHelpsothuong.Visible = chkLaythemsothuong.IsChecked;
            ...
            try
            {
                ...
                if (Reprint)
                {
                    QmsTiepdon objQms = new Select().From(QmsTiepdon.Schema)
                        .Where(QmsTiepdon.Columns.SoQms).IsEqualTo(Utility.Int32Dbnull(txtsokhac.Text, 0))
                        .And(QmsTiepdon.Columns.LoaiQms).IsEqualTo(2)
                ...
                {
                    this.LaySokham(1, txtsokhac, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongkhac, "TIEMCHUNG", 0, 0);
        ...
        void frm_QMSTiepdon_Layso_V1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F12)
            {
                this.LaySokham(0, txtSoKham, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongdichvu, "DV", 0, 0);
                this.LaySokham(0, txtSoKhamBHYT, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongbhyt, "DV", 0, 0);
                this.LaySokham(0, txtSoKhamUuTien, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), "ALL", "UUTIEN", 0, 1);
                this.LaySokham(0, txtSoKhamYeuCau, Utility.sDbnull(_QMSProperties.MaKhoaYeuCau), "ALL", "UUTIEN", 0, 0);
                this.LaySokham(0, txtsokhac, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongkhac, "KHAC", 0, 0);
                this.LaySokham(0, txtsokhacUutien, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongkhac, "KHAC", 0, 1);
            }
        ...
        void cmdgetBHYT_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    QmsTiepdon objQms = new Select().From(QmsTiepdon.Schema)
                        .Where(QmsTiepdon.Columns.SoQms).IsEqualTo(Utility.Int32Dbnull(txtSoKhamBHYT.Text, 0))
                        .And(QmsTiepdon.Columns.LoaiQms).IsEqualTo(0)
                        .And(QmsTiepdon.Columns.UuTien).IsEqualTo(0)
                        .And(QmsTiepdon.Columns.MaKhoakcb).IsEqualTo(_QMSProperties.MaKhoaKhamBenh)
                        .And(QmsTiepdon.Columns.MaDoituongKcb).IsEqualTo("ALL")
                        //.And(QmsTiepdon.Columns.MaDoituongKcb).IsEqualTo("BHYT")
                        .ExecuteSingle<QmsTiepdon>();
                    if (objQms == null)
                    {
                        Utility.ShowMsg("Số QMS bạn muốn in lại chưa được tạo hoặc không tồn tại. Đề nghị bạn nhập số khác");
                ...
                for (int i = 1; i <= soluong; i++)
                {
                    this.LaySokham(1, txtSoKhamBHYT, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongbhyt, "BHYT", 0, 0);
                    if (_QMSProperties.PrintStatus)
                    {
        ...
        private void cmdGetSoKham_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    QmsTiepdon objQms = new Select().From(QmsTiepdon.Schema)
                        .Where(QmsTiepdon.Columns.SoQms).IsEqualTo(Utility.Int32Dbnull(txtSoKham.Text, 0))
                        .And(QmsTiepdon.Columns.LoaiQms).IsEqualTo(0)
                        .And(QmsTiepdon.Columns.UuTien).IsEqualTo(0)
                        .And(QmsTiepdon.Columns.MaKhoakcb).IsEqualTo(_QMSProperties.MaKhoaKhamBenh)
                        //.And(QmsTiepdon.Columns.MaDoituongKcb).IsEqualTo("ALL")
                ...
                for (int i = 1; i <= soluong; i++)
                {
                    this.LaySokham(1, txtSoKham, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongdichvu, "DV", 0, 0);
                    if (_QMSProperties.PrintStatus)
                    {
        ...
        private void cmdKhamYC_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    QmsTiepdon objQms = new Select().From(QmsTiepdon.Schema)
                        .Where(QmsTiepdon.Columns.SoQms).IsEqualTo(Utility.Int32Dbnull(txtSoKhamYeuCau.Text, 0))
                        .And(QmsTiepdon.Columns.LoaiQms).IsEqualTo(0)
                        .And(QmsTiepdon.Columns.MaKhoakcb).IsEqualTo(_QMSProperties.MaKhoaKhamBenh)
                        .And(QmsTiepdon.Columns.MaDoituongKcb).IsEqualTo("ALL")
                        .ExecuteSingle<QmsTiepdon>();
                ...
                for (int i = 1; i <= soluong; i++)
                {
                    this.LaySokham(1, txtSoKhamYeuCau, Utility.sDbnull(_QMSProperties.MaKhoaYeuCau), "ALL", "YEUCAU", 0, 0);
                    if (_QMSProperties.PrintStatus)
                    {
        ...
        private void cmdKhamUuTien_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    QmsTiepdon objQms = new Select().From(QmsTiepdon.Schema)
                        .Where(QmsTiepdon.Columns.SoQms).IsEqualTo(Utility.Int32Dbnull(txtSoKhamUuTien.Text, 0))
                        .And(QmsTiepdon.Columns.LoaiQms).IsEqualTo(0)
                        .And(QmsTiepdon.Columns.UuTien).IsEqualTo(1)
                        //.And(QmsTiepdon.Columns.MaKhoakcb).IsEqualTo(_QMSProperties.MaKhoaKhamBenh)
                        //.And(QmsTiepdon.Columns.MaDoituongKcb).IsEqualTo("ALL")
                        .ExecuteSingle<QmsTiepdon>();
                    if (objQms == null)
                ...
                for (int i = 1; i <= soluong; i++)
                {
                    this.LaySokham(1, txtSoKhamUuTien, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituonguutien, "UUTIEN", 0, 1);
                    if (_QMSProperties.PrintStatus)
                    {
        ...
        private void cmdSotiemchung_uutien_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    QmsTiepdon objQms = new Select().From(QmsTiepdon.Schema)
                        .Where(QmsTiepdon.Columns.SoQms).IsEqualTo(Utility.Int32Dbnull(txtsokhacUutien.Text, 0))
                        .And(QmsTiepdon.Columns.LoaiQms).IsEqualTo(2)
                        .And(QmsTiepdon.Columns.UuTien).IsEqualTo(1)
                        .And(QmsTiepdon.Columns.MaKhoakcb).IsEqualTo(_QMSProperties.MaKhoaKhamBenh)
                        .And(QmsTiepdon.Columns.MaDoituongKcb).IsEqualTo("ALL")
                ...
                for (int i = 1; i <= soluong; i++)
                {
                    this.LaySokham(1, txtsokhacUutien, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongkhac, "TIEMCHUNG", 0, 1);
                    if (_QMSProperties.PrintStatus)
                    {
        ...
        private void frm_QMSTiepdon_Layso_V1_Load(object sender, EventArgs e)
        {
            this.LaySokham(0, txtSoKham, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongdichvu, "DV", 0, 0);
           this.LaySokham(0, txtSoKhamUuTien, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), "ALL", "UUTIEN", 0, 1);
           this.LaySokham(0, txtSoKhamYeuCau, Utility.sDbnull(_QMSProperties.MaKhoaYeuCau),"ALL", "YEUCAU", 0, 0);
           this.LaySokham(0, txtSoKhamBHYT, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongbhyt, "BHYT", 0, 0);
           this.LaySokham(0, txtsokhac, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongkhac, "KHAC", 0, 0);
           this.LaySokham(0, txtsokhacUutien, Utility.sDbnull(_QMSProperties.MaKhoaKhamBenh), _QMSProperties.madoituongkhac, "KHAC", 0, 1);
           hasLoaded = true;
        }
        ...
        private void LaySokham(int status, TextBox txt, string MaKhoa, string madoituongkcb, string loaiQms,byte muc_uutien, byte uutien)
        {
            try
            {
                int num = 0;
        ...
        private void LaySokham(int status,Label txt, string MaKhoa,string madoituongkcb, string loaiQms,byte muc_uutien, byte uutien)
        {
            try
            {
                int num = 0;
