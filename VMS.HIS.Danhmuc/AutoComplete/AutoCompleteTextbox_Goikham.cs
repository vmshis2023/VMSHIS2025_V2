...
namespace VNS.HIS.UCs
{
    ...
    // and is therfore called TextBox, but ment is this class (AutoCompleteTextbox_Goikham)
    public class AutoCompleteTextbox_Goikham : TextBox
    {
        #region Fields
        ...
        public delegate void OnGridSelectionChanged(int id_goi, string ma_goi, string ten_goi);
        ...
        // the constructor
        public AutoCompleteTextbox_Goikham()
            : base()
        {
            ...
            this.MouseClick += AutoCompleteTextbox_Goikham_MouseClick;
            _grid.AllowedChanged = false;
            // set the input to remember, which is empty so far
            oldText = this.Text;
        }

        private void AutoCompleteTextbox_Goikham_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void _grid__OnKeyDown1(int id_goi, string ma_goi, string ten_goi)
        {
            _Text = ten_goi;
            MyText = ten_goi;
            MyCode = ma_goi;
        ...
        private void _grid__OnCellValueChanged1(int id_goi, string ma_goi, string ten_goi)
        {
           
        }

        private void _grid__OnSelectionChanged1(int id_goi, string ma_goi, string ten_goi)
        {
           
            if (!AllowTextChanged) return;
            if (txtMyID != null)
                txtMyID.Text = id_goi.ToString();
            if (txtMyID_Edit != null)
                txtMyID_Edit.Text = id_goi.ToString();
            MyID = id_goi;
            MyCode = ma_goi;
            if (txtMyName != null)
                txtMyName.Text = ten_goi;
            if (txtMyName_Edit != null)
                txtMyName_Edit.Text = ten_goi;
            if (_OnGridSelectionChanged != null) _OnGridSelectionChanged(id_goi,ma_goi,ten_goi);
        }
