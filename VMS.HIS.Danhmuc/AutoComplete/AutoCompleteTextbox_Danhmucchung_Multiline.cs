...
namespace VNS.HIS.UCs
{
    ...
    // and is therfore called TextBox, but ment is this class (AutoCompleteTextbox_Danhmucchung_Multiline)
    public class AutoCompleteTextbox_Danhmucchung_Multiline : TextBox
    {
        #region Fields
        ...
        // the constructor
        public AutoCompleteTextbox_Danhmucchung_Multiline()
            : base()
        {
