...
{
    public partial class ucThongtinnguoibenh_quaythuoc : UserControl
    {
        ...
        public ucThongtinnguoibenh_quaythuoc()
        {
            InitializeComponent();
        ...
        public void setKhoaPhongBacSi(string khoachidinh,string bacsichidinh)
        {
            txt_khoa_phong_kedon.Text = khoachidinh;
            txt_BacSiChiDinh.Text = bacsichidinh;
        }
        public void Refresh(string patient_code)
        {
            try
            {
                ...
                if (dt_ThongtinNguoibenh != null && dt_ThongtinNguoibenh.Rows.Count > 0)
                {
                    ...
                    txtMaNgheNghiep.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["nghe_nghiep"], "", true);
                    txtDantoc.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ten_dantoc"], "");
                    txtMaDantoc.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["dan_toc"], "", true);
                    txtTenNgoaikieu.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ten_quocgia"], "");
                    txtMaNgoaikieu.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ma_quocgia"], "", true);
                    ...
                    txtMaXaPhuong.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ma_xaphuong"], "",true);
                    txtQuanhuyen.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ten_quanhuyen"], "");
                    txtMaQuanHuyen.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ma_quanhuyen"], "", true);
                    txtTinhTp.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ten_tinhtp"], "");
                    txtMaTinhTp.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ma_tinhtp"], "", true);
                    ...
                    txt_DoituongKCB.Text= Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ten_doituong_kcb"], "");
                    txt_ngaytiepdon.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ngay_tiepdon"], "");
                    txt_ngayketthuc.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ngay_ketthuc"], "");
                    txtngaynhapvien.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ngay_nhapvien"], "");
                    txt_ngayravien.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ngay_ravien"], "");
                    txtSDT.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["dien_thoai"], "");
                }
