...
{
    public partial class ucThongtinnguoibenh_emr_basic_v1 : UserControl
    {
        ...
        public ucThongtinnguoibenh_emr_basic_v1()
        {
            InitializeComponent();
        ...
        public void Refresh(string patient_code)
        {
            try
            {
                ...
                if (dt_ThongtinNguoibenh != null && dt_ThongtinNguoibenh.Rows.Count > 0)
                {
                    ...
                    txtsovaovien.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["so_vaovien"], "");
                    txtngaynhapvien.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ngay_nhapvien"], "");
                    txtKhoanoitru.Text = Utility.sDbnull(dt_ThongtinNguoibenh.Rows[0]["ten_khoanoitru"], "");
