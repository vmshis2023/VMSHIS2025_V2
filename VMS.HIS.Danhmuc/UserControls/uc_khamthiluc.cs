...
namespace VMS.HIS.Danhmuc.UserControls
{
    public partial class uc_khamthiluc : UserControl
    {
        ...
        void ClearControls()
        {
            ...
            chk_benhnhan_sau_pt_duc_ttt.Checked = chk_benhnhan_sau_pt_khucxa.Checked = chk_kinh2trong.Checked = chk_kinhaptrong.Checked =
                chk_kinhdatrong.Checked = chk_kinhdoimau.Checked = chk_kinhnhingan.Checked = chk_kinhpoly.Checked = chk_pt_duc_thuytinhthe.Checked = chk_pt_khucxa.Checked = false;
        }
        public void InitData()
        {
            try
            {
                ...
                if (cbo_khucxamay_cau_phai.Items.Count <= 0)
                {
                    ...
                    //Khúc xạ máy
                    cbo_khucxamay_cau_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxamay_cau_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxamay_tru_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxamay_tru_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxamay_truc_phai.Items.AddRange(lstTruc.ToArray<string>());
                    cbo_khucxamay_truc_trai.Items.AddRange(lstTruc.ToArray<string>());
                    //Kính cũ
                    cbo_kinhcu_cau_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_kinhcu_cau_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_kinhcu_tru_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_kinhcu_tru_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_kinhcu_truc_phai.Items.AddRange(lstTruc.ToArray<string>());
                    cbo_kinhcu_truc_trai.Items.AddRange(lstTruc.ToArray<string>());
                    //Khúc hiện tại
                    cbo_khucxahientai_cau_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxahientai_cau_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxahientai_tru_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxahientai_tru_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxahientai_truc_phai.Items.AddRange(lstTruc.ToArray<string>());
                    cbo_khucxahientai_truc_trai.Items.AddRange(lstTruc.ToArray<string>());
                    //Khúc xạ máy
                    cbo_khucxasaudieutiet_cau_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxasaudieutiet_cau_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxasaudieutiet_tru_phai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxasaudieutiet_tru_trai.Items.AddRange(lstCautru.ToArray<string>());
                    cbo_khucxasaudieutiet_truc_phai.Items.AddRange(lstTruc.ToArray<string>());
                    cbo_khucxasaudieutiet_truc_trai.Items.AddRange(lstTruc.ToArray<string>());
                    //Đơn kính
        ...
        public void SetData(KcbLuotkham objLuotkham, KcbDanhsachBenhnhan objBenhnhan,KcbDangkyKcb objCongkham)
        {
            ...
            InitData();
            if (LaKham_Thiluc)//thiết lập lại công khám thị lực để khi bấm lưu hoặc kết thúc sẽ không ảnh hưởng đến công khám chính trong case bác sĩ phòng khám chính đo tiếp và đc quyền nhập lại thông tin
            {
        ...
        {
           this.LaKham_Thiluc = LaKham_Thiluc;
            ...
            if (!LaKham_Thiluc)
                cmdSave.Visible = Utility.Coquyen("kcb_quyen_nhaplaithongtin_khamkhucxa");
        ...
        public void LoadData()
        {
            try
            {
                ...
                {
                    //Khúc xạ máy
                    cbo_khucxamay_cau_phai.Text = objKhamthiluc.KhucxamayCauPhai;
                    cbo_khucxamay_tru_phai.Text = objKhamthiluc.KhucxamayTruPhai;
                    cbo_khucxamay_truc_phai.Text = objKhamthiluc.KhucxamayTrucPhai;
                    cbo_khucxamay_cau_trai.Text = objKhamthiluc.KhucxamayCauTrai;
                    cbo_khucxamay_tru_trai.Text = objKhamthiluc.KhucxamayTruTrai;
                    cbo_khucxamay_truc_trai.Text = objKhamthiluc.KhucxamayTrucTrai;
                    //Kính cũ
                    cbo_kinhcu_cau_phai.Text = objKhamthiluc.KinhcuCauPhai;
                    cbo_kinhcu_tru_phai.Text = objKhamthiluc.KinhcuTruPhai;
                    cbo_kinhcu_truc_phai.Text = objKhamthiluc.KinhcuTrucPhai;
                    ...
                    cbo_kinhcu_cau_trai.Text = objKhamthiluc.KinhcuCauTrai;
                    cbo_kinhcu_tru_trai.Text = objKhamthiluc.KinhcuTruTrai;
                    cbo_kinhcu_truc_trai.Text = objKhamthiluc.KinhcuTrucTrai;
                    ...
                    //Khúc xạ hiện tại
                    cbo_khucxahientai_cau_phai.Text = objKhamthiluc.KhucxahientaiCauPhai;
                    cbo_khucxahientai_tru_phai.Text = objKhamthiluc.KhucxahientaiTruPhai;
                    cbo_khucxahientai_truc_phai.Text = objKhamthiluc.KhucxahientaiTrucPhai;
                    ...
                    cbo_khucxahientai_cau_trai.Text = objKhamthiluc.KhucxahientaiCauTrai;
                    cbo_khucxahientai_tru_trai.Text = objKhamthiluc.KhucxahientaiTruTrai;
                    cbo_khucxahientai_truc_trai.Text = objKhamthiluc.KhucxahientaiTrucTrai;
                    ...
                    cbo_khucxasaudieutiet_cau_phai.Text = objKhamthiluc.KhucxasaudieutietCauPhai;
                    cbo_khucxasaudieutiet_tru_phai.Text = objKhamthiluc.KhucxasaudieutietTruPhai;
                    cbo_khucxasaudieutiet_truc_phai.Text = objKhamthiluc.KhucxasaudieutietTrucPhai;
                    ...
                    cbo_khucxasaudieutiet_cau_trai.Text = objKhamthiluc.KhucxasaudieutietCauTrai;
                    cbo_khucxasaudieutiet_tru_trai.Text = objKhamthiluc.KhucxasaudieutietTruTrai;
                    cbo_khucxasaudieutiet_truc_trai.Text = objKhamthiluc.KhucxasaudieutietTrucTrai;
                    ...
                    if (objKhamthiluc.NgayKham.HasValue)
        ...
        public void PrepareData4Save()
        {
            try
            {
                ...
                objKhamthiluc.KhucxamayCauPhai=Utility.sDbnull(cbo_khucxamay_cau_phai.Text);
                 objKhamthiluc.KhucxamayTruPhai=Utility.sDbnull(cbo_khucxamay_tru_phai.Text);
                 objKhamthiluc.KhucxamayTrucPhai=Utility.sDbnull(cbo_khucxamay_truc_phai.Text);
                 objKhamthiluc.KhucxamayCauTrai=Utility.sDbnull(cbo_khucxamay_cau_trai.Text);
                 objKhamthiluc.KhucxamayTruTrai=Utility.sDbnull(cbo_khucxamay_tru_trai.Text);
                 objKhamthiluc.KhucxamayTrucTrai=Utility.sDbnull(cbo_khucxamay_truc_trai.Text);
                //Kính cũ

                 objKhamthiluc.KinhcuCauPhai = Utility.sDbnull(cbo_kinhcu_cau_phai.Text);
                 objKhamthiluc.KinhcuTruPhai = Utility.sDbnull(cbo_kinhcu_tru_phai.Text);
                 objKhamthiluc.KinhcuTrucPhai = Utility.sDbnull(cbo_kinhcu_truc_phai.Text);
                ...
                objKhamthiluc.KinhcuCauTrai = Utility.sDbnull(cbo_kinhcu_cau_trai.Text);
                 objKhamthiluc.KinhcuTruTrai = Utility.sDbnull(cbo_kinhcu_tru_trai.Text);
                 objKhamthiluc.KinhcuTrucTrai = Utility.sDbnull(cbo_kinhcu_truc_trai.Text);
                ...
                objKhamthiluc.KinhcuKcdt = Utility.sDbnull(txt_kinhcu_kcdt.Text);
                 //Khúc xạ hiện tại
                objKhamthiluc.KhucxahientaiCauPhai = Utility.sDbnull(cbo_khucxahientai_cau_phai.Text);
                objKhamthiluc.KhucxahientaiTruPhai = Utility.sDbnull(cbo_khucxahientai_tru_phai.Text);
                objKhamthiluc.KhucxahientaiTrucPhai = Utility.sDbnull(cbo_khucxahientai_truc_phai.Text);
                ...
                objKhamthiluc.KhucxahientaiCauTrai = Utility.sDbnull(cbo_khucxahientai_cau_trai.Text);
                objKhamthiluc.KhucxahientaiTruTrai = Utility.sDbnull(cbo_khucxahientai_tru_trai.Text);
                objKhamthiluc.KhucxahientaiTrucTrai = Utility.sDbnull(cbo_khucxahientai_truc_trai.Text);
                ...
                objKhamthiluc.KhucxasaudieutietCauPhai = Utility.sDbnull(cbo_khucxasaudieutiet_cau_phai.Text);
                objKhamthiluc.KhucxasaudieutietTruPhai = Utility.sDbnull(cbo_khucxasaudieutiet_tru_phai.Text);
                objKhamthiluc.KhucxasaudieutietTrucPhai = Utility.sDbnull(cbo_khucxasaudieutiet_truc_phai.Text);
                ...
                objKhamthiluc.KhucxasaudieutietCauTrai = Utility.sDbnull(cbo_khucxasaudieutiet_cau_trai.Text);
                objKhamthiluc.KhucxasaudieutietTruTrai = Utility.sDbnull(cbo_khucxasaudieutiet_tru_trai.Text);
                objKhamthiluc.KhucxasaudieutietTrucTrai = Utility.sDbnull(cbo_khucxasaudieutiet_truc_trai.Text);
                ...
                //Đơn kính
                objKhamthiluc.DonkinhCauPhai = Utility.sDbnull(cbo_donkinh_cau_phai.Text);
                objKhamthiluc.DonkinhTruPhai = Utility.sDbnull(cbo_donkinh_tru_phai.Text);
                objKhamthiluc.DonkinhTrucPhai = Utility.sDbnull(cbo_donkinh_truc_phai.Text);
                ...
                objKhamthiluc.DonkinhCauTrai = Utility.sDbnull(cbo_donkinh_cau_trai.Text);
                objKhamthiluc.DonkinhTruTrai = Utility.sDbnull(cbo_donkinh_tru_trai.Text);
                objKhamthiluc.DonkinhTrucTrai = Utility.sDbnull(cbo_donkinh_truc_trai.Text);
                ...
                if (objKhamthiluc.NgayKham.HasValue)
                    ...
                    objKhamthiluc.NgayKham = DateTime.Now;
        ...
        void modifyCommands()
        {
            ...
            else
            {
                ...
                cmdFinish.Enabled = objKhamthiluc.TrangThai <2;
        ...
        private void cmdBatdaukham_Click(object sender, EventArgs e)
        {
            ...
            if (dtpThoigian_batdau.Text == "" || !objKhamthiluc.ThoigianBatdau.HasValue)
                dtpThoigian_batdau.Value = DateTime.Now;
        ...
        private void cmdFinish_Click(object sender, EventArgs e)
        {
            ...
            PrepareData4Save();
            if (dtpThoigianKetthuc.Text == "" || !objKhamthiluc.ThoigianKetthuc.HasValue)
                dtpThoigianKetthuc.Value = DateTime.Now;
        ...
        private void lnkThoigianBatdau_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            dtpThoigian_batdau.Value = DateTime.Now;
        }

        private void lnkThoigianKetthuc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            dtpThoigianKetthuc.Value = DateTime.Now;
        }
    }
