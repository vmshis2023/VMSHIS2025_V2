...
{
    public partial class ucThongtinnguoibenh_v4 : UserControl
    {
            ...
            try
            {
                objBenhnhan = null;
                    ...
                    if (!AutoLoad)
                    {
                        ...
                        ClearControls();
                        txtMaluotkham.Text = _patient_Code;
                        dtPatient = new KCB_THAMKHAM().TimkiemBenhnhan(txtMaluotkham.Text, -1, noitrungoaitru, 0);
