...
{
    public partial class frm_danhsach_hoidong : Form
    {
        long id_phieu = -1;
        byte loai_phieu = 1;
        TBienbanKiemnhap objBienban = null;
        DataTable dtChitiet = new DataTable();
        public frm_danhsach_hoidong(long id_phieu,byte loai_phieu)
        {
            InitializeComponent();
        ...
        private void frm_danhsach_hoidong_Load(object sender, EventArgs e)
        {
            InitData();
        }
        void InitData()
        ...
        private void cmd_quanly_chucvu_Click_1(object sender, EventArgs e)
        {
