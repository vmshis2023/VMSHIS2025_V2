...
{
    public partial class frm_TimkiemBenhnhanNoitru : Form
    {
        ...
        public frm_TimkiemBenhnhanNoitru(string args,byte noitrungoaitru)
        {
            this._args = args;
            InitializeComponent();
        ...
        void frm_TimkiemBenhnhanNoitru_KeyDown(object sender, KeyEventArgs e)
        {
