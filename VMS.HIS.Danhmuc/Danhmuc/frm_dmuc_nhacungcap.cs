...
{
    public partial class frm_dmuc_nhacungcap : Form
    {
        ...
        public frm_dmuc_nhacungcap(string p_strArgs)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            ...
            {
                //Form load
                this.Load += new EventHandler(frm_dmuc_nhacungcap_Load);
                //Bắt sự kiện KeyDown trên form
                this.KeyDown += new KeyEventHandler(frm_dmuc_nhacungcap_KeyDown);
        ...
        private void InsertDataTable()
        {
            ...
            try
            {
                ...
                drNewRow[DmucChung.Columns.DienThoai] = Utility.DoTrim(txt_dienthoai.Text);
                drNewRow[DmucChung.Columns.DiaChi] = Utility.DoTrim(txt_diachi.Text);
                drNewRow[DmucChung.Columns.SoTaikhoan] = Utility.DoTrim(txt_sotk.Text);
                drNewRow[DmucChung.Columns.Mst] = Utility.DoTrim(txt_masothue.Text);
                drNewRow[DmucChung.Columns.Quocgia] = Utility.DoTrim(txt_quocgia.Text);
        ...
        private void UpdateDataTable()
        {
            try
            {
                ...
                drRow[DmucChung.Columns.DienThoai] = Utility.DoTrim(txt_dienthoai.Text);
                drRow[DmucChung.Columns.DiaChi] = Utility.DoTrim(txt_diachi.Text);
                drRow[DmucChung.Columns.SoTaikhoan] = Utility.DoTrim(txt_sotk.Text);
                drRow[DmucChung.Columns.Mst] = Utility.DoTrim(txt_masothue.Text);
                drRow[DmucChung.Columns.Quocgia] = Utility.DoTrim(txt_quocgia.Text);
        ...
        private DmucChung GetObject()
        {
            try
            {
                ...
                obj.DienThoai = Utility.DoTrim(txt_dienthoai.Text);
                obj.DiaChi = Utility.DoTrim(txt_diachi.Text);
                obj.SoTaikhoan = Utility.DoTrim(txt_sotk.Text);
                obj.Mst = Utility.DoTrim(txt_masothue.Text);
                obj.Quocgia = Utility.DoTrim(txt_quocgia.Text);
        ...
        /// <param name="e"></param>
        void frm_dmuc_nhacungcap_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="e"></param>
         ...
         void frm_dmuc_nhacungcap_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        void grdList_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr != null)
                {
                    ...
                    txt_dienthoai.Text = dr[DmucChung.Columns.DienThoai].ToString();
                    txt_diachi.Text = dr[DmucChung.Columns.DiaChi].ToString();
                    txt_masothue.Text = dr[DmucChung.Columns.Mst].ToString();
                    txt_sotk.Text = dr[DmucChung.Columns.SoTaikhoan].ToString();
                    txt_quocgia._Text = dr[DmucChung.Columns.Quocgia].ToString();
                }
