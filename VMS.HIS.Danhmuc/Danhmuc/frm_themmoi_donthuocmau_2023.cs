...
{
    public partial class frm_themmoi_donthuocmau_2023 : Form
    {
        ...
        public frm_themmoi_donthuocmau_2023(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            Load += new EventHandler(frm_themmoi_donthuocmau_2023_Load);
            KeyDown += new KeyEventHandler(frm_themmoi_donthuocmau_2023_KeyDown);
            FormClosing += new FormClosingEventHandler(frm_themmoi_donthuocmau_2023_FormClosing);
            ...
            grdPresDetail.CellUpdated += new ColumnActionEventHandler(grdAssignDetail_CellUpdated);
            grdPresDetail.CellValueChanged += new ColumnActionEventHandler(grdAssignDetail_CellValueChanged);
            grdPresDetail.ColumnHeaderClick += new ColumnActionEventHandler(grdAssignDetail_ColumnHeaderClick);
            grdPresDetail.FormattingRow += new RowLoadEventHandler(grdAssignDetail_FormattingRow);
            grdPresDetail.UpdatingCell += new UpdatingCellEventHandler(grdAssignDetail_UpdatingCell);
            grdPresDetail.KeyDown += new KeyEventHandler(grdAssignDetail_KeyDown);
            ...
            txtsolandung.TextChanged+=txtsolandung_TextChanged;
            txtsoluongdung.TextChanged+=txtsoluongdung_TextChanged;
            txtsang.TextChanged += txtCachDung_TextChanged;
            txttrua.TextChanged += txtCachDung_TextChanged;
            txtchieu.TextChanged += txtCachDung_TextChanged;
            txttoi.TextChanged += txtCachDung_TextChanged;
            SetTabStop();
        }
        ...
        void SetTabStop()
        {
            txtsolandung.TabStop = KIEU_THUOC_VT == "THUOC";
            txtsoluongdung.TabStop = KIEU_THUOC_VT == "THUOC";
            txtCachDung.TabStop = KIEU_THUOC_VT == "THUOC";
            txtsang.TabStop = txttrua.TabStop = txtchieu.TabStop = txttoi.TabStop = KIEU_THUOC_VT == "THUOC";
        }
         ...
         string phuthu, int tutuc)
        {
            ...
            txtDrug_ID.Text = ID;// string.Format("{0}-{1}", ID, txtDrugName._grid.grdListDrug.CurrentRow.Position);
        }
        ...
        private void frm_themmoi_donthuocmau_2023_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void FormatUserNhapChiDinh()
        {
            try
            {
                GridEXColumn gridExColumn =
                    grdPresDetail.RootTable.Columns[DmucDonthuocmauChitiet.Columns.NguoiTao];
                GridEXColumn gridExColumnTarget =
                    grdPresDetail.RootTable.Columns[DmucThuoc.Columns.TenThuoc];
                ...
                grdPresDetail.RootTable.FormatConditions.Add(gridExFormatCondition);
            }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_themmoi_donthuocmau_2023_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private bool IsValidDataXoaCLS_Selected()
        {
            ...
            if (!globalVariables.IsAdmin)
            {
                ...
                IdChitiet_ID =
                    Utility.Int32Dbnull(
                        grdPresDetail.CurrentRow.Cells[DmucDonthuocmauChitiet.Columns.IdChitiet].Value, -1);
        ...
        private void ModifyCommand()
        {
            try
            {
                cmdSave.Enabled = grdPresDetail.RowCount > 0;
                cmdDelete.Enabled = grdPresDetail.RowCount > 0;
                cmdInPhieuCLS.Enabled = grdPresDetail.RowCount > 0;
                ModifyButtonCommand();
            }
            catch (Exception ex)
            {
        ...
        private DmucDonthuocmau TaoDmucDonThuocMau()
        {
            ...
            objDonthuocmau.SharedX = Utility.Bool2byte(chkShared.Checked);
        ...
        private List<DmucDonthuocmauChitiet> TaoDmucDonThuocMauChitiet()
        {
            ...
            foreach (GridEXRow gridExRow in grdPresDetail.GetDataRows())
            {
                if (gridExRow.RowType == RowType.Record)
                {
                    ...
                    newItem.Sang = Utility.Int16Dbnull(gridExRow.Cells[DmucDonthuocmauChitiet.Columns.Sang].Value, 1);
                    newItem.Trua = Utility.Int16Dbnull(gridExRow.Cells[DmucDonthuocmauChitiet.Columns.Trua].Value, 1);
                    newItem.Chieu = Utility.Int16Dbnull(gridExRow.Cells[DmucDonthuocmauChitiet.Columns.Chieu].Value, 1);
                    newItem.Toi = Utility.Int16Dbnull(gridExRow.Cells[DmucDonthuocmauChitiet.Columns.Toi].Value, 1);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_themmoi_donthuocmau_2023_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            cmdDelete.Enabled = grdPresDetail.GetCheckedRows().Length > 0;
            cmdSave.Enabled = grdPresDetail.RowCount > 0;
        }
        ...
        private void grdAssignDetail_UpdatingCell(object sender, UpdatingCellEventArgs e)
        {
            try
            {
                ...
                else if (e.Column.Key == "sang" || e.Column.Key == "trua" || e.Column.Key == "chieu" || e.Column.Key == "toi")
                {
                    string chidan = GetContainGuide(Utility.sDbnull(grdPresDetail.GetValue("sang"), ""), Utility.sDbnull(grdPresDetail.GetValue("trua"), ""), Utility.sDbnull(grdPresDetail.GetValue("chieu"), ""), Utility.sDbnull(grdPresDetail.GetValue("toi"), ""), Utility.sDbnull(grdPresDetail.GetValue("cach_dung"), ""), Utility.sDbnull(grdPresDetail.GetValue("dvt"), ""));
                    grdPresDetail.CurrentRow.BeginEdit();
                    grdPresDetail.CurrentRow.Cells["chidan_them"].Value = chidan;
        ...
        private void mnuDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                long IdChitiet =
                    Utility.Int64Dbnull(grdPresDetail.CurrentRow.Cells[DmucDonthuocmauChitiet.Columns.IdChitiet].Value, -1);
        ...
        private void GetData()
        {
            ...
            if (objDonthuocmau != null)
            {
                ...
                chkShared.Checked = Utility.Byte2Bool(objDonthuocmau.SharedX);
            }
            else
            {
                txtId.Text = "Tự sinh";
        ...
        private void LayThongTin_Chitiet_donthuocmau()
        {
            try
            {
                ...
                Utility.SetDataSourceForDataGridEx(grdPresDetail, m_dtChitietNhom, false, true, "1=1", "" + DmucThuoc.Columns.TenThuoc);
        ...
        private bool IsvalidChitiet()
        {
            ...
            decimal soluong = Utility.DecimaltoDbnull(txtSoluong.Text, 0);
            ...
            if (soluong <= 0)
            {
                Utility.ShowMsg("Số lượng kê phải >0", "Thông báo");
                txtSoluong.Focus();
                return false;
            }
        ...
        private void ThemMoiChiTiet()
        {
            try
            {
                ...
                if (arrDr.Length > 0)
                {
                    ...
                    arrDr[0][DmucDonthuocmauChitiet.Columns.SolanDung] = Utility.DecimaltoDbnull(txtsolandung.Text);
                    arrDr[0][DmucDonthuocmauChitiet.Columns.SoluongDung] = Utility.DecimaltoDbnull(txtsoluongdung.Text);
                    arrDr[0][DmucDonthuocmauChitiet.Columns.CachDung] = txtCachDung.Text;
                    arrDr[0][DmucDonthuocmauChitiet.Columns.ChidanThem] = txtChiDanDungThuoc.Text;
                    m_dtChitietNhom.AcceptChanges();
                }
                else
                {
                    ...
                    drv[DmucDonthuocmauChitiet.Columns.Sang] = Utility.DecimaltoDbnull(txtsang.Text);
                    drv[DmucDonthuocmauChitiet.Columns.Trua] = Utility.DecimaltoDbnull(txttrua.Text);
                    drv[DmucDonthuocmauChitiet.Columns.Chieu] = Utility.DecimaltoDbnull(txtchieu.Text);
                    drv[DmucDonthuocmauChitiet.Columns.Toi] = Utility.DecimaltoDbnull(txttoi.Text);
        ...
        private string GetContainGuide()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(txttoi.Text))
                {
                    if (!string.IsNullOrEmpty(yourString))
