...
{
    public partial class frm_themmoi_donthuocmau : Form
    {
        ...
        private DataTable m_dtChitietDonthuocmau = new DataTable();
        ...
        public frm_themmoi_donthuocmau(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            Load += new EventHandler(frm_themmoi_donthuocmau_Load);
            KeyDown += new KeyEventHandler(frm_themmoi_donthuocmau_KeyDown);
            FormClosing += new FormClosingEventHandler(frm_themmoi_donthuocmau_FormClosing);
            ...
            grdChitietDonthuocmau.CellUpdated += new ColumnActionEventHandler(grdAssignDetail_CellUpdated);
            grdChitietDonthuocmau.CellValueChanged += new ColumnActionEventHandler(grdAssignDetail_CellValueChanged);
            grdChitietDonthuocmau.ColumnHeaderClick += new ColumnActionEventHandler(grdAssignDetail_ColumnHeaderClick);
            grdChitietDonthuocmau.FormattingRow += new RowLoadEventHandler(grdAssignDetail_FormattingRow);
            grdChitietDonthuocmau.UpdatingCell += new UpdatingCellEventHandler(grdAssignDetail_UpdatingCell);
            grdChitietDonthuocmau.KeyDown += new KeyEventHandler(grdAssignDetail_KeyDown);
        ...
        private void frm_themmoi_donthuocmau_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (grdChitietDonthuocmau.RowCount > 0)
            {
                if (!isSaved)
                {
                    if (m_dtChitietDonthuocmau.Select("NoSave=1").Length > 0)
                    {
                        if (
        ...
        private void FormatUserNhapChiDinh()
        {
            try
            {
                GridEXColumn gridExColumn =
                    grdChitietDonthuocmau.RootTable.Columns[DmucDonthuocmauChitiet.Columns.NguoiTao];
                GridEXColumn gridExColumnTarget =
                    grdChitietDonthuocmau.RootTable.Columns[DmucThuoc.Columns.TenThuoc];
                ...
                grdChitietDonthuocmau.RootTable.FormatConditions.Add(gridExFormatCondition);
            }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_themmoi_donthuocmau_Load(object sender, EventArgs e)
        {
            try
            {
                bool gridView =
        ...
        private void cmdDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridEXRow gridExRow in grdChitietDonthuocmau.GetCheckedRows())
                {
                    ...
                    gridExRow.Delete();
                    grdChitietDonthuocmau.UpdateData();
                    grdChitietDonthuocmau.Refresh();
                    m_dtChitietDonthuocmau.AcceptChanges();
                }
        ...
        {
            if (grdChitietDonthuocmau.RowCount <= 0 || grdChitietDonthuocmau.CurrentRow.RowType != RowType.Record)
            {
                Utility.ShowMsg("Bạn phải thực hiện chọn một thuốc cần xóa khỏi nhóm",
                                "Thông báo", MessageBoxIcon.Warning);
                grdChitietDonthuocmau.Focus();
            ...
            if (!globalVariables.IsAdmin)
            {
                ...
                IdChitiet_ID =
                    Utility.Int32Dbnull(
                        grdChitietDonthuocmau.CurrentRow.Cells[DmucDonthuocmauChitiet.Columns.IdChitiet].Value, -1);
        ...
        private void ModifyCommand()
        {
            try
            {
                cmdSave.Enabled = grdChitietDonthuocmau.RowCount > 0;
                cmdDelete.Enabled = grdChitietDonthuocmau.RowCount > 0;
                cmdInPhieuCLS.Enabled = grdChitietDonthuocmau.RowCount > 0;
                ModifyButtonCommand();
            }
            catch (Exception ex)
            {
        ...
        private List< DmucDonthuocmauChitiet> TaoDmucDonThuocMauChitiet()
        {
            ...
            foreach (GridEXRow gridExRow in grdChitietDonthuocmau.GetDataRows())
            {
             DmucDonthuocmauChitiet newItem= GetDonthuocMauChitiet(gridExRow);
             if (newItem != null)
        ...
        DmucDonthuocmauChitiet GetDonthuocMauChitiet(GridEXRow gridExRow)
        {
        ...
        DmucDonthuocmauChitiet GetDonthuocMauChitiet(DataRow dr)
        {
            if (dr!=null)
            {
                DmucDonthuocmauChitiet newItem = new DmucDonthuocmauChitiet();
                int newID = Utility.Int32Dbnull(dr[DmucDonthuocmauChitiet.Columns.IdChitiet], -1);
                if (newID > 0)
                {
                    newItem = DmucDonthuocmauChitiet.FetchByID(newID);
                    newItem.IsLoaded = true;
                ...
                newItem.IdNhom = Utility.Int16Dbnull(txtId.Text, -1);
                newItem.IdLoaithuoc = Utility.Int16Dbnull(dr[DmucDonthuocmauChitiet.Columns.IdLoaithuoc], -1);
                newItem.IdThuoc = Utility.Int16Dbnull(dr[DmucDonthuocmauChitiet.Columns.IdThuoc], -1);
                newItem.SoLuong = Utility.Int16Dbnull(dr[DmucDonthuocmauChitiet.Columns.SoLuong], 1);
                newItem.SttHienthi = Utility.Int16Dbnull(dr[DmucDonthuocmauChitiet.Columns.SttHienthi], 1);
                newItem.DonviTinh = Utility.sDbnull(dr[DmucDonthuocmauChitiet.Columns.DonviTinh], "");
                newItem.SolanDung = Utility.sDbnull(dr[DmucDonthuocmauChitiet.Columns.SolanDung], "");
                newItem.SoluongDung = Utility.sDbnull(dr[DmucDonthuocmauChitiet.Columns.SoluongDung], "");
                newItem.CachDung = Utility.sDbnull(dr[DmucDonthuocmauChitiet.Columns.CachDung], "");
                newItem.ChidanThem = Utility.sDbnull(dr[DmucDonthuocmauChitiet.Columns.ChidanThem], "");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_themmoi_donthuocmau_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        void ResetNewItem()
        {
            if (m_dtChitietDonthuocmau == null || !m_dtChitietDonthuocmau.Columns.Contains("isnew")) return;
            foreach (DataRow dr in m_dtChitietDonthuocmau.Rows)
                dr["isnew"] = 0;
            m_dtChitietDonthuocmau.AcceptChanges();
        }
        void SetSaveStatus()
        ...
        {
            cmdDelete.Enabled = grdChitietDonthuocmau.GetCheckedRows().Length > 0;
            cmdSave.Enabled = grdChitietDonthuocmau.RowCount > 0;
        }
        ...
        private void grdAssignDetail_UpdatingCell(object sender, UpdatingCellEventArgs e)
        {
            try
            {
                if (e.Column.Key == DmucNhomcanlamsangChitiet.Columns.SoLuong)
                {
                    ...
                    GridEXRow _row = grdChitietDonthuocmau.CurrentRow;
        ...
        private void mnuDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                long IdChitiet =
                    Utility.Int64Dbnull(grdChitietDonthuocmau.CurrentRow.Cells[DmucDonthuocmauChitiet.Columns.IdChitiet].Value, -1);

                //CHIDINH_CANLAMSANG.XoaCLSChitietKhoinhom(IdChitiet);
                new Delete().From(DmucDonthuocmauChitiet.Schema).Where(DmucDonthuocmauChitiet.Columns.IdChitiet).IsEqualTo(IdChitiet).Execute();
                if (_OnActionSuccess != null) _OnActionSuccess();
                grdChitietDonthuocmau.CurrentRow.Delete();
                grdChitietDonthuocmau.UpdateData();
                grdChitietDonthuocmau.Refresh();
                m_dtChitietDonthuocmau.AcceptChanges();
                m_blnCancel = false;
        ...
        private void LayThongTin_Chitiet_donthuocmau()
        {
            try
            {
                m_dtChitietDonthuocmau = kedonthuoc.DmucLaychitietDonThuocMau(Utility.Int32Dbnull(txtId.Text, -1));
                Utility.SetDataSourceForDataGridEx(grdChitietDonthuocmau, m_dtChitietDonthuocmau, false, true, "1=1", "stt_hienthi, " + DmucThuoc.Columns.TenThuoc);
                grdChitietDonthuocmau.MoveFirst();
                ModifyCommand();
            }
            catch (Exception ex)
            {
        ...
        private void ThemMoiChiTiet()
        {
            try
            {
                DataRow[] arrDr = m_dtChitietDonthuocmau.Select(DmucDonthuocmauChitiet.Columns.IdThuoc + "=" + txtDrug_ID.Text);
                if (arrDr.Length > 0)
                {
                ...
                {
                    DataRow drv = m_dtChitietDonthuocmau.NewRow();
                    ...
                    drv[DmucDonthuocmauChitiet.Columns.SttHienthi] = GetMaxSTT(m_dtChitietDonthuocmau, 1);// Utility.sDbnull(m_dtChitietDonthuocmau.Rows.Count + 1);
                    ...
                    m_dtChitietDonthuocmau.Rows.Add(drv);
                }
            }
            catch (Exception exception)
            {
        ...
        private int GetMaxSTT(DataTable dataTable, int addedvalues)
        {
            try
            {
                return
                    (Utility.Int32Dbnull(
                        dataTable.AsEnumerable().Max(c => c.Field<short>(DmucDonthuocmauChitiet.Columns.SttHienthi)), 0) + addedvalues);
            }
            catch (Exception)
            {
        ...
        {
            int STT = Utility.Int32Dbnull(grdChitietDonthuocmau.CurrentRow.Cells[DmucDonthuocmauChitiet.Columns.SttHienthi].Value, 0);
            if (STT == grdChitietDonthuocmau.RowCount) return;//nút chắc chắn đã bị disable nên ko click được nhưng cứ bắt
            cmdDown.Enabled = STT == grdChitietDonthuocmau.RowCount - 1;
            DoiSTT(grdChitietDonthuocmau.CurrentRow, STT, STT + 1, true);
            ModifyUpDownButton();
        }
        ...
        bool DoiSTT(GridEXRow currentR, int STT_cu, int STT_moi, bool hoandoi)
        {
            try
            {
                int maxstt = GetMaxSTT(m_dtChitietDonthuocmau, 0);
                DataRow[] arrDr = null;
                //Tìm bản ghi có STT=số thứ tự mới và khác id chi tiết để hoán đổi số thứ tự với dòng hiện tại
                if (hoandoi)
                {
                    string filter = string.Format("{0}<>{1} and {2}={3}", DmucDonthuocmauChitiet.Columns.IdThuoc, currentR.Cells[DmucDonthuocmauChitiet.Columns.IdThuoc].Value, DmucDonthuocmauChitiet.Columns.SttHienthi, STT_moi);
                    arrDr = m_dtChitietDonthuocmau.Select(filter);
                    if (arrDr.Length > 0)
                    {
                        arrDr[0][DmucDonthuocmauChitiet.Columns.SttHienthi] = STT_cu;
                    }
                }
                //Tìm bản ghi hiện tại để đổi STT
                ((DataRowView)currentR.DataRow).Row[DmucDonthuocmauChitiet.Columns.SttHienthi] = STT_moi;// > maxstt ? STT_moi : maxstt;
                m_dtChitietDonthuocmau.AcceptChanges();
                if (THU_VIEN_CHUNG.Laygiatrithamsohethong("KCB_DONTHUOCMAU_CAPNHAT_STT_NGAYSAUKHITHAYDOI", "0", true) == "1")
                {
                    DmucDonthuocmauChitiet objChitiet = GetDonthuocMauChitiet(currentR);
                    if (objChitiet.IdChitiet > 0)
                        new Update(DmucDonthuocmauChitiet.Schema).Where(DmucDonthuocmauChitiet.Columns.SttHienthi).IsEqualTo(objChitiet.SttHienthi).Where(DmucDonthuocmauChitiet.Columns.IdChitiet).IsEqualTo(objChitiet.IdChitiet).Execute();
                    objChitiet = GetDonthuocMauChitiet(arrDr[0]);
                    if (objChitiet.IdChitiet > 0)
                        new Update(DmucDonthuocmauChitiet.Schema).Where(DmucDonthuocmauChitiet.Columns.SttHienthi).IsEqualTo(objChitiet.SttHienthi).Where(DmucDonthuocmauChitiet.Columns.IdChitiet).IsEqualTo(objChitiet.IdChitiet).Execute();
                }
        ...
        {
            bool canDown = Utility.isValidGrid(grdChitietDonthuocmau) && grdChitietDonthuocmau.RowCount > 1 && grdChitietDonthuocmau.CurrentRow.Position < grdChitietDonthuocmau.RowCount - 1;
            bool canUp = Utility.isValidGrid(grdChitietDonthuocmau) && grdChitietDonthuocmau.RowCount > 1 && grdChitietDonthuocmau.CurrentRow.Position > 0;
