...
{
    public partial class frm_themmoi_donthuocmau_2023_V1 : Form
    {
        ...
        public frm_themmoi_donthuocmau_2023_V1(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            Load += new EventHandler(frm_themmoi_donthuocmau_2023_V1_Load);
            KeyDown += new KeyEventHandler(frm_themmoi_donthuocmau_2023_V1_KeyDown);
            FormClosing += new FormClosingEventHandler(frm_themmoi_donthuocmau_2023_V1_FormClosing);
        ...
        private void frm_themmoi_donthuocmau_2023_V1_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_themmoi_donthuocmau_2023_V1_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_themmoi_donthuocmau_2023_V1_KeyDown(object sender, KeyEventArgs e)
        {
