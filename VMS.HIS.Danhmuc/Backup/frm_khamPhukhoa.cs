...
namespace VNS.HIS.UI.NGOAITRU
{
    public partial class frm_khamPhukhoa : Form
    {
        ...
        public frm_khamPhukhoa(KcbLuotkham objLuotkham)
        {
            InitializeComponent();
        ...
        void grdLichSu_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                objphieukham = EmrPhieukhamPhukhoa.FetchByID(Utility.Int64Dbnull(grdLichSu.GetValue("id")));
                FillData();
            }
        }
            ...
            try
            {
                ...
                if (globalVariables.IsAdmin || Utility.sDbnull(grdLichSu.GetValue("id_bacsi"), "-1") == globalVariables.gv_intIDNhanvien.ToString())
                {
                    ...
                    if (objphieukham != null)
                    {
                        ...
                        {
                            EmrPhieukhamPhukhoa.Delete(objphieukham.Id);
        ...
        void cmdthemmoi_Click(object sender, EventArgs e)
        {
            ...
            objphieukham = new EmrPhieukhamPhukhoa();
            SetControlStatus();
        }
        ...
        void ucThongtinnguoibenh1__OnEnterMe()
        {
            if (ucThongtinnguoibenh1.objLuotkham != null)
            {
                ...
                //uc_tiensusanphukhoa1.Init(objLuotkham, null);
                //uc_tiensusanphukhoa1.DisplayData();
                AllowedChanged = false;
                LoadLichSu();
                AllowedChanged = true;
                grdLichSu_SelectionChanged(grdLichSu, new EventArgs());
        ...
        private void LoadLichSu()
        {
            ...
            m_dtData = SPs.KcbLaydanhsachPhieukhamphukhoa(objLuotkham.IdBenhnhan, objLuotkham.MaLuotkham).GetDataSet().Tables[0];

            Utility.SetDataSourceForDataGridEx(grdLichSu, m_dtData, true, true, "1=1", "ngay_kham desc");
        }
        EmrPhieukhamPhukhoa objphieukham = null;
        private void FillData()
        {
            try
            {
                if (objphieukham != null)
                {
                    ...
                    txtDaniemmac.Text = objphieukham.PhukhoaDaniemmac;
                    txtHach.Text = objphieukham.PhukhoaHach;
                    txtVu.Text = objphieukham.PhukhoaVu;
                    ...
                    //txtTuanhoan.Text = objphieukham.PhukhoaTuanhoan;
                    //txtHohap.Text = objphieukham.PhukhoaHohap;
                    //txtTieuhoa.Text = objphieukham.PhukhoaTieuhoa;
                    //txtThantietnieu.Text = objphieukham.PhukhoaThantietnieusinhduc;
                    //txtThankinh.Text = objphieukham.PhukhoaThankinh;
                    //txtCoxuongkhop.Text = objphieukham.PhukhoaCoxuongkhop;
                    //txtTaimuihong.Text = objphieukham.PhukhoaTaimuihong;
                    //txtRanghammat.Text = objphieukham.PhukhoaRanghammat;
                    //txtMat.Text = objphieukham.PhukhoaMat;
                    //txtBophanKhac.Text = objphieukham.PhukhoaKhac;
                    //khám ngoài
                    txtCacdauhieusinhducthuphat.Text = objphieukham.BaKckCacdauhieusinhducthuphat;
                    txtMoilon.Text = objphieukham.BaKckMoilon;
                    txtMoibe.Text = objphieukham.BaKckMoibe;
                    txtAmvat.Text = objphieukham.BaKckAmvat;
                    txtAmho.Text = objphieukham.BaKckAmho;
                    txtMangtrinh.Text = objphieukham.BaKckMangtrinh;
                    txtTangsinhmon.Text = objphieukham.BaKckTangsinhmon;
                    //Khám trong
                    txtAmdao.Text = objphieukham.BaKckAmdao;
                    txtCotucung.Text = objphieukham.BaKckCotucung;
                    txtThantucung.Text = objphieukham.BaKckThantucung;
                    txtPhanphu.Text = objphieukham.BaKckPhanphu;
                    txtCactuicung.Text = objphieukham.BaKckCactuicung;
                    ...
                    txt_batdauthaykinh_nam.Text = Utility.sDbnull(objphieukham.BaTsspkBatdauthaykinhNam);
                    txt_batdauthaykinhtuoi.Text = Utility.sDbnull(objphieukham.BaTsspkBatdauthaykinhTuoi);
                    txt_tinhchatkinhnguyet.Text = Utility.sDbnull(objphieukham.BaTsspkTinhchatkinhnguyet);
                    txt_chuky.Text = Utility.sDbnull(objphieukham.BaTsspkChuky);
                    txt_songaythaykinh.Text = Utility.sDbnull(objphieukham.BaTsspkSongaythaykinh);
                    txt_luongkinh.Text = Utility.sDbnull(objphieukham.BaTsspkLuongkinh);
                    if (objphieukham.BaTsspkKinhlancuoingay.HasValue)
                        dtpKinhlancuoingay.Value = objphieukham.BaTsspkKinhlancuoingay.Value;
                    else
                        dtpKinhlancuoingay.ResetText();
                    chkCodaubung.Checked = Utility.Bool2Bool(objphieukham.BaTsspkCodaubung);
                    chk_thoigiantruoc.Checked = Utility.Bool2Bool(objphieukham.BaTsspkThoigianTruoc);
                    chk_thoigiantrong.Checked = Utility.Bool2Bool(objphieukham.BaTsspkThoigianTrong);
                    chk_thoigiansau.Checked = Utility.Bool2Bool(objphieukham.BaTsspkThoigianSau);
                    txt_laychongnam.Text = Utility.sDbnull(objphieukham.BaTsspkLaychongNam);
                    txt_laychongtuoi.Text = Utility.sDbnull(objphieukham.BaTsspkLaychongTuoi);
                    txt_hetkinhnam.Text = Utility.sDbnull(objphieukham.BaTsspkHetkinhnam);
                    txt_hetkinhtuoi.Text = Utility.sDbnull(objphieukham.BaTsspkHetkinhtuoi);
                    txt_benhphukhoadadieutri.Text = Utility.sDbnull(objphieukham.BaTsspkBenhphukhoadadieutri);
                    txt_para.Text = Utility.sDbnull(objphieukham.BaTsspkPara);
                }
                else
                {
        ...
        void SaveData()
        {
            try
            {
                ...
                objphieukham.PhukhoaDaniemmac = Utility.sDbnull(txtDaniemmac.Text);
                objphieukham.PhukhoaHach = Utility.sDbnull(txtHach.Text);
                objphieukham.PhukhoaVu = Utility.sDbnull(txtVu.Text);
                //objphieukham.PhukhoaTuanhoan = Utility.sDbnull(txtTuanhoan.Text);
                //objphieukham.PhukhoaHohap = Utility.sDbnull(txtHohap.Text);
                //objphieukham.PhukhoaTieuhoa = Utility.sDbnull(txtTieuhoa.Text);
                //objphieukham.PhukhoaThantietnieusinhduc = Utility.sDbnull(txtThantietnieu.Text);
                //objphieukham.PhukhoaThankinh = Utility.sDbnull(txtThankinh.Text);
                //objphieukham.PhukhoaCoxuongkhop = Utility.sDbnull(txtCoxuongkhop.Text);
                //objphieukham.PhukhoaTaimuihong = Utility.sDbnull(txtTaimuihong.Text);
                //objphieukham.PhukhoaRanghammat = Utility.sDbnull(txtRanghammat.Text);
                //objphieukham.PhukhoaMat = Utility.sDbnull(txtMat.Text);
                //objphieukham.PhukhoaKhac = Utility.sDbnull(txtBophanKhac.Text);
                //Khám ngoài
                objphieukham.BaKckCacdauhieusinhducthuphat = Utility.sDbnull(txtCacdauhieusinhducthuphat.Text);
                objphieukham.BaKckMoilon = Utility.sDbnull(txtMoilon.Text);
                objphieukham.BaKckMoibe = Utility.sDbnull(txtMoibe.Text);
                objphieukham.BaKckAmvat = Utility.sDbnull(txtAmvat.Text);
                objphieukham.BaKckAmho = Utility.sDbnull(txtAmho.Text);
                objphieukham.BaKckMangtrinh = Utility.sDbnull(txtMangtrinh.Text);
                objphieukham.BaKckTangsinhmon = Utility.sDbnull(txtTangsinhmon.Text);
                //Khám trong
                objphieukham.BaKckAmdao = Utility.sDbnull(txtAmdao.Text);
                objphieukham.BaKckCotucung = Utility.sDbnull(txtCotucung.Text);
                objphieukham.BaKckThantucung = Utility.sDbnull(txtThantucung.Text);
                objphieukham.BaKckPhanphu = Utility.sDbnull(txtPhanphu.Text);
                objphieukham.BaKckCactuicung = Utility.sDbnull(txtCactuicung.Text);
                //Chức năng sống
                ...
                objphieukham.BaTsspkBatdauthaykinhNam = Utility.Int16Dbnull(txt_batdauthaykinh_nam.Text, 0);
                objphieukham.BaTsspkBatdauthaykinhTuoi = Utility.Int16Dbnull(txt_batdauthaykinhtuoi.Text, 0);
                objphieukham.BaTsspkTinhchatkinhnguyet = Utility.sDbnull(txt_tinhchatkinhnguyet.Text);
                objphieukham.BaTsspkChuky = Utility.Int16Dbnull(txt_chuky.Text, 0);
                objphieukham.BaTsspkSongaythaykinh = Utility.Int16Dbnull(txt_songaythaykinh.Text, 0);
                objphieukham.BaTsspkLuongkinh = Utility.sDbnull(txt_luongkinh.Text);
                objphieukham.BaTsspkKinhlancuoingay = dtpKinhlancuoingay.Value;
                objphieukham.BaTsspkCodaubung = chkCodaubung.Checked;
                objphieukham.BaTsspkThoigianTruoc = chk_thoigiantruoc.Checked;
                objphieukham.BaTsspkThoigianTrong = chk_thoigiantrong.Checked;
                objphieukham.BaTsspkThoigianSau = chk_thoigiansau.Checked;

                objphieukham.BaTsspkLaychongNam = Utility.Int16Dbnull(txt_laychongnam.Text, 0);
                objphieukham.BaTsspkLaychongTuoi = Utility.Int16Dbnull(txt_laychongtuoi.Text, 0);
                objphieukham.BaTsspkHetkinhnam = Utility.Int16Dbnull(txt_hetkinhnam.Text, 0);
                objphieukham.BaTsspkHetkinhtuoi = Utility.Int16Dbnull(txt_hetkinhtuoi.Text, 0);
                objphieukham.BaTsspkBenhphukhoadadieutri = Utility.sDbnull(txt_benhphukhoadadieutri.Text);
                objphieukham.BaTsspkPara = Utility.sDbnull(txt_para.Text);
