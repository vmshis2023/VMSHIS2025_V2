    ...
    public partial class frm_KCB_KE_DONTHUOC : Form
    {
        ...
        private void AddPreDetail()
        {
            try
            {
                ...
                decimal num = CommonLoadDuoc.SoLuongTonTrongKho(-1L, Utility.Int32Dbnull(cmd_khokedon.SelectedValue), Utility.Int32Dbnull(txtDrugID.Text, -1), -1,
                ...
                DataTable listdata =
                    new XuatThuoc().GetObjThuocKhoCollection(
                        Utility.Int32Dbnull(cmd_khokedon.SelectedValue, 0),
                    ...
                    if (soluong > 0)
                    {
                        ...
                        else//Kê 1 dòng thuốc kho mới
                        {
                            ...
                            row[KcbDonthuocChitiet.Columns.IdKho] =
                                Utility.Int32Dbnull(cmd_khokedon.SelectedValue, -1);
                        ...
                        if (IdThuockho > 0)//100%
                        {
                            ...
                            THU_VIEN_CHUNG.UpdateKeTam(id_donthuocchitiet, id_donthuoc, GUID, privateguid, IdThuockho, objThuoc.IdThuoc, Utility.Int16Dbnull(cmd_khokedon.SelectedValue), tongsoluong, (byte)LoaiTamKe.KEDONTHUOC,
        ...
        private bool AddQuantity(int id_thuoc, long id_thuockho, decimal SlMoi,decimal SlCu)
        {
            try
            {
                ...
                //{
                    decimal sluongton = CommonLoadDuoc.SoLuongTonTrongKho(-1L, Utility.Int32Dbnull(cmd_khokedon.SelectedValue),
                ...
                //}
                DataTable listdata =
                    new XuatThuoc().GetObjThuocKhoCollection(Utility.Int32Dbnull(cmd_khokedon.SelectedValue, 0), id_thuoc,
                ...
                foreach (DataRow thuockho in listdata.Rows)
                {
                    ...
                    if (_soluong > 0)
                    {
                        ...
                        else//Id thuốc kho mới
                        {
                            ...
                            row[KcbDonthuocChitiet.Columns.NgayNhap] = thuockho[TThuockho.Columns.NgayNhap];
                            row[KcbDonthuocChitiet.Columns.IdKho] = Utility.Int32Dbnull(cmd_khokedon.SelectedValue, -1);
                            row[TDmucKho.Columns.TenKho] = Utility.sDbnull(cmd_khokedon.Text, -1);
                            ...
                            if (IdThuockho > 0)//100%
                            {
                                ...
                                //Dùng bảng tạm kê để lưu trữ
                                THU_VIEN_CHUNG.UpdateKeTam(-1, -1, GUID,privateguid, IdThuockho, objThuoc.IdThuoc, Utility.Int16Dbnull(cmd_khokedon.SelectedValue), Utility.DecimaltoDbnull(_soluong), (byte)LoaiTamKe.KEDONTHUOC,
                ...
                else if ((e.Column.Key != KcbDonthuocChitiet.Columns.TuTuc) && (e.Column.Key == KcbDonthuocChitiet.Columns.SoLuong))
                {
                    ...
                    if (sluong_moi != sluong_cu)
                    {
                        ...
                        else//Giảm số lượng kê-->Không cần kiểm tra tồn--Cập nhật lại trong bảng tạm kê
                        {
                            ...
                            THU_VIEN_CHUNG.UpdateKeTam(_IdChitietdonthuoc, _IdDonthuoc, GUID, privateguid, _IdThuockho, idThuoc, Utility.Int16Dbnull(cmd_khokedon.SelectedValue), Utility.DecimaltoDbnull(sluong_moi), (byte)LoaiTamKe.KEDONTHUOC,
...
//        }
        ...
        private void txtDrugID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rowArray.Length > 0)
                {
                    ...
                    txtTonKho.Text =
                        CommonLoadDuoc.SoLuongTonTrongKho(-1L, Utility.Int32Dbnull(cmd_khokedon.SelectedValue),
                            Utility.Int32Dbnull(txtDrugID.Text, -1),
                            txtdrug.GridView
                                ? id_thuockho
                                : txtdrug.id_thuockho,
        ...
        private void grdListDonThuocCu_ColumnButtonClick(object sender, ColumnActionEventArgs e)
        {
            if (e.Column.Key == "Chon")
            {
                ...
                frm.idkhosaochep = Utility.Int16Dbnull(cmd_khokedon.SelectedValue, -1);
