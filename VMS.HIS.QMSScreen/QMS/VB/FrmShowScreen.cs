...
namespace VMS.QMS
{
    public partial class FrmShowScreen : Form
    {
        ...
        string layoutfile = Application.StartupPath + @"\QMSGrid0.layout";
        ...
        public FrmShowScreen(bool UsingWS, int QMSType, int numberofDisplay,string layout)
        {
            ...
            this.Resize += FrmShowScreen_Resize;
            this.Shown += FrmShowScreen_Shown;
            this.FormClosing+=FrmShowScreen_FormClosing;
            CauHinh();
        }

        void FrmShowScreen_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                e.Cancel = !_closeme;
        ...
        void FrmShowScreen_Resize(object sender, EventArgs e)
        {
        ...
        void FrmShowScreen_Shown(object sender, EventArgs e)
        {
        ...
        public void CauHinh()
        {
            ...
            //lbldanhsachnho.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColorDanhsachnho);
            //lblSoDangKham.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColorSodangkham);
            //lbltenbacsy.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColorTenbacsi);//Color.DarkBlue;
            //lblphongkham.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColorphongkham);
            //lbldanhsachchokham.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColordanhsachchokham);
            //lblTenDangKham.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColorTendangkham);
            //grdList.ForeColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._ForeColorGrid);


            //lbltenbacsy.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColorTenbacsi);
            //lblphongkham.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColorphongkham);
            //lblSoDangKham.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColorSodangkham);
            //lbldanhsachchokham.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColordanhsachchokham);
            //lblTenDangKham.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColorTendangkham);
            //grdList.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColorGrid);
            //lbldanhsachnho.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColorDanhsachnho);
           ...
           // this.BackColor = System.Drawing.ColorTranslator.FromHtml(_qmsPrintProperties._backColor);
            ...
            pnlLogo.Height = PropertyLib._QMSColorProperties.BottomHeight;
            lblphongkham.Font = new Font(lblphongkham.Font.FontFamily, PropertyLib._QMSColorProperties.TenphongkhamFontSize);
            ...
            lblSoDangKham.Font = new Font(lblSoDangKham.Font.FontFamily, PropertyLib._QMSColorProperties.SodangkhamFontSize);
        ...
        private void FrmShowScreen_Load(object sender, EventArgs e)
        {
            _log.Trace("Load...");
            LoadThongTinKhoaPhong();
        ...
        private void LoadDanhsach(string maphong, DateTime _ngaytao, int trangthai, string maKhoa)
        {
            ...
            try
            {
                ...
                if (nhacnho.Length > 0)
                    nhacnho = "Danh sách bệnh nhân nhỡ: " + nhacnho;
                if (mDtDanhSachChoKhamNext.Rows.Count > 0 || arrDangThien.Length > 0)
                {
                    ...
                    if (rowDangkham.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in rowDangkham.AsEnumerable())
                        {
                            ...
                            string _text = string.Format( "{0}: {1}" ,Utility.Int32Dbnull(row["Uu_tien"], 0) == 0 ?_qmsPrintProperties.XQActSothuong:_qmsPrintProperties.XQActSoUutien, sSoKham);
                            if (_text != lblSoDangKham.Text)
                                lblSoDangKham.Text = _text;
                            string thongtinnguoibenh = "";
                            if( PropertyLib._QMSColorProperties.DisplayType==0)
                                thongtinnguoibenh = string.Format("{0}", row["TEN_BENHNHAN"]);
                            else if (PropertyLib._QMSColorProperties.DisplayType == 1)
                                thongtinnguoibenh = string.Format("{0}-{1}", row["TEN_BENHNHAN"], row["gioitinh"]);
                            else if (PropertyLib._QMSColorProperties.DisplayType == 2)
                                thongtinnguoibenh = string.Format("{0}-{1}-{2}", row["TEN_BENHNHAN"], row["gioitinh"], row["nam_sinh"]);
                            lblTenDangKham.Text = thongtinnguoibenh;
                    ...
                    {
                        lblSoDangKham.Text = string.Format("ĐANG THỰC HIỆN SỐ:");
        ...
        private void mnuSaveLayout_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_OnsaveLayout != null) _OnsaveLayout(layout,0);
            }
            catch (Exception ex)
            {
