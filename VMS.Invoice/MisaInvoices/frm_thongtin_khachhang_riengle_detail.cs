...
{
    public partial class frm_thongtin_khachhang_riengle_detail : Form
    {
        ...
        public frm_thongtin_khachhang_riengle_detail(MisaInvoice _MisaInvoices, BuyerInfor _buyer, DataRow dr, byte kieuxuat, string str_IdThanhtoan, string str_IdThanhtoanChitiet,DataTable dtData)
        {
            ...
            this.Shown += frm_thongtin_khachhang_riengle_detail_Shown;
            this.FormClosing += frm_thongtin_khachhang_riengle_detail_FormClosing;
        }
        ...
        private void frm_thongtin_khachhang_riengle_detail_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }
        ...
        public frm_thongtin_khachhang_riengle_detail()
        {
            InitializeComponent();
            Utility.SetVisualStyle(this);
            this.KeyDown += frm_thongtin_khachhang_riengle_detail_KeyDown;
        ...
        private void frm_thongtin_khachhang_riengle_detail_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_thongtin_khachhang_riengle_detail_Load(object sender, EventArgs e)
        {
            try
            {
