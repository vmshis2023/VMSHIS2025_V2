...
{
    public partial class frm_hoadon_taotay_v2 : Form
    {
       
        public BuyerInfor _buyer;
        private MisaInvoice _MisaInvoices = new MisaInvoice();
        public frm_hoadon_taotay_v2(BuyerInfor _buyer,DataRow dr)
        {
            InitializeComponent();
            this.KeyDown += frm_hoadon_taotay_v2_KeyDown;
            ...
            this.Shown += frm_hoadon_taotay_v2_Shown;
            this.FormClosing += frm_hoadon_taotay_v2_FormClosing;
        }
        ...
        private void frm_hoadon_taotay_v2_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }

        private void frm_hoadon_taotay_v2_Shown(object sender, EventArgs e)
        {
            LoadUserConfigs();
        }
        ...
        private void frm_hoadon_taotay_v2_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_hoadon_taotay_v2_Load(object sender, EventArgs e)
        {
