...
namespace VNS.HIS.UI.BA
{
    public partial class frm_Emr : Form
    {
        ...
        public frm_Emr()
        {
            ...
            txtMaluotkham.Visible = globalVariables.IsAdmin;
        ...
        void txtMaluotkham_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    DataTable dtData = SPs.EmrLaydanhsachDocuments(Utility.sDbnull(txtMaluotkham.Text), -1).GetDataSet().Tables[0];
        ...
        private void cmdOpenDoc_Click(object sender, EventArgs e)
        {
            ...
            {
                LoadWordFile(ofd.FileName, true);
            }    
        }
