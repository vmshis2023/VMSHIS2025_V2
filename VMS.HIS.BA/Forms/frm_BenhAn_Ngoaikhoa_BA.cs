...
{
    public partial class frm_BenhAn_Ngoaikhoa_BA : Form
    {
        ...
        public frm_BenhAn_Ngoaikhoa_BA(string lstLoaiBA)
        {
            InitializeComponent();
        ...
        bool KiemTraBenhAn()
        {
            ...
            {
                Utility.ShowMsg(string.Format("Người bệnh {0} đã có {1} nên không thể tạo Bệnh án Nội khoa. Vui lòng kiểm tra lại", ucThongtinnguoibenh_emr_basic1.txtTenBN.Text, Utility.GetTenLoaiBenhAn(objEmrBa.LoaiBa)));
                objLuotkham = null;
                objBenhnhan = null;
                return false;
            }
        ...
        private void FillThongtinRavien()
        {
            ...
            string chandoanphu = "";
            string mabenhphu = "";
            string ICD_Bienchung_Code = "";
            string ICD_BienChung_Name = "";
            if (objPhieuRavien!=null)
            {
                ...
                string ICD_Phu_Name = "";
                string ICD_Phu_Code = "";
                ICD_Bienchung_Code = objPhieuRavien.MabenhBienchung;
                ICD_BienChung_Name = objPhieuRavien.BienchungMota;
                ...
                foreach (CheckBox cb in pnlTinhtrangravien.Controls)
                    if (Utility.sDbnull(cb.Tag, "-1") == objPhieuRavien.MaTinhtrangravien)
                        ...
                        cb.Checked = false;
                //Tình trạng ra viện
                opt_ttrv_khoi.Checked = chkTTRVKhoi.Checked;
                opt_ttrv_do.Checked = chkTTRVDoGiam.Checked;
                opt_ttrv_khongthaydoi.Checked = chkTTRVKhongThayDoi.Checked;
                opt_ttrv_nanghon.Checked = chkTTRVNangHon.Checked;
                opt_ttrv_tuvong.Checked = chkTTRVTuVong.Checked;
                opt_ttrv_tienluongnangxinve.Checked = chkTTRV_Tienluongnangxinhve.Checked;
                opt_ttrv_chuaxacdinh.Checked = chkTTRV_Chuaxacdinh.Checked;
                ...
                txt_tenbienchung.Text = objPhieuRavien.BienchungMota;
                txt_mabienchung.Text = objPhieuRavien.MabenhBienchung;
            }
            txt_chandoanravien_tenbenhchinh.Text = chandoan;
            txt_chandoanravien_mabenhchinh.Text = Utility.sDbnull(mabenh);
            txt_chandoanravien_tenbenhphu.Text = chandoanphu;
            txt_chandoanravien_mabenhphu.Text = mabenhphu;
            txt_tenbienchung.Text = ICD_BienChung_Name;
            txt_mabienchung.Text = ICD_Bienchung_Code;
        }
        ...
        private void ClearControl()
        {
            ...
            txt_chandoanravien_tenbenhchinh.Clear();
            txt_chandoanravien_mabenhchinh.Clear();
            txt_chandoanravien_tenbenhphu.Clear();
            txt_chandoanravien_mabenhphu.Clear();
            ...
            opt_ttrv_khoi.Checked = false;
            opt_ttrv_do.Checked = false;
            opt_ttrv_khongthaydoi.Checked = false;
            opt_ttrv_nanghon.Checked = false;
            opt_ttrv_tuvong.Checked = false;
            opt_ttrv_tienluongnangxinve.Checked = false;
            opt_ttrv_chuaxacdinh.Checked = false;
            ...
            txt_benhchinh_khivaokhoadieutri.Clear();
            txt_benhkemtheo_khivaokhoadieutri.Clear();
            txt_tenbienchung_khivaokhoadieutri.Clear();
        
            txtBenhAnHuongDieuTri.Clear();
            txtTKBAQuaTrinhBenhLy.Clear();
            txtTKBATTomTatKetQua.Clear();
          
            txt_TongketbaHuongdieutritieptheo.Clear();
        ...
        void LuuBA(int trangthai)
        {
            try
            {
                ...
                if (objEmrBa.IdBa > 0)
                {
                    if (!Utility.isValidSignStatus4UpdateDelete(objLuotkham, objEmrBa.IdBa, Loaiphieu_HIS.BA_NOIKHOA, "Bệnh án Nội khoa"))
                        return;
                }
                ...
                using (var scope = new TransactionScope())
                {
                    using (var dbscope = new SharedDbConnectionScope())
                    {
                        ...
                        else
                        {
                            ...
                            TaoPhieukhamNoikhoa();
                            objPKNgoaiKhoa.Save();
                            Utility.Log(this.Name, globalVariables.UserName, string.Format("Cập nhật thông tin phiếu khám nội khoa cho người bệnh: {0}-{1} thành công", objEmrBa.MaLuotkham, objEmrBa.TenBenhnhan), objPKNgoaiKhoa.IsNew ? newaction.Insert : newaction.Update, "EMR");
                            
                        }
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA02_BANGOAIKHOA_BIA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA02_BANGOAIKHOA_CACTODAU", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO1, "BA02_BANGOAIKHOA_TO1", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO2, "BA02_BANGOAIKHOA_TO2", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO3, "BA02_BANGOAIKHOA_TO3", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO4", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO5", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO6", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO7", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BA_NOIKHOA, "BA02_BANGOAIKHOA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
        ...
        void TaoPhieukhamNoikhoa()
        {
            objPKNgoaiKhoa = new Select().From(EmrPhieukhamNgoaikhoa.Schema)
             .Where(EmrPhieukhamNgoaikhoa.Columns.IdBenhnhan).IsEqualTo(objLuotkham.IdBenhnhan)
             .And(EmrPhieukhamNgoaikhoa.Columns.MaLuotkham).IsEqualTo(objLuotkham.MaLuotkham)
             .ExecuteSingle<EmrPhieukhamNgoaikhoa>();
            if (objPKNgoaiKhoa != null && objPKNgoaiKhoa.Id > 0)
            {
                objPKNgoaiKhoa.MarkOld();
                objPKNgoaiKhoa.NguoiSua = globalVariables.UserName;
                objPKNgoaiKhoa.NgaySua = THU_VIEN_CHUNG.GetSysDateTime();
            }
            else
            {
                objPKNgoaiKhoa = new EmrPhieukhamNgoaikhoa();
                objPKNgoaiKhoa.IsNew = true;
                objPKNgoaiKhoa.MaLuotkham = Utility.sDbnull(objLuotkham.MaLuotkham);
                objPKNgoaiKhoa.IdBenhnhan = Utility.Int32Dbnull(objLuotkham.IdBenhnhan);
                objPKNgoaiKhoa.NguoiTao = globalVariables.UserName;
                objPKNgoaiKhoa.NgayTao = THU_VIEN_CHUNG.GetSysDateTime();
            }
            //Call các usercontrol.setdata
            uc_ba_coxuongkhop_ngoaikhoa1.SetData(objPKNgoaiKhoa);
            uc_ba_tiensubanthan_ngoaikhoa1.SetData(objPKNgoaiKhoa);
            uc_ba_ranghammat_mat_taimuihong1.SetData(objPKNgoaiKhoa);
            uc_ba_tieuhoa_ngoaikhoa1.SetData(objPKNgoaiKhoa);
            uc_ba_tuanhoan_hohap_ngoaikhoa1.SetData(objPKNgoaiKhoa);
            uc_ba_than_tietnieu_ngoaikhoa1.SetData(objPKNgoaiKhoa);
            uc_ba_thankinh_ngoaikhoa1.SetData(objPKNgoaiKhoa);
            uc_ba1_toanthan_ngoaikhoa1.SetData(objPKNgoaiKhoa);
           
            objPKNgoaiKhoa.BenhlyKhac = Utility.sDbnull(txt_Benhlykhac.Text);
        }
        void TaoPhieuTKBA()
        {
        ...
        private EmrBa TaoEmrBa()
        {
            ...
            try
            {
                ...
                if (objNhapvien != null)
                {
                    ...
                    objEmrBa.VaovienDonvikhac = chk_tiepnhantu_donvikhac.Checked;
                ...
                if(objPhieuchuyenvien!=null)
                {
                    ...
                    //objEmrBa.manoichuyendi = objPhieuchuyenvien.IdBenhvienChuyenden;
                    //objEmrBa.tennoichuyendi= objPhieuchuyenvien.te
                }
                //if (objPhieuRavien != null)
                //{
                ...
                objEmrBa.RavienTronvien = chkQLNBRavienBoVe.Checked;
                    objEmrBa.ChuyenvienNoichuyenden = Utility.sDbnull(txtQLNBChuyenVienNoiChuyenDen.Text);
                    objEmrBa.ChuyenvienNoichuyenden = Utility.sDbnull(txtQLNBChuyenVienNoiChuyenDen.Text);
                    objEmrBa.RavienMaBenhchinh = Utility.sDbnull(txt_chandoanravien_mabenhchinh.Text);
                    objEmrBa.RavienMaBenhphu = Utility.sDbnull(txt_chandoanravien_mabenhphu.Text);
                    objEmrBa.RavienTenBenhchinh = Utility.sDbnull(txt_chandoanravien_tenbenhphu.Text);
                    objEmrBa.RavienTenBenhphu = Utility.sDbnull(txt_chandoanravien_mabenhphu.Text);
                objEmrBa.RavienMaBienchung = Utility.sDbnull(txt_mabienchung.Text);
                objEmrBa.RavienTenBienchung = Utility.sDbnull(txt_tenbienchung.Text);
                //Tình trạng ra viện
                //Kết quả điều trị
                ...
                objEmrBa.TinhtrangravienKetquadieutriKhongxacdinh = chkTTRV_Chuaxacdinh.Checked;
                objEmrBa.TinhtrangravienKetquadieutriTienluongnangxinve = chkTTRV_Tienluongnangxinhve.Checked;
                    //Giải phẫu bệnh
                ...
                //Tình hình tử vong
                objEmrBa.TinhtrangravienTruockhivaovien = chk_tuvong_truockhivaovien.Checked;
              ...
              //Chẩn đoán
                ...
                objEmrBa.VaovienGio = chk_vaovien_gio.Checked;
                objEmrBa.VaovienGiothu =Utility.ByteDbnull( nmr_vaovien_giothu.Value);
                objEmrBa.VaovienNgayCheck = chk_vaovien_ngay_check.Checked;
                objEmrBa.VaovienNgaythu = Utility.ByteDbnull(nmr_vaovien_ngaythu.Value);
                objEmrBa.VaovienVaongaythucuabenh =Utility.ByteDbnull(nmr_vaovien_ngaythu.Value);
                objEmrBa.VaovienKhongro = chk_vaovien_khongro.Checked;
                objEmrBa.HoibenhQuatrinhbenhly = Utility.sDbnull(txt_hoibenh_quatrinhbenhly.Text);
                objEmrBa.HoibenhChandoanCo = opt_hoibenh_chandoan_co.Checked;
                objEmrBa.HoibenhChandoanKhong = opt_hoibenh_chandoan_khong.Checked;
                objEmrBa.HoibenhChandoanGhiro = opt_hoibenh_chandoan_co.Checked? Utility.sDbnull(txt_hoibenh_chandoan_ghiro.Text):"";
                ...
                //
                objEmrBa.KhambenhXetnghiemClsCanlamCo = opt_khambenh_xetnghiem_cls_canlam_co.Checked;
                objEmrBa.KhambenhXetnghiemClsCanlamKhong = opt_khambenh_xetnghiem_cls_canlam_khong.Checked;
                objEmrBa.KhambenhXetnghiemClsCanlam =opt_khambenh_xetnghiem_cls_canlam_co.Checked? Utility.sDbnull(txtBenhAnCacXetNghiem.Text):"";
                objEmrBa.KhambenhTomtatbenhan = Utility.sDbnull(txtBenhAnTomTatBenhAn.Text);

                objEmrBa.CdBandau = Utility.sDbnull(txt_tenchandoan_vaovien_khivaokhoadieutri.Text);
                objEmrBa.CdVaovien = Utility.sDbnull(txt_tenchandoan_vaovien_khivaokhoadieutri.Text);
                
                objEmrBa.CdKhivaokhoadieutriPhanbiet = Utility.sDbnull(txt_tenchandoan_phanbiet_khivaokhoadieutri.Text);

                objEmrBa.CdKhivaokhoadieutriBenhchinh = Utility.sDbnull(txt_benhchinh_khivaokhoadieutri.Text);
                objEmrBa.CdKhivaokhoadieutriBenhphu = Utility.sDbnull(txt_benhkemtheo_khivaokhoadieutri.Text);
                objEmrBa.CdKhivaokhoadieutriBienchung = Utility.sDbnull(txt_tenbienchung_khivaokhoadieutri.Text);

               
                objEmrBa.KhambenhTienluongGan = Utility.sDbnull(txt_khambenh_tienluong_gan.Text);
                objEmrBa.KhambenhTienluongXa = Utility.sDbnull(txt_khambenh_tienluong_xa.Text);
                objEmrBa.KhambenhHuongdieutri = Utility.sDbnull(txtBenhAnHuongDieuTri.Text);

                objEmrBa.KhdtChedochamsocCap1 = opt_khdt_chedochamsoc_cap1.Checked;
                objEmrBa.KhdtChedochamsocCap2 = opt_khdt_chedochamsoc_cap2.Checked;
                objEmrBa.KhdtChedochamsocCap3 = opt_khdt_chedochamsoc_cap3.Checked;

                objEmrBa.KhdtChedodinhduongDuongmieng = chk_khdt_chedodinhduong_duongmieng.Checked;
                objEmrBa.KhdtChedodinhduongOngthong = chk_khdt_chedodinhduong_ongthong.Checked;
                objEmrBa.KhdtChedodinhduongTinhmach = chk_khdt_chedodinhduong_tinhmach.Checked;

                objEmrBa.KhdtPhuchoichucnangCo = chk_khdt_phuchoichucnang_co.Checked;
                objEmrBa.KhdtPhuchoichucnangKhong = chk_khdt_phuchoichucnang_khong.Checked;
                objEmrBa.KhdtPhuchoichucnangGhiro = Utility.sDbnull(txt_khdt_phuchoichucnang_ghiro.Text);

                objEmrBa.KhdtTuvanCo = opt_khdt_tuvan_co.Checked;
                objEmrBa.KhdtTuvanKhong = opt_khdt_tuvan_khong.Checked;
                objEmrBa.KhdtTuvanGhiro = Utility.sDbnull(txt_khdt_tuvan_ghiro.Text);
                ...
                objEmrBa.TongketbaHuongdieutritieptheo = Utility.sDbnull(txt_TongketbaHuongdieutritieptheo.Text);

                objEmrBa.TongketbaNoikhoaKhong = opt_TongketbaNoikhoaKhong.Checked;
                objEmrBa.TongketbaNoikhoaCo = opt_TongketbaNoikhoaCo.Checked;
                objEmrBa.TongketbaNoikhoaGhiro = opt_TongketbaNoikhoaCo.Checked? Utility.sDbnull(txt_TongketbaNoikhoaGhiro.Text):"";
                objEmrBa.TongketbaPtttKhong = opt_TongketbaPtttKhong.Checked;
                objEmrBa.TongketbaPtttCo = opt_TongketbaPtttCo.Checked;
                objEmrBa.TongketbaPtttGhiro = opt_TongketbaPtttCo.Checked? Utility.sDbnull(txt_TongketbaPtttGhiro.Text):"";
        ...
        private void frm_BenhAn_Ngoaikhoa_BA_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
        ...
        private void frm_BenhAn_Ngoaikhoa_BA_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        EmrPhieukhamNgoaikhoa objPKNgoaiKhoa;
            ...
            try
            {
                ...
                if (objEmrBa != null)
                {
                    ...
                    try
                    {
                        ...
                        chk_tiepnhantu_donvikhac.Checked = Utility.Bool2Bool(objEmrBa.VaovienDonvikhac);
                        ...
                        if (objEmrBa.TrangThai >= 1)
                        {
                            ...
                            chkQLNBRavienBoVe.Checked = Utility.Bool2Bool(objEmrBa.RavienTronvien);
                        }
                        txtQLNBTongSoNgayDieuTri.Text = Utility.sDbnull(objEmrBa.RavienTongsongayDieutri);
                       
                        //txt_chandoanravien_tenbenhchinh.Text = Utility.sDbnull(objEmrBa.RavienTenBenhchinh);
                        //txt_chandoanravien_mabenhchinh.Text = Utility.sDbnull(objEmrBa.RavienMaBenhchinh);
                        //txt_chandoanravien_tenbenhphu.Text = Utility.sDbnull(objEmrBa.RavienTenBenhphu);
                        //txt_chandoanravien_mabenhphu.Text = Utility.sDbnull(objEmrBa.RavienMaBenhphu);
                        ...
                        if (objEmrBa.TrangThai >= 1)
                        {
                            ...
                            chkTTRV_Tienluongnangxinhve.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriTienluongnangxinve);
                            chkTTRV_Chuaxacdinh.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriKhongxacdinh);
                            ...
                            chk_tuvong_truockhivaovien.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienTruockhivaovien);
                        ...
                        chk_vaovien_gio.Checked = Utility.Bool2Bool(objEmrBa.VaovienGio);
                        nmr_vaovien_giothu.Value = Utility.DecimaltoDbnull(objEmrBa.VaovienGiothu);
                        chk_vaovien_ngay_check.Checked = Utility.Bool2Bool(objEmrBa.VaovienNgayCheck);
                        nmr_vaovien_ngaythu.Value = Utility.DecimaltoDbnull(objEmrBa.VaovienNgaythu);
                        chk_vaovien_khongro.Checked = Utility.Bool2Bool(objEmrBa.VaovienKhongro);
                        txt_hoibenh_quatrinhbenhly.Text = Utility.sDbnull(objEmrBa.HoibenhQuatrinhbenhly);// Utility.sDbnull(dr["BaQtbl"].ToString());
                        
                        
                        opt_hoibenh_chandoan_co.Checked = Utility.Bool2Bool(objEmrBa.HoibenhChandoanCo);
                        opt_hoibenh_chandoan_khong.Checked = Utility.Bool2Bool(objEmrBa.HoibenhChandoanKhong);

                        txt_hoibenh_chandoan_ghiro.Text = Utility.sDbnull(objEmrBa.HoibenhChandoanGhiro);// Utility.sDbnull(dr["BaGiaDinh"].ToString());
                        ...
                        opt_khambenh_xetnghiem_cls_canlam_co.Checked = Utility.Bool2Bool(objEmrBa.KhambenhXetnghiemClsCanlamCo);
                        opt_khambenh_xetnghiem_cls_canlam_khong.Checked = Utility.Bool2Bool(objEmrBa.KhambenhXetnghiemClsCanlamKhong);
                        txtBenhAnTomTatBenhAn.Text = Utility.sDbnull(objEmrBa.KhambenhTomtatbenhan);

                        txt_tenchandoan_vaovien_khivaokhoadieutri.Text = Utility.sDbnull(objEmrBa.CdBandau);
                        txt_tenchandoan_phanbiet_khivaokhoadieutri.Text = Utility.sDbnull(objEmrBa.CdKhivaokhoadieutriPhanbiet);

                        txt_benhchinh_khivaokhoadieutri.Text = Utility.sDbnull(objEmrBa.CdKhivaokhoadieutriBenhchinh);
                        txt_benhkemtheo_khivaokhoadieutri.Text = Utility.sDbnull(objEmrBa.CdKhivaokhoadieutriBenhphu);
                        txt_tenbienchung_khivaokhoadieutri.Text = Utility.sDbnull(objEmrBa.CdKhivaokhoadieutriPhanbiet);

                        txt_khambenh_tienluong_gan.Text = Utility.sDbnull(objEmrBa.KhambenhTienluongGan);
                        txt_khambenh_tienluong_xa.Text = Utility.sDbnull(objEmrBa.KhambenhTienluongXa);
                        ...
                        txt_TongketbaHuongdieutritieptheo.Text = Utility.sDbnull(objEmrBa.TongketbaHuongdieutritieptheo);// Utility.sDbnull(dr["TkbaHdt"].ToString());

                        opt_khdt_chedochamsoc_cap1.Checked = Utility.Bool2Bool(objEmrBa.KhdtChedochamsocCap1);
                        opt_khdt_chedochamsoc_cap2.Checked = Utility.Bool2Bool(objEmrBa.KhdtChedochamsocCap2);
                        opt_khdt_chedochamsoc_cap3.Checked = Utility.Bool2Bool(objEmrBa.KhdtChedochamsocCap3);

                        chk_khdt_chedodinhduong_duongmieng.Checked = Utility.Bool2Bool(objEmrBa.KhdtChedodinhduongDuongmieng);
                        chk_khdt_chedodinhduong_ongthong.Checked = Utility.Bool2Bool(objEmrBa.KhdtChedodinhduongOngthong);
                        chk_khdt_chedodinhduong_tinhmach.Checked = Utility.Bool2Bool(objEmrBa.KhdtChedodinhduongTinhmach);

                        chk_khdt_phuchoichucnang_co.Checked = Utility.Bool2Bool(objEmrBa.KhdtPhuchoichucnangCo);
                        chk_khdt_phuchoichucnang_khong.Checked = Utility.Bool2Bool(objEmrBa.KhdtPhuchoichucnangKhong);
                        txt_khdt_phuchoichucnang_ghiro.Text = Utility.sDbnull(objEmrBa.KhdtPhuchoichucnangGhiro);

                        opt_khdt_tuvan_co.Checked = Utility.Bool2Bool(objEmrBa.KhdtTuvanCo);
                        opt_khdt_tuvan_khong.Checked = Utility.Bool2Bool(objEmrBa.KhdtTuvanKhong);
                        txt_khdt_tuvan_ghiro.Text = Utility.sDbnull(objEmrBa.KhdtTuvanGhiro);

                        opt_TongketbaNoikhoaCo.Checked= Utility.Bool2Bool(objEmrBa.TongketbaNoikhoaCo);
                        opt_TongketbaNoikhoaKhong.Checked = Utility.Bool2Bool(objEmrBa.TongketbaNoikhoaKhong);
                        txt_TongketbaNoikhoaGhiro.Text= Utility.sDbnull(objEmrBa.TongketbaNoikhoaGhiro);

                        opt_TongketbaPtttCo.Checked = Utility.Bool2Bool(objEmrBa.TongketbaPtttCo);
                        opt_TongketbaPtttKhong.Checked = Utility.Bool2Bool(objEmrBa.TongketbaPtttKhong);
                        txt_TongketbaPtttGhiro.Text = Utility.sDbnull(objEmrBa.TongketbaPtttGhiro);
       ...
       // VKcbLuotkham objBenhnhan = null;
                        ...
                        using (var Scope = new TransactionScope())
                        {
                            using (var dbScope = new SharedDbConnectionScope())
                            {
                              ...
                              new Delete().From(EmrHosoluutru.Schema)
                                ...
                                Utility.Log("frm_BenhAn_Ngoaikhoa_BA", globalVariables.UserName, string.Format("Xóa bệnh án id={0}, loại BA={1}, mã BA={2} của người bệnh id ={3}, mã lần khám {4} thành công",objEmrBa.IdBa,objEmrBa.LoaiBa,objEmrBa.MaBa,objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham), newaction.Delete, "UI");
                            }
                            Scope.Complete();
                        }
        ...
        {
            txt_benhchinh_khivaokhoadieutri.Text = txtCDKhiVaoDieuTri.Text;
        }
        ...
        void FillTongketBenhAn()
        {
            try
            {
                ...
                if (objTKBA != null)
                {
                    ...
                    txt_TongketbaHuongdieutritieptheo.Text = objTKBA.HuongDieutri;
        ...
        void FillPhieukhamNoikhoa()
        {
            try
            {
                objPKNgoaiKhoa = new Select().From(EmrPhieukhamNgoaikhoa.Schema)
                    ...
                    .And(EmrPhieukhamNgoaikhoa.Columns.MaLuotkham).IsEqualTo(objLuotkham.MaLuotkham)
                    .ExecuteSingle<EmrPhieukhamNgoaikhoa>();
                if (objPKNgoaiKhoa != null)
                {
                    uc_ba_coxuongkhop_ngoaikhoa1.ShowData(objPKNgoaiKhoa);
                    uc_ba_tiensubanthan_ngoaikhoa1.ShowData(objPKNgoaiKhoa,objLuotkham);
                    uc_ba_ranghammat_mat_taimuihong1.ShowData(objPKNgoaiKhoa);
                    uc_ba_tieuhoa_ngoaikhoa1.ShowData(objPKNgoaiKhoa);
                    uc_ba_tuanhoan_hohap_ngoaikhoa1.ShowData(objPKNgoaiKhoa);
                    uc_ba_than_tietnieu_ngoaikhoa1.ShowData(objPKNgoaiKhoa);
                    uc_ba_thankinh_ngoaikhoa1.ShowData(objPKNgoaiKhoa);
                    uc_ba1_toanthan_ngoaikhoa1.ShowData(objPKNgoaiKhoa);
                    txt_Benhlykhac.Text= Utility.sDbnull(objPKNgoaiKhoa.BenhlyKhac );
                }
                else
                    uc_ba_tiensubanthan_ngoaikhoa1.InitData( objLuotkham);
            }
            catch (Exception ex)
            {
                Utility.CatchException(ex);
        ...
        private void mnuSent2EMR_Click(object sender, EventArgs e)
        {
            try
            {
                if(objEmrBa!=null)
                {
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA02_BANGOAIKHOA_BIA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true,false,"", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA02_BANGOAIKHOA_CACTODAU", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO1, "BA02_BANGOAIKHOA_TO1", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO2, "BA02_BANGOAIKHOA_TO2", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO3, "BA02_BANGOAIKHOA_TO3", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO4", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO5", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO6", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA02_BANGOAIKHOA_TO7", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BA_NOIKHOA, "BA02_BANGOAIKHOA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NGOAIKHOA);
                    emrdoc.Save();
        ...
        private void opt_hoibenh_chandoan_co_CheckedChanged(object sender, EventArgs e)
        {
            RadioButton _obj = sender as RadioButton;
            txt_hoibenh_chandoan_ghiro.Enabled = _obj.Checked;
            if (_obj.Checked) txt_hoibenh_chandoan_ghiro.Focus();
        }

        private void opt_khambenh_xetnghiem_cls_canlam_co_CheckedChanged(object sender, EventArgs e)
        {
            txtBenhAnCacXetNghiem.Enabled = opt_khambenh_xetnghiem_cls_canlam_co.Checked;
           if (txtBenhAnCacXetNghiem.Enabled) txtBenhAnCacXetNghiem.Focus();
        }
        ...
        private void lnk_Chandoanravien_benhchinh_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (objPhieuRavien != null)
            {
                txt_chandoanravien_tenbenhchinh.Text = objPhieuRavien.MotaBenhchinh;
                txt_chandoanravien_mabenhchinh.Text = objPhieuRavien.MabenhChinh;
            }
        }

        private void lnk_Chandoanravien_benhkemtheo_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (objPhieuRavien != null)
            {
                txt_chandoanravien_tenbenhphu.Text = objPhieuRavien.TenBenhphu;
                txt_chandoanravien_mabenhphu.Text = objPhieuRavien.MabenhPhu;
            }
        }

        private void lnk_Chandoanravien_bienchung_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (objPhieuRavien != null)
            {
                txt_tenbienchung.Text = objPhieuRavien.BienchungMota;
        ...
        private void opt_khambenh_xetnghiem_cls_canlam_co_CheckedChanged_1(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txtBenhAnCacXetNghiem, sender as RadioButton);
        }

        private void chk_khdt_phuchoichucnang_co_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_khdt_phuchoichucnang_ghiro, sender as RadioButton);
        }

        private void opt_khdt_tuvan_co_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_khdt_tuvan_ghiro, sender as RadioButton);
        }

        private void opt_TongketbaNoikhoaCo_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_TongketbaNoikhoaGhiro, sender as RadioButton);
        }

        private void opt_TongketbaPtttCo_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_TongketbaPtttGhiro, sender as RadioButton);
        }

        private void mnuInTo5_Click(object sender, EventArgs e)
        {
            clsInBA.InBA(objEmrBa.IdBa, objEmrBa.MaBa, objEmrBa.LoaiBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, null, null, 5, false);
        }

        private void mnuInTo6_Click(object sender, EventArgs e)
        {
            clsInBA.InBA(objEmrBa.IdBa, objEmrBa.MaBa, objEmrBa.LoaiBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, null, null, 6, false);
        }

        private void mnuInTo7_Click(object sender, EventArgs e)
        {
            clsInBA.InBA(objEmrBa.IdBa, objEmrBa.MaBa, objEmrBa.LoaiBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, null, null, 7, false);

        }

        private void uc_ba_tiensubanthan_ngoaikhoa1_Load(object sender, EventArgs e)
        {
        ...
        {
            clsInBA.InBA(objEmrBa.IdBa, objEmrBa.MaBa, objEmrBa.LoaiBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, null, null, 10, false);
        }
    }
}
