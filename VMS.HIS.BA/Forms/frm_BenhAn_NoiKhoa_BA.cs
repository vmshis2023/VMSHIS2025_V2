...
{
    public partial class frm_BenhAn_NoiKhoa_BA : Form
    {
        ...
        public frm_BenhAn_NoiKhoa_BA(string lstLoaiBA)
        {
            InitializeComponent();
                ...
                using (var scope = new TransactionScope())
                {
                    using (var dbscope = new SharedDbConnectionScope())
                    {
                        ...
                        else
                        {
                            ...
                            TaoPhieukhamNoikhoa();
                            objPKNoikhoa.Save();
                            Utility.Log(this.Name, globalVariables.UserName, string.Format("Cập nhật thông tin phiếu khám nội khoa cho người bệnh: {0}-{1} thành công", objEmrBa.MaLuotkham, objEmrBa.TenBenhnhan), objPKNoikhoa.IsNew ? newaction.Insert : newaction.Update, "EMR");
                            
                        }
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA01_BANOIKHOA_BIA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA01_BANOIKHOA_CACTODAU", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO1, "BA01_BANOIKHOA_TO1", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO2, "BA01_BANOIKHOA_TO2", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO3, "BA01_BANOIKHOA_TO3", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA01_BANOIKHOA_TO4", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA01_BANOIKHOA_TO5", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA01_BANOIKHOA_TO6", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BA_NOIKHOA, "BA01_BANOIKHOA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
        ...
        {
            objPKNoikhoa = new Select().From(EmrPhieukhamNoikhoa.Schema)
             .Where(EmrPhieukhamNoikhoa.Columns.IdBenhnhan).IsEqualTo(objLuotkham.IdBenhnhan)
             .And(EmrPhieukhamNoikhoa.Columns.MaLuotkham).IsEqualTo(objLuotkham.MaLuotkham)
             .ExecuteSingle<EmrPhieukhamNoikhoa>();
            if (objPKNoikhoa != null && objPKNoikhoa.Id > 0)
            {
                objPKNoikhoa.MarkOld();
                objPKNoikhoa.NguoiSua = globalVariables.UserName;
                objPKNoikhoa.NgaySua = THU_VIEN_CHUNG.GetSysDateTime();
            }
            else
            {
                objPKNoikhoa = new EmrPhieukhamNoikhoa();
                objPKNoikhoa.IsNew = true;
                objPKNoikhoa.MaLuotkham = Utility.sDbnull(objLuotkham.MaLuotkham);
                objPKNoikhoa.IdBenhnhan = Utility.Int32Dbnull(objLuotkham.IdBenhnhan);
                objPKNoikhoa.NguoiTao = globalVariables.UserName;
                objPKNoikhoa.NgayTao = THU_VIEN_CHUNG.GetSysDateTime();
            }
            //Call các usercontrol.setdata
            uc_ba_diung1.SetData(objPKNoikhoa);
            uc_ba1_toanthan1.SetData(objPKNoikhoa);
            uc_ba_tuanhoan1.SetData(objPKNoikhoa);
            uc_ba_hohap1.SetData(objPKNoikhoa);
            uc_ba_tieuhoa1.SetData(objPKNoikhoa);
            uc_ba_than_tietnieu1.SetData(objPKNoikhoa);
            uc_ba_ranghammat1.SetData(objPKNoikhoa);
            uc_ba_thankinh1.SetData(objPKNoikhoa);
            uc_ba_coxuongkhop1.SetData(objPKNoikhoa);
            uc_ba_taimuihong1.SetData(objPKNoikhoa);
            uc_ba_mat_noitiet_dinhduong1.SetData(objPKNoikhoa);
            objPKNoikhoa.BenhlyKhac = Utility.sDbnull(txt_Benhlykhac.Text);
        }
        void TaoPhieuTKBA()
        {
        ...
        private EmrBa TaoEmrBa()
        {
            ...
            try
            {
              ...
              //Chẩn đoán
                ...
                objEmrBa.CdBandau = Utility.sDbnull(txt_cd_bandau.Text);
                objEmrBa.CdVaovien = Utility.sDbnull(txt_cd_bandau.Text);

                objEmrBa.CdKhivaokhoadieutriPhanbiet = Utility.sDbnull(txt_cd_khivaokhoadieutri_phanbiet.Text);
        ...
        private void frm_BenhAn_NoiKhoa_BA_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
        ...
        private void frm_BenhAn_NoiKhoa_BA_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        EmrPhieukhamNoikhoa objPKNoikhoa;
            ...
            try
            {
                ...
                if (objEmrBa != null)
                {
                    ...
                    try
                    {
                        ...
                        txt_cd_bandau.Text = Utility.sDbnull(objEmrBa.CdBandau);
                        txt_cd_khivaokhoadieutri_phanbiet.Text = Utility.sDbnull(objEmrBa.CdKhivaokhoadieutriPhanbiet);
       ...
       // VKcbLuotkham objBenhnhan = null;
                        ...
                        using (var Scope = new TransactionScope())
                        {
                            using (var dbScope = new SharedDbConnectionScope())
                            {
                              ...
                              new Delete().From(EmrHosoluutru.Schema)
                                ...
                                Utility.Log("frm_BenhAn_NoiKhoa_BA", globalVariables.UserName, string.Format("Xóa bệnh án id={0}, loại BA={1}, mã BA={2} của người bệnh id ={3}, mã lần khám {4} thành công",objEmrBa.IdBa,objEmrBa.LoaiBa,objEmrBa.MaBa,objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham), newaction.Delete, "UI");
                            }
                            Scope.Complete();
                        }
        ...
        void FillPhieukhamNoikhoa()
        {
            try
            {
                objPKNoikhoa = new Select().From(EmrPhieukhamNoikhoa.Schema)
                    ...
                    .And(EmrPhieukhamNoikhoa.Columns.MaLuotkham).IsEqualTo(objLuotkham.MaLuotkham)
                    .ExecuteSingle<EmrPhieukhamNoikhoa>();
                if (objPKNoikhoa != null)
                {
                    uc_ba_diung1.ShowData(objPKNoikhoa);
                    uc_ba1_toanthan1.ShowData(objPKNoikhoa);
                    uc_ba_tuanhoan1.ShowData(objPKNoikhoa);
                    uc_ba_hohap1.ShowData(objPKNoikhoa);
                    uc_ba_tieuhoa1.ShowData(objPKNoikhoa);
                    uc_ba_than_tietnieu1.ShowData(objPKNoikhoa);
                    uc_ba_ranghammat1.ShowData(objPKNoikhoa);
                    uc_ba_thankinh1.ShowData(objPKNoikhoa);
                    uc_ba_coxuongkhop1.ShowData(objPKNoikhoa);
                    uc_ba_taimuihong1.ShowData(objPKNoikhoa);
                    uc_ba_mat_noitiet_dinhduong1.ShowData(objPKNoikhoa);
                    txt_Benhlykhac.Text= Utility.sDbnull(objPKNoikhoa.BenhlyKhac );
                }
            }
            catch (Exception ex)
            {
        ...
        private void mnuSent2EMR_Click(object sender, EventArgs e)
        {
            try
            {
                if(objEmrBa!=null)
                {
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA01_BANOIKHOA_BIA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true,false,"", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA01_BANOIKHOA_CACTODAU", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO1, "BA01_BANOIKHOA_TO1", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO2, "BA01_BANOIKHOA_TO2", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO3, "BA01_BANOIKHOA_TO3", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA01_BANOIKHOA_TO4", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA01_BANOIKHOA_TO5", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO4, "BA01_BANOIKHOA_TO6", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
                    emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BA_NOIKHOA, "BA01_BANOIKHOA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", Loaiphieu_HIS.BA_NOIKHOA);
                    emrdoc.Save();
        ...
        private void mnu_InTKBA_Click(object sender, EventArgs e)
        {
            clsInBA.InBA(objEmrBa.IdBa, objEmrBa.MaBa, objEmrBa.LoaiBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, null, null, 6, false);
        }

        private void mnu_InCacToBA_Click(object sender, EventArgs e)
        {
