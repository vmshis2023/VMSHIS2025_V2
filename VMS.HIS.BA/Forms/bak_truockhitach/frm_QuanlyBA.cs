...
namespace VMS.HIS.UI.EMR
{
    public partial class frm_QuanlyBA : Form
    {
        ...
        private void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                frm_BenhAn_NoiKhoa BenhAn_NoiKhoa = new frm_BenhAn_NoiKhoa(MauBA);
            ...
            else if (MauBA == LoaiBA.BA_NGOAITRU)//Bệnh án ngoại trú
            {
                ...
                _BenhAn_NgoaiTru._OnCreated += _OnCreated;
                _BenhAn_NgoaiTru.ShowDialog();
            }
            else if (MauBA == LoaiBA.BA_NGOAIKHOA)//Bệnh án ngoại khoa
            {
                frm_BenhAn_NgoaiKhoa _BenhAn_NgoaiKhoa = new frm_BenhAn_NgoaiKhoa(MauBA);
                EmrBa bant = EmrBa.FetchByID(Utility.Int64Dbnull(grdList.GetValue("id_ba")));
                _BenhAn_NgoaiKhoa.objEmrBa = bant;
                _BenhAn_NgoaiKhoa.ucThongtinnguoibenh_emr_basic1.txtMaluotkham.Text = Utility.sDbnull(grdList.GetValue("ma_luotkham"));
                _BenhAn_NgoaiKhoa.m_enAct = action.Update;
                _BenhAn_NgoaiKhoa._OnCreated += _OnCreated;
                _BenhAn_NgoaiKhoa.ShowDialog();
            }
            else if (MauBA == LoaiBA.BA_PHUKHOA)//Bệnh án phụ khoa
            {
                frm_BenhAn_PhuKhoa _BenhAn_PhuKhoa = new frm_BenhAn_PhuKhoa(MauBA);
                EmrBa bant = EmrBa.FetchByID(Utility.Int64Dbnull(grdList.GetValue("id_ba")));
                _BenhAn_PhuKhoa.objEmrBa = bant;
                _BenhAn_PhuKhoa.ucThongtinnguoibenh_emr_basic1.txtMaluotkham.Text = Utility.sDbnull(grdList.GetValue("ma_luotkham"));
                _BenhAn_PhuKhoa.m_enAct = action.Update;
                _BenhAn_PhuKhoa._OnCreated += _OnCreated;
                _BenhAn_PhuKhoa.ShowDialog();
            }
            else if (MauBA == LoaiBA.BA_SANKHOA)//Bệnh án sản khoa
            {
                frm_BenhAn_SanKhoa _BenhAn_SanKhoa = new frm_BenhAn_SanKhoa(MauBA);
                EmrBa bant = EmrBa.FetchByID(Utility.Int64Dbnull(grdList.GetValue("id_ba")));
                _BenhAn_SanKhoa.objEmrBa = bant;
                _BenhAn_SanKhoa.ucThongtinnguoibenh_emr_basic1.txtMaluotkham.Text = Utility.sDbnull(grdList.GetValue("ma_luotkham"));
                _BenhAn_SanKhoa.m_enAct = action.Update;
                _BenhAn_SanKhoa._OnCreated += _OnCreated;
                _BenhAn_SanKhoa.ShowDialog();
            }
            else if (MauBA == LoaiBA.BA_NAMKHOA)//Bệnh án Nam khoa
            {
                frm_BenhAn_NamKhoa _BenhAn_NamKhoa = new frm_BenhAn_NamKhoa(MauBA);
                EmrBa bant = EmrBa.FetchByID(Utility.Int64Dbnull(grdList.GetValue("id_ba")));
                _BenhAn_NamKhoa.objEmrBa = bant;
                _BenhAn_NamKhoa.ucThongtinnguoibenh_emr_basic1.txtMaluotkham.Text = Utility.sDbnull(grdList.GetValue("ma_luotkham"));
                _BenhAn_NamKhoa.m_enAct = action.Update;
                _BenhAn_NamKhoa._OnCreated += _OnCreated;
                _BenhAn_NamKhoa.ShowDialog();
            }
        }
        ...
        {
            InitData4Print();
            clsInBA.InBA(objEmrBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, dt_tssk, dtPhieuPttt, 1, false);
        }

        private void mnuInTo2_Click(object sender, EventArgs e)
        {
            InitData4Print();
            clsInBA.InBA(objEmrBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, dt_tssk, dtPhieuPttt, 2, false);
        }

        private void mnuInTo3_Click(object sender, EventArgs e)
        {
            InitData4Print();
            clsInBA.InBA(objEmrBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, dt_tssk, dtPhieuPttt, 3, false);
        }

        private void mnuInTo4_Click(object sender, EventArgs e)
        {
            InitData4Print();
            clsInBA.InBA(objEmrBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, dt_tssk, dtPhieuPttt, 4, false);
        }

        private void mnuPrintAll_Click(object sender, EventArgs e)
        {
            InitData4Print();
            clsInBA.InBA(objEmrBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, dt_tssk, dtPhieuPttt, 100, false);
        }
      ...
      void InitData4Print()
        ...
        private void mnuInVoBA_Click(object sender, EventArgs e)
        {
            ...
            clsInBA.InBA(objEmrBa, objLuotkham, null, null, null, null, 0, false);
        }
        ...
        private void mnuBANoikhoa_Click(object sender, EventArgs e)
        {
            ToolStripMenuItem mnu = sender as ToolStripMenuItem;
            frm_BenhAn_NoiKhoa BenhAn_NoiKhoa = new frm_BenhAn_NoiKhoa(mnu.Tag.ToString());
        ...
        {
            ToolStripMenuItem mnu = sender as ToolStripMenuItem;
            frm_BenhAn_PhuKhoa _BenhAn_PhuKhoa = new frm_BenhAn_PhuKhoa(mnu.Tag.ToString());
            _BenhAn_PhuKhoa.m_enAct = action.Insert;
            _BenhAn_PhuKhoa._OnCreated += _OnCreated;
            _BenhAn_PhuKhoa.ShowDialog();
        }
        ...
        {
            ToolStripMenuItem mnu = sender as ToolStripMenuItem;
            frm_BenhAn_SanKhoa _BenhAn_SanKhoa = new frm_BenhAn_SanKhoa(mnu.Tag.ToString());
            _BenhAn_SanKhoa.m_enAct = action.Insert;
            _BenhAn_SanKhoa._OnCreated += _OnCreated;
            _BenhAn_SanKhoa.ShowDialog();
        }

        private void mnuBASosinh_Click(object sender, EventArgs e)
        {

        }

        private void mnuBANgoaikhoa_Click(object sender, EventArgs e)
        {
            ToolStripMenuItem mnu = sender as ToolStripMenuItem;
            frm_BenhAn_NgoaiKhoa _BenhAn_NgoaiKhoa = new frm_BenhAn_NgoaiKhoa(mnu.Tag.ToString());
            _BenhAn_NgoaiKhoa.m_enAct = action.Insert;
            _BenhAn_NgoaiKhoa._OnCreated += _OnCreated;
            _BenhAn_NgoaiKhoa.ShowDialog();
        }
        ...
        private void mnuBANgoaitru_Click(object sender, EventArgs e)
        {
            ToolStripMenuItem mnu = sender as ToolStripMenuItem;
            frm_BenhAn_NgoaiTru _BenhAn_NgoaiTru = new frm_BenhAn_NgoaiTru(mnu.Tag.ToString());
            _BenhAn_NgoaiTru.m_enAct = action.Insert;
            _BenhAn_NgoaiTru._OnCreated += _OnCreated;
            _BenhAn_NgoaiTru.ShowDialog();
        }

        private void mnuBANamKhoa_Click(object sender, EventArgs e)
        {
            ToolStripMenuItem mnu = sender as ToolStripMenuItem;
            frm_BenhAn_NamKhoa _BenhAn_NamKhoa = new frm_BenhAn_NamKhoa(mnu.Tag.ToString());
            _BenhAn_NamKhoa.m_enAct = action.Insert;
            _BenhAn_NamKhoa._OnCreated += _OnCreated;
            _BenhAn_NamKhoa.ShowDialog();
        }
    }
