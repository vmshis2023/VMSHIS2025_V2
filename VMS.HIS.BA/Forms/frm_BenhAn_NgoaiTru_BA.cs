...
{
    public partial class frm_BenhAn_NgoaiTru_BA : Form
    {
        ...
        public frm_BenhAn_NgoaiTru_BA(string lstLoaiBA)
        {
            InitializeComponent();
       ...
       void LuuBA(int trangthai)
            ...
            try
            {
                ...
                using (var scope = new TransactionScope())
                {
                    using (var dbscope = new SharedDbConnectionScope())
                    {
                        ...
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_BIA, "BA16_BANGOAITRU_BIA", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();

                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO1, "BA16_BANGOAITRU_TO1", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO2, "BA16_BANGOAITRU_TO2", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BENHAN_TO3, "BA16_BANGOAITRU_TO3", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();

                        emrdoc.InitDocument(objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham, Utility.Int64Dbnull(objEmrBa.IdBa), objEmrBa.NgaylamBa.Value, Loaiphieu_HIS.BA_NGOAITRU, "BA16_BANGOAITRU", objEmrBa.NguoiTao, -1, -1, Utility.Byte2Bool(0), "", true, false, "", objEmrBa.LoaiBa);
                        emrdoc.Save();
        ...
        void TaoPhieuKCB()
        {
            ...
            objPKB.MotaThem = "";
            uc_ba_caccoquan_ngoaikhoa1.SetData(objPKB);
        ...
        private EmrBa TaoEmrBa()
        {
            ...
            try
            {
                ...
                objEmrBa.HoibenhTiensubanthan = Utility.sDbnull(txt_tsb_banthan_mota.Text);
                objEmrBa.HoibenhTiensugiadinh = Utility.sDbnull(txt_tsb_giadinh_mota.Text);
               ...
               //Thông tin khám bệnh
                ...
                objEmrBa.TsbDiungCo = opt_tsb_diung_co.Checked;
                objEmrBa.TsbDiungKhong = opt_tsb_diung_khong.Checked;
                objEmrBa.TsbDiungMota = Utility.sDbnull(txt_tsb_diung_mota.Text);

                objEmrBa.TsbBanthanCo = opt_tsb_banthan_co.Checked;
                objEmrBa.TsbBanthanKhong = opt_tsb_banthan_khong.Checked;
                objEmrBa.TsbBanthanMota = Utility.sDbnull(txt_tsb_banthan_mota.Text);

                objEmrBa.TsbGiadinhCo = opt_tsb_giadinh_co.Checked;
                objEmrBa.TsbGiadinhKhong = opt_tsb_giadinh_khong.Checked;
                objEmrBa.TsbGiadinhMota = Utility.sDbnull(txt_tsb_giadinh_mota.Text);


                objEmrBa.KhambenhToanthan = Utility.sDbnull(objPKB.ToanThan);
                objEmrBa.ToanthanBatthuong = objPKB.ToanthanBatthuong;
                objEmrBa.ToanthanBinhthuong = objPKB.ToanthanBinhthuong;

                objEmrBa.KhambenhTuanhoan = Utility.sDbnull(objPKB.Tuanhoan);
                objEmrBa.TuanhoanBatthuong = objPKB.TuanhoanBatthuong;
                objEmrBa.TuanhoanBinhthuong = objPKB.TuanhoanBinhthuong;
                
                objEmrBa.KhambenhHohap = Utility.sDbnull(objPKB.Hohap);
                objEmrBa.HohapBatthuong = objPKB.HohapBatthuong;
                objEmrBa.HohapBinhthuong = objPKB.HohapBinhthuong;
                
                objEmrBa.KhambenhTieuhoa = Utility.sDbnull(objPKB.Tieuhoa);
                objEmrBa.TieuhoaBatthuong = objPKB.TieuhoaBatthuong;
                objEmrBa.TieuhoaBinhthuong = objPKB.TieuhoaBinhthuong;
                
                objEmrBa.KhambenhThantietnieusinhduc = Utility.sDbnull(objPKB.Thantietnieusinhduc);
                objEmrBa.ThantietnieusinhducBatthuong = objPKB.ThantietnieusinhducBatthuong;
                objEmrBa.ThantietnieusinhducBinhthuong = objPKB.ThantietnieusinhducBinhthuong;
               
                objEmrBa.KhambenhThankinh = Utility.sDbnull(objPKB.Thankinh);
                objEmrBa.ThankinhBatthuong = objPKB.ThankinhBatthuong;
                objEmrBa.ThankinhBinhthuong = objPKB.ThankinhBinhthuong;
               
                objEmrBa.KhambenhCoxuongkhop = Utility.sDbnull(objPKB.Coxuongkhop);
                objEmrBa.CoxuongkhopBatthuong = objPKB.CoxuongkhopBatthuong;
                objEmrBa.CoxuongkhopBinhthuong = objPKB.CoxuongkhopBinhthuong;
                
                objEmrBa.KhambenhTaimuihong = Utility.sDbnull(objPKB.ToanThan);
                objEmrBa.TaimuihongBatthuong = objPKB.ToanthanBatthuong;
                objEmrBa.TaimuihongBinhthuong = objPKB.ToanthanBinhthuong;
                
                objEmrBa.KhambenhTaimuihong = Utility.sDbnull(objPKB.Taimuihong);
                objEmrBa.ToanthanBatthuong = objPKB.ToanthanBatthuong;
                objEmrBa.ToanthanBinhthuong = objPKB.ToanthanBinhthuong;
               
                objEmrBa.KhambenhRanghammat = Utility.sDbnull(objPKB.Ranghammat);
                objEmrBa.RanghammatBatthuong = objPKB.RanghammatBatthuong;
                objEmrBa.RanghammatBinhthuong = objPKB.RanghammatBinhthuong;

                objEmrBa.KhambenhMat = Utility.sDbnull(objPKB.Mat);
                objEmrBa.MatBatthuong = objPKB.MatBatthuong;
                objEmrBa.MatBinhthuong = objPKB.MatBinhthuong;

                objEmrBa.KhambenhBenhlykhac = Utility.sDbnull(objPKB.CacBenhlyKhac);

                objEmrBa.KhambenhCacbophan = Utility.sDbnull(objPKB.BoPhan);
                objEmrBa.KhambenhTomtatbenhan= Utility.sDbnull(txtTomtatKQCLS.Text);
                objEmrBa.CdBandau = Utility.sDbnull(txt_chandoan_vaovien.Text);
                objEmrBa.KhambenhDaxulychamsoc = Utility.sDbnull(txtDaXulyThuocChamsoc.Text);
                objEmrBa.RavienTenBenhchinh = Utility.sDbnull(txt_chandoan_ravien.Text);
                ...
                objEmrBa.TinhtrangravienKetquadieutriKhoi = opt_ttrv_khoi.Checked;
                objEmrBa.TinhtrangravienKetquadieutriDogiam = opt_ttrv_do.Checked;
                objEmrBa.TinhtrangravienKetquadieutriKhongthaydoi = opt_ttrv_khongthaydoi.Checked;
                objEmrBa.TinhtrangravienKetquadieutriNanghon = opt_ttrv_nanghon.Checked;
                objEmrBa.TinhtrangravienKetquadieutriTuvong = opt_ttrv_tuvong.Checked;
                objEmrBa.TinhtrangravienKetquadieutriKhongxacdinh = opt_ttrv_chuaxacdinh.Checked;
                objEmrBa.TinhtrangravienKetquadieutriTienluongnangxinve = opt_ttrv_tienluongnangxinve.Checked;

                objEmrBa.TongketbaTinhtrangNguoiravien = Utility.sDbnull(txtTKBATinhTrangRaVien.Text);
               
                objEmrBa.RavienTenBenhchinh = Utility.sDbnull(txt_tenbenhchinh_ravien.Text);
                objEmrBa.RavienTenBenhphu = Utility.sDbnull(txt_tenbenhkemtheo_ravien.Text);
                objEmrBa.RavienTenBienchung = Utility.sDbnull(txt_tenbienchung_ravien.Text);

                objEmrBa.RavienMaBenhchinh = Utility.sDbnull(txt_mabenhchinh_ravien.Text);
                objEmrBa.RavienMaBenhphu = Utility.sDbnull(txt_mabenhkemtheo_ravien.Text);
                objEmrBa.RavienMaBienchung = Utility.sDbnull(txt_mabienchung_ravien.Text);
        ...
        private void frm_BenhAn_NgoaiTru_BA_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
        ...
        private void frm_BenhAn_NgoaiTru_BA_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                ...
                if (objEmrBa != null)
                {
                    ...
                    try
                    {
                        ...
                        txt_tsb_banthan_mota.Text = objEmrBa.HoibenhTiensubanthan;
                        txt_tsb_giadinh_mota.Text = objEmrBa.HoibenhTiensugiadinh;
                        opt_tsb_diung_co.Checked = Utility.Bool2Bool(objEmrBa.TsbDiungCo);
                        opt_tsb_diung_khong.Checked = Utility.Bool2Bool(objEmrBa.TsbDiungKhong);
                        txt_tsb_diung_mota.Text = Utility.sDbnull(objEmrBa.TsbDiungMota);

                        opt_tsb_banthan_co.Checked = Utility.Bool2Bool(objEmrBa.TsbBanthanCo);
                        opt_tsb_banthan_khong.Checked = Utility.Bool2Bool(objEmrBa.TsbBanthanKhong);
                        txt_tsb_banthan_mota.Text = Utility.sDbnull(objEmrBa.TsbBanthanMota);

                        opt_tsb_giadinh_co.Checked = Utility.Bool2Bool(objEmrBa.TsbGiadinhCo);
                        opt_tsb_giadinh_khong.Checked = Utility.Bool2Bool(objEmrBa.TsbGiadinhKhong);
                        txt_tsb_giadinh_mota.Text = Utility.sDbnull(objEmrBa.TsbGiadinhMota);


                        txtTomtatKQCLS.Text = objEmrBa.KhambenhTomtatbenhan;
                        txt_chandoan_vaovien.Text = objEmrBa.CdBandau;
                        txtDaXulyThuocChamsoc.Text = objEmrBa.KhambenhDaxulychamsoc;
                        txt_chandoan_ravien.Text = objEmrBa.RavienTenBenhchinh;
                        ...
                        {
                            opt_ttrv_khoi.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriKhoi);
                            opt_ttrv_do.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriDogiam);
                            opt_ttrv_khongthaydoi.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriKhongthaydoi);
                            opt_ttrv_nanghon.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriNanghon);
                            opt_ttrv_tuvong.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriTuvong);

                            opt_ttrv_tienluongnangxinve.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriTienluongnangxinve);
                            opt_ttrv_chuaxacdinh.Checked = Utility.Bool2Bool(objEmrBa.TinhtrangravienKetquadieutriKhongxacdinh);

                            txt_tenbenhchinh_ravien.Text = Utility.sDbnull(objEmrBa.RavienTenBenhchinh);
                            txt_mabenhchinh_ravien.Text = Utility.sDbnull(objEmrBa.RavienMaBenhchinh);

                            txt_tenbenhkemtheo_ravien.Text = Utility.sDbnull(objEmrBa.RavienTenBenhphu);
                            txt_mabenhkemtheo_ravien.Text = Utility.sDbnull(objEmrBa.RavienMaBenhphu);

                            txt_tenbienchung_ravien.Text = Utility.sDbnull(objEmrBa.RavienTenBienchung);
                            txt_mabienchung_ravien.Text = Utility.sDbnull(objEmrBa.RavienMaBienchung);
                        }
                        else if (objEmrBa.TrangThai >= 2)
                        {
                        }
                ...
                else//Auto fill
                {
                    ...
                    {
                        if (objPhieuRavien.DieutringoaitruTungay.HasValue)
                        {
                            dtpDieutriTungay.Value = objPhieuRavien.DieutringoaitruTungay.Value;
                            dtpDieutriDenngay.Value = dtpDieutriTungay.Value.AddDays(Utility.Int32Dbnull( objPhieuRavien.DieutringoaitruSongay));
                        }
                        else
                            dtpDieutriDenngay.ResetText();
                    }    
        ...
        void FillHoibenhChandoan()
        {
            try
            {
                ...
                if (objHoiBenhChanDoan != null)
                {
                    ...
                    txt_tsb_banthan_mota.Text = objHoiBenhChanDoan.TiensuBenh;
                    txt_tsb_giadinh_mota.Text = objHoiBenhChanDoan.TiensuGiadinh;
                    txtTomtatKQCLS.Text = objHoiBenhChanDoan.TomtatCls;
                    txt_chandoan_vaovien.Text = objHoiBenhChanDoan.Chandoan;
                    ...
                    if (dr != null)
                        txt_chandoan_ravien.Text =Utility.sDbnull( dr[DmucBenh.Columns.TenBenh]);
                    else
        ...
        void FillPhieuKCB()
        {
            ...
            if (objPKB != null)
            {
                ...
                uc_ba_caccoquan_ngoaikhoa1.ShowData(objPKB);
        ...
        void FillThongtinNhapvien()
        {
            ...
            if (objNhapvien != null)
            {
                ...
                txt_chandoan_vaovien.Text =objNhapvien.ChandoanVaovien;
        ...
        private void FillThongtinRavien()
        {
            ...
            if (objPhieuRavien != null)
            {
                ...
                foreach (CheckBox cb in pnl_tinhtrangravien.Controls)
            ...
            txt_tenbenhchinh_ravien.Text = chandoan;
            txt_mabenhchinh_ravien.Text = Utility.sDbnull(mabenh);
            txt_tenbenhkemtheo_ravien.Text = chandoanphu;
            txt_mabenhkemtheo_ravien.Text = mabenhphu;
            txt_tenbienchung_ravien.Text = ICD_BienChung_Name;
            txt_mabienchung_ravien.Text = ICD_Bienchung_Code;
                    ...
                    if (Utility.AcceptQuestion("Bạn có muốn xóa thông tin bệnh án đang chọn không ?", "Thông báo", true))
                    {
                        using (var Scope = new TransactionScope())
                        {
                            using (var dbScope = new SharedDbConnectionScope())
                            {
                                ...
                                Utility.Log("frm_BenhAn_NgoaiTru_BA", globalVariables.UserName, string.Format("Xóa bệnh án id={0}, loại BA={1}, mã BA={2} của người bệnh id ={3}, mã lần khám {4} thành công", objEmrBa.IdBa, objEmrBa.LoaiBa, objEmrBa.MaBa, objEmrBa.IdBenhnhan, objEmrBa.MaLuotkham), newaction.Delete, "UI");
                            }
                            Scope.Complete();
                        }
                        this.DialogResult = DialogResult.OK;
        ...
        private void opt_tsb_diung_co_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_tsb_diung_mota, sender as RadioButton);
        }

        private void opt_tsb_banthan_co_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_tsb_banthan_mota, sender as RadioButton);
        }

        private void opt_tsb_giadinh_co_CheckedChanged(object sender, EventArgs e)
        {
            Utility.EnableAndFocus(txt_tsb_giadinh_mota, sender as RadioButton);
        }
    }
}
