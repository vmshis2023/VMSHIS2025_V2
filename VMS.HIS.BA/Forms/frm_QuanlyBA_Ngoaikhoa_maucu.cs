...
{
    public partial class frm_QuanlyBA_Ngoaikhoa_maucu : Form
    {
        ...
        public frm_QuanlyBA_Ngoaikhoa_maucu(string lstLoaiBA)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            ...
            Load += frm_QuanlyBA_Ngoaikhoa_maucu_Load;
            KeyDown += frm_QuanlyBA_Ngoaikhoa_maucu_KeyDown;
        ...
        private void frm_QuanlyBA_Ngoaikhoa_maucu_Load(object sender, EventArgs e)
        {
        ...
        private void frm_QuanlyBA_Ngoaikhoa_maucu_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            //{
            frm_BenhAn_Ngoaikhoa_BA _BenhAn_NgoaiKhoa = new frm_BenhAn_Ngoaikhoa_BA(MauBA);
      ...
      void InitData4Print()
        ...
        private void cmdInsert_Click_1(object sender, EventArgs e)
        {
            ...
            frm_BenhAn_Ngoaikhoa_BA _BenhAn_NgoaiKhoa = new frm_BenhAn_Ngoaikhoa_BA("BA-02");
        ...
        {
            InitData4Print();
            clsInBA.InBA(objEmrBa.IdBa, objEmrBa.MaBa, objEmrBa.LoaiBa, objLuotkham, dtkhoanhapvien, dtkhoachuyen, dt_tssk, dtPhieuPttt, 7, false);
        }
