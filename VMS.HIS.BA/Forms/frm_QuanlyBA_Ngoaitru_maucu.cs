...
{
    public partial class frm_QuanlyBA_Ngoaitru_maucu : Form
    {
        ...
        public frm_QuanlyBA_Ngoaitru_maucu(string lstLoaiBA)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            ...
            Load += frm_QuanlyBA_Ngoaitru_maucu_Load;
            KeyDown += frm_QuanlyBA_Ngoaitru_maucu_KeyDown;
        ...
        private void frm_QuanlyBA_Ngoaitru_maucu_Load(object sender, EventArgs e)
        {
        ...
        private void frm_QuanlyBA_Ngoaitru_maucu_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            //{
            frm_BenhAn_NgoaiTru_BA BA = new frm_BenhAn_NgoaiTru_BA(MauBA);
      ...
      void InitData4Print()
        ...
        private void cmdInsert_Click_1(object sender, EventArgs e)
        {
            ...
            frm_BenhAn_NgoaiTru_BA _BenhAn_NgoaiTru = new frm_BenhAn_NgoaiTru_BA("BA-16");
