...
{
    public partial class frm_phieubangiaonguoibenhchuyenkhoa : Form
    {
        ...
        {
            InitializeComponent();
            this.FormClosing += frm_phieubangiaonguoibenhchuyenkhoa_FormClosing;
        ...
        private void frm_phieubangiaonguoibenhchuyenkhoa_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }
