...
namespace VMS.HIS.UI.EMR
{
    public partial class frm_KCBCoban : Form
    {
        ...
        public frm_KCBCoban(KcbLuotkham objLuotkham, KcbDanhsachBenhnhan objBenhnhan)
        {
            InitializeComponent();
        ...
        void grdLichSu_SelectionChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    objphieukham = EmrPhieukhambenh.FetchByID(Utility.Int64Dbnull(grdLichSu.GetValue("id")));
            //    FillData();
            //}
        }
        ...
        void cmdthemmoi_Click(object sender, EventArgs e)
        {
            ...
            objphieukham = new EmrPhieukhambenh();
            SetControlStatus();
        }
        ...
        {
            cmdthemmoi.Enabled = objphieukham==null;
            cmdSua.Enabled = cmdIn.Enabled = cmdxoa.Enabled = objphieukham!=null;
            cmdExit.Enabled = true;
        }
        ...
        //}
        EmrPhieukhambenh objphieukham = null;
        private void FillData()
        {
            try
            {
                if (objphieukham != null)
                {
                    ...
                    txt_KhamToanThan.Text = objphieukham.ToanThan;
                    txtBenhNgoaikhoa.Text = objphieukham.NgoaiKhoa;
                    txt_KhamBoPhan.Text = objphieukham.BoPhan;
                    ...
                    txtToanThan_DangDi.Text = objphieukham.DangDi;
                    txtToanThan_TinhThan.Text = objphieukham.TinhThan;
                    txtToanThan_HinhDangChung.Text = objphieukham.HinhdangChung;
                    txtToanThan_MauSacDa.Text = objphieukham.MausacDa;
                    txtToanThan_TinhTrangDa.Text = objphieukham.TinhtrangDa;
                    txtToanThan_HeThongLongToc.Text = objphieukham.HethongLongtoc;
                    txtBoPhan_NghiCoBenh.Text = objphieukham.NghiCobenh;
                    txtBoPhan_Dau.Text = objphieukham.BophanDau;
                    txtBoPhan_Co.Text = objphieukham.BophanCo;
                    txtBoPhan_Nguc.Text = objphieukham.BophanNguc;
                    txtBoPhan_Bung.Text = objphieukham.BophanBung;
                    txtBoPhan_CotSong.Text = objphieukham.BophanCotsong;
                    txtBoPhan_ChatThai.Text = objphieukham.BophanChatthai;
                    txt_KhamBoPhan.Text = objphieukham.BoPhan;
                    txt_KhamToanThan.Text = objphieukham.ToanThan;

                    txtTuanhoan.Text = objphieukham.Tuanhoan;
                    txtHohap.Text = objphieukham.Hohap;
                    txtTieuhoa.Text = objphieukham.Tieuhoa;
                    txtThantietnieu.Text = objphieukham.Thantietnieusinhduc;
                    txtThankinh.Text = objphieukham.Thankinh;
                    txtCoxuongkhop.Text = objphieukham.Coxuongkhop;
                    txtTaimuihong.Text = objphieukham.Taimuihong;
                    txtRanghammat.Text = objphieukham.Ranghammat;
                    txtMat.Text = objphieukham.Mat;
                    txtBophanKhac.Text = objphieukham.Noitietdinhduongbenhlykhac;
                ...
                else
                {
                    ...
                    if (tef != null)
                    {
                        txtNhipTho.Text = Utility.sDbnull(tef.Mach);
        ...
        void SaveData()
        {
            try
            {
                ...
                objphieukham.NgoaiKhoa = Utility.sDbnull(txtBenhNgoaikhoa.Text);
                ...
                objphieukham.Tuanhoan = Utility.sDbnull(txtTuanhoan.Text);
                objphieukham.Hohap = Utility.sDbnull(txtHohap.Text);
                objphieukham.Tieuhoa = Utility.sDbnull(txtTieuhoa.Text);
                objphieukham.Thantietnieusinhduc = Utility.sDbnull(txtThantietnieu.Text);
                objphieukham.Thankinh = Utility.sDbnull(txtThankinh.Text);
                objphieukham.Coxuongkhop = Utility.sDbnull(txtCoxuongkhop.Text);
                objphieukham.Taimuihong = Utility.sDbnull(txtTaimuihong.Text);
                objphieukham.Ranghammat = Utility.sDbnull(txtRanghammat.Text);
                objphieukham.Mat = Utility.sDbnull(txtMat.Text);
