...
{
    public partial class frm_QuanlyGiaychungnhanTainanThuongtich : Form
    {
        ...
        public frm_QuanlyGiaychungnhanTainanThuongtich()
        {
            InitializeComponent();
        ...
        private void frm_QuanlyGiaychungnhanTainanThuongtich_Load(object sender, EventArgs e)
        {
        ...
        private void TimKiemThongTin()
        {
            ...
            m_dtData = SPs.Tt25GiaychungnhanThuongtichLaydanhsach(-1,tungay, denngay, "", ma_luotkham,ten_benhnhan).GetDataSet().Tables[0];
        ...
        private void frm_QuanlyGiaychungnhanTainanThuongtich_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            frm_giaychungnhan_tainanthuongtich giayxacnhan = new frm_giaychungnhan_tainanthuongtich();
        ...
        void _OnCreated(long id, action m_enAct)
        {
            try
            {
                DataTable dt_temp = SPs.Tt25GiaychungnhanThuongtichLaydanhsach(id, new DateTime(1900, 1, 1), new DateTime(1900, 1, 1),"","","").GetDataSet().Tables[0];
        ...
        bool DeleteMe()
        {
            try
            {
                using (var scope = new TransactionScope())
                {
                    ...
                    {
                        long IdPhieu = Utility.Int32Dbnull(grdList.GetValue(Tt25GiaychungnhanThuongtich.Columns.Id), -1);
                        new Delete().From(Tt25GiaychungnhanThuongtich.Schema).Where(Tt25GiaychungnhanThuongtich.Columns.Id).IsEqualTo(IdPhieu).Execute();
                        emrdoc.DeleteDocument(IdPhieu, Loaiphieu_HIS.TT25_GIAYCHUNGNHAN_TAINANTHUONGTICH, Loaiphieu_HIS.TT25_GIAYCHUNGNHAN_TAINANTHUONGTICH);
                    }
                    scope.Complete();
        ...
        private void cmdDelete_Click(object sender, EventArgs e)
        {
            try
            {
                Tt25GiaychungnhanThuongtich objGiayXacnhan = Tt25GiaychungnhanThuongtich.FetchByID(Utility.Int32Dbnull(grdList.GetValue(Tt25GiaychungnhanThuongtich.Columns.Id), -1));
                if (objGiayXacnhan == null)
                {
                    Utility.ShowMsg(string.Format("Giấy chứng nhận thương tích của người bệnh {0} có thể đã bị người khác xóa ở chức năng khác. Vui lòng kiểm tra lại bằng cách nhấn nút tìm kiếm", grdList.GetValue("ten_benhnhan").ToString()));
                    return;
                }
                
                if (Utility.AcceptQuestion(string.Format("Bạn có chắc chắn muốn xóa phiếu {0} của người bệnh {1} hay không?", grdList.GetValue(Tt25GiaychungnhanThuongtich.Columns.SoHoso).ToString(), grdList.GetValue("ten_benhnhan").ToString()), "Xác nhận xóa", true))
                {
                    if (DeleteMe())
                    {
                        ...
                        DataRow[] arrDr = m_dtData.Select(string.Format("{0}={1}", Tt25GiaychungnhanThuongtich.Columns.Id, grdList.GetValue(Tt25GiaychungnhanThuongtich.Columns.Id)));
                        if (arrDr.Length > 0)
                            m_dtData.Rows.Remove(arrDr[0]);
                        m_dtData.AcceptChanges();
                    }
        ...
        private void cmdPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    Tt25GiaychungnhanThuongtich giayxacnhan = new Select().From(Tt25GiaychungnhanThuongtich.Schema)
                           .Where(Tt25GiaychungnhanThuongtich.Columns.Id).IsEqualTo(Utility.Int64Dbnull( grdList.GetValue(Tt25GiaychungnhanThuongtich.Columns.Id)))
                           .ExecuteSingle<Tt25GiaychungnhanThuongtich>();
                    if (giayxacnhan==null)
                    {
                        Utility.ShowMsg("Giấy chứng nhận tai nạn thương tích không tồn tại.\nCó thể đã bị người khác xóa trong khi bạn đang thao tác.\nVui lòng kiểm tra lại");
