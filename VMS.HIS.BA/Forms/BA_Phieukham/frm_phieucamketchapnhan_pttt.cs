...
{
    public partial class frm_phieucamketchapnhan_pttt : Form
    {
        ...
        {
            InitializeComponent();
            this.FormClosing += frm_phieucamketchapnhan_pttt_FormClosing;
          
            this.Shown += frm_phieucamketchapnhan_pttt_Shown;
            this.KeyDown += frm_phieucamketchapnhan_pttt_KeyDown;
        ...
        private void frm_phieucamketchapnhan_pttt_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_phieucamketchapnhan_pttt_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }
