        ...
        public void DisplayData()
        {
            try
            {
                ...
                if (objPhieutheodoitaibuongde != null)
                {
                    ...
                    nmrSorauCannang.Value =Utility.Int32Dbnull( objPhieutheodoitaibuongde.TresosinhCannang);
                    ...
                    nmrSorauCannang.Value =Utility.Int32Dbnull( objPhieutheodoitaibuongde.SorauCannang);
            ...
            try
            {
                using (var scope = new TransactionScope())
                {
                   ...
                   .ExecuteSingle<EmrPhieutheodoiTaibuongde>();
                        ...
                        objPhieutheodoitaibuongde.SorauCannang= Utility.Int16Dbnull(nmrSorauCannang.Value);
