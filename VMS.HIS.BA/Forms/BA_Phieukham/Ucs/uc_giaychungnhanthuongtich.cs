...
{
    public partial class uc_giaychungnhanthuongtich : UserControl
    {
        ...
        public void Init(KcbLuotkham objLuotkham, Tt25GiaychungnhanThuongtich giayxacnhan)
        {
        ...
        public void Init(KcbLuotkham objLuotkham)
        {
            dtpNgayxacnhan.Value = globalVariables.SysDate;
            this.objLuotkham = objLuotkham;
            giayxacnhan = new Select().From(Tt25GiaychungnhanThuongtich.Schema)
                        .Where(Tt25GiaychungnhanThuongtich.Columns.IdBenhnhan).IsEqualTo(objLuotkham.IdBenhnhan)
                        .And(Tt25GiaychungnhanThuongtich.Columns.MaLuotkham).IsEqualTo(objLuotkham.MaLuotkham)
        ...
        public void DisplayData()
        {
            try
            {
                ...
                if (giayxacnhan != null)
                {
                    ...
                    txt_lydo_vaovien.Text = Utility.sDbnull(giayxacnhan.LydoVaovien);
                    ...
                    txt_tinhtrangtonthuonglucvaovien.Text = Utility.sDbnull(giayxacnhan.Tinhtrangtonthuonglucvaovien);
                    txt_tinhtrangtonthuonglucravien.Text = Utility.sDbnull(giayxacnhan.Tinhtrangtonthuonglucravien);
                    txt_lydo_vaovien.Text = Utility.sDbnull(giayxacnhan.LydoVaovien);
                ...
                txtSoHoso.Text = giayxacnhan == null || string.IsNullOrEmpty(Utility.sDbnull(giayxacnhan.SoHoso, "")) ? THU_VIEN_CHUNG.TT25LaySohoso(1) : Utility.sDbnull(giayxacnhan.SoHoso, "");
       ...
       void ClearControl()
        ...
        {
            Msg = "";
            if (dtpNgayravien.Value<= dtpNgayvaovien.Value)
            {
            ...
            DataTable dtData = new Select().From(Tt25GiaychungnhanThuongtich.Schema)
                .Where(Tt25GiaychungnhanThuongtich.Columns.SoHoso).IsEqualTo(Utility.DoTrim(txtSoHoso.Text))
                .And(Tt25GiaychungnhanThuongtich.Columns.Id).IsNotEqualTo(Utility.Int64Dbnull(txtId.Text, -1))
            ...
            try
            {
                ...
                using (var scope = new TransactionScope())
                {
                   ...
                   .ExecuteSingle<Tt25GiaychungnhanThuongtich>();
                        ...
                        {
                            isNew = true;
                            giayxacnhan = new Tt25GiaychungnhanThuongtich();
                        ...
                        giayxacnhan.NgayRavien = dtpNgayravien.Value;
                        giayxacnhan.Ngayxacnhan = dtpNgayxacnhan.Value;

                        giayxacnhan.LydoVaovien = Utility.sDbnull(txt_lydo_vaovien.Text, "");
                        ...
                        giayxacnhan.Tinhtrangtonthuonglucvaovien = Utility.sDbnull(txt_tinhtrangtonthuonglucvaovien.Text, "");
                        giayxacnhan.Tinhtrangtonthuonglucravien = Utility.sDbnull(txt_tinhtrangtonthuonglucravien.Text, "");
                        ...
                        giayxacnhan.Save();
                        emrdoc.InitDocument(giayxacnhan.IdBenhnhan, giayxacnhan.MaLuotkham, Utility.Int64Dbnull(giayxacnhan.Id), giayxacnhan.Ngayxacnhan.Value, Loaiphieu_HIS.TT25_GIAYCHUNGNHAN_TAINANTHUONGTICH, "TT25_GIAYCHUNGNHAN_TAINANTHUONGTICH", giayxacnhan.NguoiTao,Utility.Int16Dbnull( objNguoiXacnhan.IdKhoa), Utility.Int16Dbnull(objNguoiXacnhan.IdPhong), Utility.Byte2Bool(0),"");
                        emrdoc.Save();
                    }
                    scope.Complete();
                }
        ...
        {
            txtSoHoso.Text = THU_VIEN_CHUNG.TT25LaySohoso(1);
        }
    }
}
