...
{
    public partial class uc_tt25_giayxacnhan_quatrinhdieutrinoitru : UserControl
    {
        ...
        public Tt25GiayxacnhanQuatrinhdieutrinoitru giayxacnhan;
        ...
        public void Init(KcbLuotkham objLuotkham)
        {
            dtpNgayxacnhan.Value = globalVariables.SysDate;
            this.objLuotkham = objLuotkham;
            giayxacnhan = new Select().From(Tt25GiayxacnhanQuatrinhdieutrinoitru.Schema)
        ...
        public void DisplayData()
        {
            try
            {
                ...
                if (giayxacnhan != null)
                {
                    ...
                    chkDangdieutriNoitru.Checked = Utility.Bool2Bool(giayxacnhan.Hiendangdieutrinoitru);
                    txt_hiendangdieutriNoitruTai.Text = Utility.sDbnull(giayxacnhan.Hiendangdieutrinoitrutai);
                    txt_tinhtrangnguoibenh.Text = Utility.sDbnull(giayxacnhan.Tinhtrangnguoibenh);
                ...
                txtSoHoso.Text = giayxacnhan == null || string.IsNullOrEmpty(Utility.sDbnull(giayxacnhan.SoHoso, "")) ? THU_VIEN_CHUNG.TT25LaySohoso(4) : Utility.sDbnull(giayxacnhan.SoHoso, "");
       ...
       void ClearControl()
        ...
        bool isValidData()
        {
            ...
            DataTable dtData = new Select().From(Tt25GiayxacnhanQuatrinhdieutrinoitru.Schema)
              .Where(Tt25GiayxacnhanQuatrinhdieutrinoitru.Columns.SoHoso).IsEqualTo(Utility.DoTrim(txtSoHoso.Text))
              .And(Tt25GiayxacnhanQuatrinhdieutrinoitru.Columns.Id).IsNotEqualTo(Utility.Int64Dbnull(txtId.Text, -1))
            ...
            try
            {
                ...
                using (var scope = new TransactionScope())
                {
                   ...
                   .ExecuteSingle<Tt25GiayxacnhanQuatrinhdieutrinoitru>();
                        ...
                        {
                            isNew = true;
                            giayxacnhan = new Tt25GiayxacnhanQuatrinhdieutrinoitru();
                        ...
                        giayxacnhan.Hiendangdieutrinoitru = chkDangdieutriNoitru.Checked;
                        giayxacnhan.Davarien = chkDaravien.Checked;
                        giayxacnhan.Hiendangdieutrinoitrutai = chkDangdieutriNoitru.Checked? Utility.sDbnull(txt_hiendangdieutriNoitruTai.Text, ""):"";
                        giayxacnhan.Tinhtrangnguoibenh = Utility.sDbnull(txt_tinhtrangnguoibenh.Text, "");
        ...
        {
            txt_hiendangdieutriNoitruTai.Enabled = chkDangdieutriNoitru.Checked;
        }
        ...
        {
            txtSoHoso.Text = THU_VIEN_CHUNG.TT25LaySohoso(4);
        }
    }
}
