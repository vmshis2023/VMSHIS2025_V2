...
{
    public partial class frm_giayxacnhan_nghiduongthai : Form
    {
        ...
        public frm_giayxacnhan_nghiduongthai()
        {
            InitializeComponent();
            this.FormClosing += frm_giayxacnhan_nghiduongthai_FormClosing;
          
            this.Shown += frm_giayxacnhan_nghiduongthai_Shown;
            this.KeyDown += frm_giayxacnhan_nghiduongthai_KeyDown;
            ucThongtinnguoibenh_emr_basic1._OnEnterMe += UcThongtinnguoibenh_emr_basic1__OnEnterMe;
            uc_tt25_giayxacnhan_nghiduongthai1._OnMsg += _OnMsg;
            uc_tt25_giayxacnhan_nghiduongthai1._OnStatus += _OnStatus;
        }
        ...
        private void UcThongtinnguoibenh_emr_basic1__OnEnterMe()
        {
            ...
            uc_tt25_giayxacnhan_nghiduongthai1.Init(objLuotkham);
            uc_tt25_giayxacnhan_nghiduongthai1.dtpNgayxacnhan.Focus();
        }

        private void frm_giayxacnhan_nghiduongthai_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                uc_tt25_giayxacnhan_nghiduongthai1.HandleKeyEnter();
        }

        private void frm_giayxacnhan_nghiduongthai_Shown(object sender, EventArgs e)
        {
            uc_tt25_giayxacnhan_nghiduongthai1.Init();
            uc_tt25_giayxacnhan_nghiduongthai1.Force2Saved = Force2Saved;
        ...
        private void frm_giayxacnhan_nghiduongthai_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }
        ...
        {
            IsChanged = true;
            bool result= uc_tt25_giayxacnhan_nghiduongthai1.Save();
            if (result)
            {
                m_enAct = action.Update;
                if (_OnCreated != null) _OnCreated(uc_tt25_giayxacnhan_nghiduongthai1.giayxacnhan.Id, m_enAct);
        ...
        {
            uc_tt25_giayxacnhan_nghiduongthai1.Print();
        }
    }
}
