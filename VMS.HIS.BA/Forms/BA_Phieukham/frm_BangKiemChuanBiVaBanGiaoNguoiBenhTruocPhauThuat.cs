...
{
    public partial class frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat : Form
    {
        ...
        public frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat()
        {
            InitializeComponent();
            this.FormClosing += frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat_FormClosing;
          
            this.Shown += frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat_Shown;
            this.KeyDown += frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat_KeyDown;
            ucThongtinnguoibenh_emr_basic1._OnEnterMe += UcThongtinnguoibenh_emr_basic1__OnEnterMe;
            uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1._OnMsg += _OnMsg;
            uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1._OnStatus += _OnStatus;
        }
        ...
        {
            uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.ClearControl();
            if (ucThongtinnguoibenh_emr_basic1.objLuotkham != null)
            {
                ...
                uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.Init(objLuotkham);
                uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.dtp_ngayphauthuat.Focus();
            }
            else
            {
                uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.ClearControl();
        ...
        private void frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.HandleKeyEnter();
        }

        private void frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat_Shown(object sender, EventArgs e)
        {
            uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.Init();
            uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.Force2Saved = Force2Saved;
        ...
        private void frm_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }
        ...
        {
          bool result= uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.Save();
            if (result)
            {
                m_enAct = action.Update;
                if (_OnCreated != null) _OnCreated(uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1._phieu.IdPhieu, m_enAct);
        ...
        {
            uc_pt02_BangKiemChuanBiVaBanGiaoNguoiBenhTruocPhauThuat1.Print();
        }
    }
}
