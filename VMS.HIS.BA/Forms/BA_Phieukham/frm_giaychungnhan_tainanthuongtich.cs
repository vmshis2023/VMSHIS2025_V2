...
{
    public partial class frm_giaychungnhan_tainanthuongtich : Form
    {
        ...
        {
            InitializeComponent();
            this.FormClosing += frm_giaychungnhan_tainanthuongtich_FormClosing;
          
            this.Shown += frm_giaychungnhan_tainanthuongtich_Shown;
            this.KeyDown += frm_giaychungnhan_tainanthuongtich_KeyDown;
            ucThongtinnguoibenh_emr_basic1._OnEnterMe += UcThongtinnguoibenh_emr_basic1__OnEnterMe;
            uc_giaychungnhanthuongtich1._OnMsg += _OnMsg;
            uc_giaychungnhanthuongtich1._OnStatus += _OnStatus;
        }
        ...
        private void UcThongtinnguoibenh_emr_basic1__OnEnterMe()
        {
            ...
            uc_giaychungnhanthuongtich1.Init(objLuotkham);
            uc_giaychungnhanthuongtich1.dtpNgayxacnhan.Focus();
        }

        private void frm_giaychungnhan_tainanthuongtich_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                uc_giaychungnhanthuongtich1.HandleKeyEnter();
        }
        ...
        private void frm_giaychungnhan_tainanthuongtich_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }
        ...
        {
          bool result= uc_giaychungnhanthuongtich1.Save();
            if (result)
            {
                m_enAct = action.Update;
                if (_OnCreated != null) _OnCreated(uc_giaychungnhanthuongtich1.giayxacnhan.Id, m_enAct);
        ...
        {
            uc_giaychungnhanthuongtich1.Print();
        }
    }
}
