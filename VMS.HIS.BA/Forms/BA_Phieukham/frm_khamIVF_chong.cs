...
{
    public partial class frm_khamIVF_chong : Form
    {
        ...
        {
            InitializeComponent();
            this.KeyDown += frm_khamIVF_chong_KeyDown;
        ...
        void frm_khamIVF_chong_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_khamIVF_chong_Load(object sender, EventArgs e)
        {
            InitDanhmucchung();
        ...
        private void FillData()
        {
            try
            {
                ...
                if (objPhieuKhamIvfChong != null)
                {
                    ...
                    //Tiền sử nội khoa
                    txt_hoten_chong.Text = Utility.sDbnull(objPhieuKhamIvfChong.HotenChong);
                    dtp_ngaysinh.Value = objPhieuKhamIvfChong.NgaythangnamsinhChong.Value;
                    txt_sodienthoai_chong.Text=Utility.sDbnull(objPhieuKhamIvfChong.SodienthoaiChong);
                    ...
                    txt_benhkhac_mota.Text = Utility.sDbnull(objPhieuKhamIvfChong.BenhkhacMota);
                    //Tiền sử điều trị nội khoa
                    opt_tiensudieutrinoikhoa_co.Checked = Utility.Bool2Bool(objPhieuKhamIvfChong.TiensudieutrinoikhoaCo); 
                    opt_tiensudieutrinoikhoa_khong.Checked = Utility.Bool2Bool(objPhieuKhamIvfChong.TiensudieutrinoikhoaKhong); 
                    ...
                    txt_tinhoan_phai.Text = Utility.sDbnull(objPhieuKhamIvfChong.TinhoanPhai);
                    txt_tinhoan_trai.Text = Utility.sDbnull(objPhieuKhamIvfChong.TinhoanTrai);
                    txt_thetich_phai.Text = Utility.sDbnull(objPhieuKhamIvfChong.ThetichPhai);
                    txt_thetich_trai.Text = Utility.sDbnull(objPhieuKhamIvfChong.ThetichTrai);
                    txt_maotinhoan_phai.Text = Utility.sDbnull(objPhieuKhamIvfChong.MaotinhoanPhai);
                    txt_maotinhoan_trai.Text = Utility.sDbnull(objPhieuKhamIvfChong.MaotinhoanTrai);
                    txt_ongdantinh_phai.Text = Utility.sDbnull(objPhieuKhamIvfChong.OngdantinhPhai);
                    txt_ongdantinh_trai.Text = Utility.sDbnull(objPhieuKhamIvfChong.OngdantinhTrai);
                    txt_giantinhmachthungtinh_phai.Text = Utility.sDbnull(objPhieuKhamIvfChong.GiantinhmachthungtinhPhai);
                    txt_giantinhmachthungtinh_trai.Text = Utility.sDbnull(objPhieuKhamIvfChong.GiantinhmachthungtinhTrai);
                    txt_ben_phai.Text = Utility.sDbnull(objPhieuKhamIvfChong.BenPhai);
        ...
        void TaoPhieuKhamIVFChong()
        {
            ...
            //Nội khoa
            objPhieuKhamIvfChong.HotenChong = Utility.sDbnull(txt_hoten_chong.Text);
            objPhieuKhamIvfChong.NgaythangnamsinhChong = dtp_ngaysinh.Value;
            objPhieuKhamIvfChong.SodienthoaiChong = Utility.sDbnull(txt_sodienthoai_chong.Text);
            objPhieuKhamIvfChong.DiachiChong= Utility.sDbnull(txt_diachi_chong.Text);
           ...
           //Bệnh toàn thân
            ...
            objPhieuKhamIvfChong.BenhkhacMota = chk_benhkhac.Checked? Utility.sDbnull(txt_benhkhac_mota.Text):"";
            //tiền sử nội khoa
            objPhieuKhamIvfChong.TiensudieutrinoikhoaCo = opt_tiensudieutrinoikhoa_co.Checked;
            objPhieuKhamIvfChong.TiensudieutrinoikhoaKhong = opt_tiensudieutrinoikhoa_khong.Checked;
            objPhieuKhamIvfChong.TiensudieutrinoikhoaMota = opt_tiensudieutrinoikhoa_co.Checked? Utility.sDbnull(txt_tiensudieutrinoikhoa_mota.Text):"";
            //Tiền sử pttt
            ...
            objPhieuKhamIvfChong.TinhoanPhai = Utility.sDbnull(txt_tinhoan_phai.Text);
            objPhieuKhamIvfChong.TinhoanTrai = Utility.sDbnull(txt_tinhoan_trai.Text);
            objPhieuKhamIvfChong.ThetichPhai = Utility.sDbnull(txt_thetich_phai.Text);
            objPhieuKhamIvfChong.ThetichTrai = Utility.sDbnull(txt_thetich_trai.Text);
            objPhieuKhamIvfChong.MaotinhoanPhai = Utility.sDbnull(txt_maotinhoan_phai.Text);
            objPhieuKhamIvfChong.MaotinhoanTrai = Utility.sDbnull(txt_maotinhoan_trai.Text);
            objPhieuKhamIvfChong.OngdantinhPhai = Utility.sDbnull(txt_ongdantinh_phai.Text);
            objPhieuKhamIvfChong.OngdantinhTrai = Utility.sDbnull(txt_ongdantinh_trai.Text);
            objPhieuKhamIvfChong.GiantinhmachthungtinhPhai = Utility.sDbnull(txt_giantinhmachthungtinh_phai.Text);
            objPhieuKhamIvfChong.GiantinhmachthungtinhTrai = Utility.sDbnull(txt_giantinhmachthungtinh_trai.Text);
            objPhieuKhamIvfChong.BenPhai = Utility.sDbnull(txt_ben_phai.Text);
