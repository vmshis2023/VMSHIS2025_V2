...
{
    public partial class frm_QuanlyBA_Phukhoa : Form
    {
        ...
        public frm_QuanlyBA_Phukhoa(string lstLoaiBA)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            ...
            Load += frm_QuanlyBA_Phukhoa_Load;
            KeyDown += frm_QuanlyBA_Phukhoa_KeyDown;
        ...
        private void frm_QuanlyBA_Phukhoa_Load(object sender, EventArgs e)
        {
        ...
        private void frm_QuanlyBA_Phukhoa_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            frm_BenhAn_PhuKhoa _BenhAn_PhuKhoa = new frm_BenhAn_PhuKhoa("04/BV1");
