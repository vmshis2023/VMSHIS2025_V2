  ...
  public class ConnectionSQL
  {
     ...
     public ConnectionSQL()
     {
      ...
      public  string KhoiTaoKetNoi()
      {
            ...
            string strSQL = string.Format("workstation id={0};packet size=4096;data source={0};persist security info=False;initial catalog={1};uid={2};pwd={3}",
                    globalVariables.ServerName, globalVariables.sDbName, globalVariables.sUName, globalVariables.sPwd);
            //string strSQL = string.Format("workstation id={0};packet size=4096;data source={0};persist security info=False;initial catalog={1};Integrated Security =true",
            //        globalVariables.ServerName, globalVariables.sDbName);
            return strSQL;
