...
{
    public partial class frm_baocao_thoigianthuchien : Form
    {
        ...
        public frm_baocao_thoigianthuchien(string sThamSo)
        {
            InitializeComponent();
        ...
        {
            _dtData =
                SPs.SpBaoCaoThongKeThoiGianKham(dtFromDate.Value, dtToDate.Value,
                                            Utility.Int16Dbnull(cboDoituongKCB.SelectedValue, -1),
                                            Utility.Int16Dbnull(txtPhongkham.MyID, -1), thamso).GetDataSet().
                    Tables[0];
