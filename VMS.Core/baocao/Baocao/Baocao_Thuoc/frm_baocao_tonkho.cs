...
{
    public partial class frm_baocao_tonkho : Form
    {
        ...
        string KieuKho = "";
        public frm_baocao_tonkho(string args)
        {
            InitializeComponent();
            ...
            this.Load+=new EventHandler(frm_baocao_tonkho_Load);
            chkByDate.CheckedChanged += chkByDate_CheckedChanged;
            cmdBaoCao.Click+=new EventHandler(cmdBaoCao_Click);
            this.KeyDown+=new KeyEventHandler(frm_baocao_tonkho_KeyDown);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_baocao_tonkho_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_baocao_tonkho_KeyDown_1(object sender, KeyEventArgs e)
        {
