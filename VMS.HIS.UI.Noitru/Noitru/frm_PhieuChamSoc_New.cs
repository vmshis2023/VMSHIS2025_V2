...
{
    public partial class frm_PhieuChamSoc_New : Form
    {
        ...
        public frm_PhieuChamSoc_New()
        {
            InitializeComponent();
            Utility.SetVisualStyle(this);
            Shown += frm_PhieuChamSoc_New_Shown;
            FormClosing += frm_PhieuChamSoc_New_FormClosing;
            ...
            KeyDown += frm_PhieuChamSoc_New_KeyDown;
        ...
        void frm_PhieuChamSoc_New_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveUserConfigs();
        }

        void frm_PhieuChamSoc_New_Shown(object sender, EventArgs e)
        {
            LoadUserConfigs();
        }
        ...
        public frm_PhieuChamSoc_New(string sthamso)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void frm_PhieuChamSoc_New_Load(object sender, EventArgs e)
        {
            InitData();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_PhieuChamSoc_New_KeyDown(object sender, KeyEventArgs e)
        {
