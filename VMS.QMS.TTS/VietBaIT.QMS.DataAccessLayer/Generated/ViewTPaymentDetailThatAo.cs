...
namespace VietBaIT.HISLink.DataAccessLayer{
    /// <summary>
    /// Strongly-typed collection for the ViewTPaymentDetailThatAo class.
    /// </summary>
    [Serializable]
    public partial class ViewTPaymentDetailThatAoCollection : ReadOnlyList<ViewTPaymentDetailThatAo, ViewTPaymentDetailThatAoCollection>
    {        
        public ViewTPaymentDetailThatAoCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_T_PaymentDetail_That_AO view.
    /// </summary>
    [Serializable]
    public partial class ViewTPaymentDetailThatAo : ReadOnlyRecord<ViewTPaymentDetailThatAo>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_T_PaymentDetail_That_AO", TableType.View, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("View_T_PaymentDetail_That_AO",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewTPaymentDetailThatAo()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewTPaymentDetailThatAo(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewTPaymentDetailThatAo(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewTPaymentDetailThatAo(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public int? DoctorAssignId 
	    {
		    get
		    {
			    return GetColumnValue<int?>("DoctorAssign_ID");
		    }
            set 
		    {
        ...
        public int? PaymentDetailType 
	    {
		    get
		    {
			    return GetColumnValue<int?>("Payment_Detail_Type");
		    }
            set 
		    {
			    SetColumnValue("Payment_Detail_Type", value);
            }
        }
