...
{
	/// <summary>
	/// Strongly-typed collection for the TNoitietThanhtoanChitietAo class.
	/// </summary>
    [Serializable]
	public partial class TNoitietThanhtoanChitietAoCollection : ActiveList<TNoitietThanhtoanChitietAo, TNoitietThanhtoanChitietAoCollection>
	{	   
		public TNoitietThanhtoanChitietAoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TNoitietThanhtoanChitietAoCollection</returns>
		public TNoitietThanhtoanChitietAoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TNoitietThanhtoanChitietAo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_NOITIET_THANHTOAN_CHITIET_AO table.
	/// </summary>
	[Serializable]
	public partial class TNoitietThanhtoanChitietAo : ActiveRecord<TNoitietThanhtoanChitietAo>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TNoitietThanhtoanChitietAo()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TNoitietThanhtoanChitietAo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TNoitietThanhtoanChitietAo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TNoitietThanhtoanChitietAo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_NOITIET_THANHTOAN_CHITIET_AO", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("T_NOITIET_THANHTOAN_CHITIET_AO",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varPaymentId,int? varQuantity,decimal? varOriginPrice,decimal? varDiscountRate,decimal? varDiscountPrice,decimal? varTienBnTra,decimal? varSurchargePrice,int? varId,int? varIdDetail,int? varServiceId,int? varServiceDetailId,string varServiceDetailName,byte? varPaymentTypeId,int? varIsCancel,int? varIsPayment,string varCancelBy,DateTime? varCancelDate,int? varDepartmentId,int? varDoctorAssignId,int? varThuTuIn,string varDonViTinh,string varMaDv,decimal? varPTramBh,string varMaKieuTtoan,int? varIdGoiDvu,decimal? varPtramCkhau,int? varTrongGoi,int? varDaThien,DateTime? varNgayTao,string varNguoiTao,byte? varNoiTru,string varIpMacTao,string varIpMayTao,string varTenHienThi,byte? varTtChuyen,byte? varBhytStatus,short? varIdNvienThien)
		{
