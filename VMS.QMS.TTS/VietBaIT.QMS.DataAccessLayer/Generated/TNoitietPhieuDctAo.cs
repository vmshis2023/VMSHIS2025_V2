...
{
	/// <summary>
	/// Strongly-typed collection for the TNoitietPhieuDctAo class.
	/// </summary>
    [Serializable]
	public partial class TNoitietPhieuDctAoCollection : ActiveList<TNoitietPhieuDctAo, TNoitietPhieuDctAoCollection>
	{	   
		public TNoitietPhieuDctAoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TNoitietPhieuDctAoCollection</returns>
		public TNoitietPhieuDctAoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TNoitietPhieuDctAo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_NOITIET_PHIEU_DCT_AO table.
	/// </summary>
	[Serializable]
	public partial class TNoitietPhieuDctAo : ActiveRecord<TNoitietPhieuDctAo>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TNoitietPhieuDctAo()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TNoitietPhieuDctAo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TNoitietPhieuDctAo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TNoitietPhieuDctAo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_NOITIET_PHIEU_DCT_AO", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("T_NOITIET_PHIEU_DCT_AO",schema);
			}
		}
		#endregion
