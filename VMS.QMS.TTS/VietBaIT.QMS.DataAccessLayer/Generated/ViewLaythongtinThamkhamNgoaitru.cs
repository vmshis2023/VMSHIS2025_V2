...
namespace VietBaIT.HISLink.DataAccessLayer{
    /// <summary>
    /// Strongly-typed collection for the ViewLaythongtinThamkhamNgoaitru class.
    /// </summary>
    [Serializable]
    public partial class ViewLaythongtinThamkhamNgoaitruCollection : ReadOnlyList<ViewLaythongtinThamkhamNgoaitru, ViewLaythongtinThamkhamNgoaitruCollection>
    {        
        public ViewLaythongtinThamkhamNgoaitruCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the VIEW_LAYTHONGTIN_THAMKHAM_NGOAITRU view.
    /// </summary>
    [Serializable]
    public partial class ViewLaythongtinThamkhamNgoaitru : ReadOnlyRecord<ViewLaythongtinThamkhamNgoaitru>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VIEW_LAYTHONGTIN_THAMKHAM_NGOAITRU", TableType.View, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("VIEW_LAYTHONGTIN_THAMKHAM_NGOAITRU",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewLaythongtinThamkhamNgoaitru()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewLaythongtinThamkhamNgoaitru(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewLaythongtinThamkhamNgoaitru(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewLaythongtinThamkhamNgoaitru(string columnName, object columnValue)
        {
            SetSQLProps();
