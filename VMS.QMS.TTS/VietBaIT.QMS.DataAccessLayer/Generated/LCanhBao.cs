...
{
	/// <summary>
	/// Strongly-typed collection for the LCanhBao class.
	/// </summary>
    [Serializable]
	public partial class LCanhBaoCollection : ActiveList<LCanhBao, LCanhBaoCollection>
	{	   
		public LCanhBaoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>LCanhBaoCollection</returns>
		public LCanhBaoCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the L_CANH_BAO table.
	/// </summary>
	[Serializable]
	public partial class LCanhBao : ActiveRecord<LCanhBao>, IActiveRecord
	{
		...
		public LCanhBao(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LCanhBao(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("L_CANH_BAO", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("L_CANH_BAO",schema);
			}
		}
		#endregion
