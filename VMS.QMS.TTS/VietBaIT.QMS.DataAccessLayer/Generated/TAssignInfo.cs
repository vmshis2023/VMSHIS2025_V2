...
{
	/// <summary>
	/// Strongly-typed collection for the TAssignInfo class.
	/// </summary>
    [Serializable]
	public partial class TAssignInfoCollection : ActiveList<TAssignInfo, TAssignInfoCollection>
	{	   
		public TAssignInfoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAssignInfoCollection</returns>
		public TAssignInfoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAssignInfo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Assign_Info table.
	/// </summary>
	[Serializable]
	public partial class TAssignInfo : ActiveRecord<TAssignInfo>, IActiveRecord
	{
		...
		public TAssignInfo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAssignInfo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAssignInfo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Assign_Info", TableType.Table, DataService.GetInstance("ORM"));
				...
				colvarIsPHIDvuKtheo.IsReadOnly = false;
						...
						colvarIsPHIDvuKtheo.DefaultSetting = @"((0))";
				colvarIsPHIDvuKtheo.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarNgayBPham = new TableSchema.TableColumn(schema);
				colvarNgayBPham.ColumnName = "Ngay_BPham";
				colvarNgayBPham.DataType = DbType.DateTime;
				colvarNgayBPham.MaxLength = 0;
				colvarNgayBPham.AutoIncrement = false;
				colvarNgayBPham.IsNullable = true;
				colvarNgayBPham.IsPrimaryKey = false;
				colvarNgayBPham.IsForeignKey = false;
				colvarNgayBPham.IsReadOnly = false;
				
						colvarNgayBPham.DefaultSetting = @"(getdate())";
				colvarNgayBPham.ForeignKeyTableName = "";
				schema.Columns.Add(colvarNgayBPham);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["ORM"].AddSchema("T_Assign_Info",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<byte?>(Columns.IsPHIDvuKtheo); }
			set { SetColumnValue(Columns.IsPHIDvuKtheo, value); }
		}
		...
		[XmlAttribute("NgayBPham")]
		[Bindable(true)]
		public DateTime? NgayBPham 
		{
			get { return GetColumnValue<DateTime?>(Columns.NgayBPham); }
			set { SetColumnValue(Columns.NgayBPham, value); }
		}
		...
		/// </summary>
		public static void Insert(long? varExamId,int? varTreatId,int? varPatientDeptId,string varPatientCode,long varPatientId,short? varServiceId,short? varServiceTypeId,DateTime varRegDate,short? varDiagPerson,short? varDepartmentId,byte varPaymentStatus,byte? varAssignStatus,string varCreatedBy,DateTime? varCreateDate,string varModifiedBy,DateTime? varModifiedDate,string varAssignCode,byte? varActived,byte? varPrintId,byte? varSendId,string varBarcode,short? varObjectTypeId,byte? varNoiTru,string varMaKhoaThien,byte? varIsPHIDvuKtheo,string varMaChidinh,DateTime? varNgayBPham)
		{
			...
			item.IsPHIDvuKtheo = varIsPHIDvuKtheo;
			
			item.MaChidinh = varMaChidinh;
			
			item.NgayBPham = varNgayBPham;
        ...
        public static TableSchema.TableColumn IsPHIDvuKtheoColumn
        {
        ...
        public static TableSchema.TableColumn NgayBPhamColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string NgayBPham = @"Ngay_BPham";
