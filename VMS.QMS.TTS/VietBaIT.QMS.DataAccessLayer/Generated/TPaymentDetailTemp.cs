...
{
	/// <summary>
	/// Strongly-typed collection for the TPaymentDetailTemp class.
	/// </summary>
    [Serializable]
	public partial class TPaymentDetailTempCollection : ActiveList<TPaymentDetailTemp, TPaymentDetailTempCollection>
	{	   
		public TPaymentDetailTempCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPaymentDetailTempCollection</returns>
		public TPaymentDetailTempCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPaymentDetailTemp o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Payment_Detail_temp table.
	/// </summary>
	[Serializable]
	public partial class TPaymentDetailTemp : ActiveRecord<TPaymentDetailTemp>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TPaymentDetailTemp()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TPaymentDetailTemp(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPaymentDetailTemp(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPaymentDetailTemp(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Payment_Detail_temp", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("T_Payment_Detail_temp",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(long varPaymentDetailId,int varPaymentId,int? varQuantity,decimal? varOriginPrice,decimal? varDiscountRate,decimal? varDiscountPrice,decimal? varTienBnTra,decimal? varSurchargePrice,int? varId,int? varIdDetail,int? varServiceId,int? varServiceDetailId,string varServiceDetailName,byte? varPaymentTypeId,byte? varIsCancel,byte? varIsPayment,string varCancelBy,DateTime? varCancelDate,short? varDepartmentId,short? varDoctorAssignId,int? varThuTuIn,string varDonViTinh,string varMaDv,decimal? varPTramBh,string varMaKieuTtoan,byte? varNoiTru,string varTenHienThi,short? varIdNvienThien)
		{
