...
namespace VietBaIT.HISLink.DataAccessLayer{
    /// <summary>
    /// Strongly-typed collection for the ViewDanhSachThuNgan class.
    /// </summary>
    [Serializable]
    public partial class ViewDanhSachThuNganCollection : ReadOnlyList<ViewDanhSachThuNgan, ViewDanhSachThuNganCollection>
    {        
        public ViewDanhSachThuNganCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the view_DanhSachThuNgan view.
    /// </summary>
    [Serializable]
    public partial class ViewDanhSachThuNgan : ReadOnlyRecord<ViewDanhSachThuNgan>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("view_DanhSachThuNgan", TableType.View, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("view_DanhSachThuNgan",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDanhSachThuNgan()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDanhSachThuNgan(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDanhSachThuNgan(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDanhSachThuNgan(string columnName, object columnValue)
        {
            SetSQLProps();
