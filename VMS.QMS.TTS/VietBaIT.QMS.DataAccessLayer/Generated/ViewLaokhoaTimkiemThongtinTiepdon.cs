...
namespace VietBaIT.HISLink.DataAccessLayer{
    /// <summary>
    /// Strongly-typed collection for the ViewLaokhoaTimkiemThongtinTiepdon class.
    /// </summary>
    [Serializable]
    public partial class ViewLaokhoaTimkiemThongtinTiepdonCollection : ReadOnlyList<ViewLaokhoaTimkiemThongtinTiepdon, ViewLaokhoaTimkiemThongtinTiepdonCollection>
    {        
        public ViewLaokhoaTimkiemThongtinTiepdonCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the VIEW_LAOKHOA_TIMKIEM_THONGTIN_TIEPDON view.
    /// </summary>
    [Serializable]
    public partial class ViewLaokhoaTimkiemThongtinTiepdon : ReadOnlyRecord<ViewLaokhoaTimkiemThongtinTiepdon>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VIEW_LAOKHOA_TIMKIEM_THONGTIN_TIEPDON", TableType.View, DataService.GetInstance("ORM"));
                ...
                colvarSoBhyt.DataType = DbType.AnsiString;
                colvarSoBhyt.MaxLength = 52;
                ...
                colvarDiseaseCode.MaxLength = 50;
                ...
                colvarAuxiDiseaseCode.DataType = DbType.AnsiString;
                colvarAuxiDiseaseCode.MaxLength = 50;
                ...
                DataService.Providers["ORM"].AddSchema("VIEW_LAOKHOA_TIMKIEM_THONGTIN_TIEPDON",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewLaokhoaTimkiemThongtinTiepdon()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewLaokhoaTimkiemThongtinTiepdon(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewLaokhoaTimkiemThongtinTiepdon(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewLaokhoaTimkiemThongtinTiepdon(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public short? DanToc 
	    {
		    get
		    {
			    return GetColumnValue<short?>("Dan_Toc");
		    }
            set 
		    {
        ...
        public string SoBhyt 
	    {
		    get
		    {
			    return GetColumnValue<string>("so_bhyt");
		    }
            set 
		    {
			    SetColumnValue("so_bhyt", value);
            }
        }
        ...
        public bool? TuyenXa 
	    {
		    get
		    {
			    return GetColumnValue<bool?>("Tuyen_Xa");
		    }
            set 
		    {
			    SetColumnValue("Tuyen_Xa", value);
            }
        }
