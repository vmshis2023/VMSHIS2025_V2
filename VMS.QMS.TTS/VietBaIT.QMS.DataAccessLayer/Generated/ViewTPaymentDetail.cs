...
namespace VietBaIT.HISLink.DataAccessLayer{
    /// <summary>
    /// Strongly-typed collection for the ViewTPaymentDetail class.
    /// </summary>
    [Serializable]
    public partial class ViewTPaymentDetailCollection : ReadOnlyList<ViewTPaymentDetail, ViewTPaymentDetailCollection>
    {        
        public ViewTPaymentDetailCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_T_PaymentDetail view.
    /// </summary>
    [Serializable]
    public partial class ViewTPaymentDetail : ReadOnlyRecord<ViewTPaymentDetail>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_T_PaymentDetail", TableType.View, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("View_T_PaymentDetail",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewTPaymentDetail()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewTPaymentDetail(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewTPaymentDetail(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewTPaymentDetail(string columnName, object columnValue)
        {
            SetSQLProps();
