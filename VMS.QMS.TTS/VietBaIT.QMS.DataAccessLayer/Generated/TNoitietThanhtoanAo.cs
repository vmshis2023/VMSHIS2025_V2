...
{
	/// <summary>
	/// Strongly-typed collection for the TNoitietThanhtoanAo class.
	/// </summary>
    [Serializable]
	public partial class TNoitietThanhtoanAoCollection : ActiveList<TNoitietThanhtoanAo, TNoitietThanhtoanAoCollection>
	{	   
		public TNoitietThanhtoanAoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TNoitietThanhtoanAoCollection</returns>
		public TNoitietThanhtoanAoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TNoitietThanhtoanAo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_NOITIET_THANHTOAN_AO table.
	/// </summary>
	[Serializable]
	public partial class TNoitietThanhtoanAo : ActiveRecord<TNoitietThanhtoanAo>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TNoitietThanhtoanAo()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TNoitietThanhtoanAo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TNoitietThanhtoanAo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TNoitietThanhtoanAo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_NOITIET_THANHTOAN_AO", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("T_NOITIET_THANHTOAN_AO",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varPatientCode,int varPatientId,DateTime? varPaymentDate,int? varStaffId,int? varStatus,string varCreatedBy,DateTime? varCreatedDate,DateTime? varModifyDate,string varModifyBy,string varPaymentCode,int? varKieuThanhToan,int? varDaIn,DateTime? varNgayIn,string varNguoiIn,DateTime? varNgayTHop,string varNguoiTHop,int? varTrongGoi,string varMaKieuTtoan,string varIpMacSua,string varIpMacTao,string varIpMaySua,string varIpMayTao,string varLyDoHuy,string varMaKhoaThien,DateTime? varNgayChot,int? varTthaiChuyen,byte? varDaChot)
		{
