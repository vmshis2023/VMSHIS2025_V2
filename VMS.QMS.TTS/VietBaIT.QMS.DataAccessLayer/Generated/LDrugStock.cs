...
{
	/// <summary>
	/// Strongly-typed collection for the LDrugStock class.
	/// </summary>
    [Serializable]
	public partial class LDrugStockCollection : ActiveList<LDrugStock, LDrugStockCollection>
	{	   
		public LDrugStockCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>LDrugStockCollection</returns>
		public LDrugStockCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the L_Drug_Stock table.
	/// </summary>
	[Serializable]
	public partial class LDrugStock : ActiveRecord<LDrugStock>, IActiveRecord
	{
		...
		public LDrugStock(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LDrugStock(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public LDrugStock(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("L_Drug_Stock", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("L_Drug_Stock",schema);
			}
		}
		#endregion
