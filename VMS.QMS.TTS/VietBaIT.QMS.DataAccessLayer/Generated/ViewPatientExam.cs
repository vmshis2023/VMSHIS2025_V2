...
namespace VietBaIT.HISLink.DataAccessLayer{
    /// <summary>
    /// Strongly-typed collection for the ViewPatientExam class.
    /// </summary>
    [Serializable]
    public partial class ViewPatientExamCollection : ReadOnlyList<ViewPatientExam, ViewPatientExamCollection>
    {        
        public ViewPatientExamCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the view_PatientExam view.
    /// </summary>
    [Serializable]
    public partial class ViewPatientExam : ReadOnlyRecord<ViewPatientExam>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("view_PatientExam", TableType.View, DataService.GetInstance("ORM"));
                ...
                colvarMaTinh.DataType = DbType.AnsiString;
                colvarMaTinh.MaxLength = 2;
                colvarMaTinh.AutoIncrement = false;
                colvarMaTinh.IsNullable = true;
                ...
                TableSchema.TableColumn colvarMaDkkcb = new TableSchema.TableColumn(schema);
                colvarMaDkkcb.ColumnName = "MA_DKKCB";
                colvarMaDkkcb.DataType = DbType.AnsiString;
                colvarMaDkkcb.MaxLength = 22;
                colvarMaDkkcb.AutoIncrement = false;
                colvarMaDkkcb.IsNullable = true;
                colvarMaDkkcb.IsPrimaryKey = false;
                colvarMaDkkcb.IsForeignKey = false;
                colvarMaDkkcb.IsReadOnly = false;
                
                schema.Columns.Add(colvarMaDkkcb);
                
                
                BaseSchema = schema;
                //add this schema to the provider
                //so we can query it later
                DataService.Providers["ORM"].AddSchema("view_PatientExam",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewPatientExam()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewPatientExam(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewPatientExam(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewPatientExam(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public bool? KhoaTheBHYT 
	    {
		    get
		    {
			    return GetColumnValue<bool?>("Khoa_TheBHYT");
		    }
            set 
		    {
			    SetColumnValue("Khoa_TheBHYT", value);
            }
        }
        ...
        public string MaDTSSong 
	    {
		    get
		    {
			    return GetColumnValue<string>("MaDT_SSong");
		    }
            set 
		    {
			    SetColumnValue("MaDT_SSong", value);
            }
        }
        ...
        public string MaTinh 
	    {
		    get
		    {
			    return GetColumnValue<string>("MA_TINH");
		    }
            set 
		    {
			    SetColumnValue("MA_TINH", value);
            }
        }
	      
        [XmlAttribute("MaDkkcb")]
        [Bindable(true)]
        public string MaDkkcb 
	    {
		    get
		    {
			    return GetColumnValue<string>("MA_DKKCB");
		    }
            set 
		    {
			    SetColumnValue("MA_DKKCB", value);
            }
        }
	    ...
	    public struct Columns
	    {
            ...
            public static string MaDkkcb = @"MA_DKKCB";
