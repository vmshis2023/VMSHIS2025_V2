...
{
	/// <summary>
	/// Strongly-typed collection for the TPrescriptionDetail class.
	/// </summary>
    [Serializable]
	public partial class TPrescriptionDetailCollection : ActiveList<TPrescriptionDetail, TPrescriptionDetailCollection>
	{	   
		public TPrescriptionDetailCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPrescriptionDetailCollection</returns>
		public TPrescriptionDetailCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPrescriptionDetail o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Prescription_Detail table.
	/// </summary>
	[Serializable]
	public partial class TPrescriptionDetail : ActiveRecord<TPrescriptionDetail>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TPrescriptionDetail()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TPrescriptionDetail(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPrescriptionDetail(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPrescriptionDetail(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Prescription_Detail", TableType.Table, DataService.GetInstance("ORM"));
				...
				colvarSurchargePrice.IsReadOnly = false;
						...
						colvarSurchargePrice.DefaultSetting = @"((0))";
				...
				DataService.Providers["ORM"].AddSchema("T_Prescription_Detail",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int?>(Columns.ComfirmDeposit); }
		...
		/// </summary>
		public static void Insert(int varPresId,int varDrugId,DateTime varExpireDate,int varQuantity,decimal varPrice,decimal? varSurchargePrice,string varSDesc,int? varPaymentStatus,int? varQuantityCancel,int? varIsCancel,string varCancelBy,DateTime? varCancelDate,DateTime? varPaymentDate,byte? varIsPayment,int? varStockId,byte? varHasComfirm,byte? varBhytStatus,short? varThuTuIn,decimal? varGiaBhytCt,decimal? varGiaBnct,string varMaDTuong,int? varPaymentId,byte? varXacNhan,int? varComfirmDeposit,int? varIdGoiDvu,byte? varTrongGoi,string varCachDung,string varChiDanThem,string varDviDung,string varIpMacSua,string varIpMacTao,string varIpMaySua,string varIpMayTao,string varSoLanDung,string varSoLuongDung,DateTime? varNgayTao,string varNguoiTao,byte? varTtChuyen,decimal? varPtramBhyt,int? varSluongLinh,int? varSluongSua)
		{
			TPrescriptionDetail item = new TPrescriptionDetail();
		...
		/// </summary>
		public static void Update(int varPresDetailId,int varPresId,int varDrugId,DateTime varExpireDate,int varQuantity,decimal varPrice,decimal? varSurchargePrice,string varSDesc,int? varPaymentStatus,int? varQuantityCancel,int? varIsCancel,string varCancelBy,DateTime? varCancelDate,DateTime? varPaymentDate,byte? varIsPayment,int? varStockId,byte? varHasComfirm,byte? varBhytStatus,short? varThuTuIn,decimal? varGiaBhytCt,decimal? varGiaBnct,string varMaDTuong,int? varPaymentId,byte? varXacNhan,int? varComfirmDeposit,int? varIdGoiDvu,byte? varTrongGoi,string varCachDung,string varChiDanThem,string varDviDung,string varIpMacSua,string varIpMacTao,string varIpMaySua,string varIpMayTao,string varSoLanDung,string varSoLuongDung,DateTime? varNgayTao,string varNguoiTao,byte? varTtChuyen,decimal? varPtramBhyt,int? varSluongLinh,int? varSluongSua)
		{
			TPrescriptionDetail item = new TPrescriptionDetail();
