...
{
	/// <summary>
	/// Strongly-typed collection for the TRegExamTemp class.
	/// </summary>
    [Serializable]
	public partial class TRegExamTempCollection : ActiveList<TRegExamTemp, TRegExamTempCollection>
	{	   
		public TRegExamTempCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TRegExamTempCollection</returns>
		public TRegExamTempCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TRegExamTemp o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Reg_Exam_temp table.
	/// </summary>
	[Serializable]
	public partial class TRegExamTemp : ActiveRecord<TRegExamTemp>, IActiveRecord
	{
		...
		public TRegExamTemp(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TRegExamTemp(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TRegExamTemp(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Reg_Exam_temp", TableType.Table, DataService.GetInstance("ORM"));
				...
				colvarKhamNgoaigio.DefaultSetting = @"";
				...
				colvarIsNgoaiGio.DefaultSetting = @"";
				...
				DataService.Providers["ORM"].AddSchema("T_Reg_Exam_temp",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(long varRegId,long? varPatientId,string varPatientCode,decimal? varRegFee,byte? varPaymentStatus,DateTime? varRegDate,DateTime? varInputDate,string varUserId,decimal? varSurchargePrice,short? varDepartmentId,short? varDoctorAssignId,byte? varActived,byte? varPrintId,DateTime? varModifyDate,string varModifiedBy,byte? varStatus,int? varExamId,byte? varIsCancel,short? varSoKham,decimal? varGiaBhytCt,decimal? varGiaBnct,DateTime? varPaymentDate,short? varFromDepartmentId,byte? varNoiTru,byte? varXacNhan,int? varPaymentId,short? varIdBsyThien,int? varIdGoiDvu,string varKieuKhambenh,int? varTrongGoi,string varIpMacSua,string varIpMacTao,string varIpMaySua,string varIpMayTao,string varMaKhoaThien,short? varIdPhongChuyen,byte? varIsPayment,DateTime? varNgayChuyenPhong,string varNguoiChuyenPhong,byte? varTtChuyen,byte? varKhamNgoaigio,string varMaPhongStt,byte? varIsNgoaiGio)
		{
