...
namespace VNS.HIS.UI.NGOAITRU
{
   ...
   /// </summary>
    public partial class frm_KCB_DANGKY : Form
    {
        ...
        private void frm_KCB_DANGKY_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sudungsonha)
                {
                    ...
                    lblDiachiBN.Text = "Số nhà/Tổ/Phố:";
                }
            ...
            if (objBenhnhan != null)
            {
                ...
                if (_objLuotkham != null)
                {
                    ...
                    if (THU_VIEN_CHUNG.IsBaoHiem(_objDoituongKcb.IdLoaidoituongKcb) && !string.IsNullOrEmpty(_objLuotkham.MatheBhyt))//Thông tin BHYT
                    {
                        ...
                        txtMaDoituongKCB.Enabled = txtMaDoituongKCB.myCode != "-1";
                        cmdGetBV.Enabled = txtchandoantuyenduoi.Enabled = dt_ngaydt_tuyentruoc_tu.Enabled = dt_ngaydt_tuyentruoc_den.Enabled = txtNoichuyenden.Enabled = chkChuyenVien.Checked;
        ...
        private bool IsValidBhyt()
        {
            ...
            //    return false;
            //}
            if (dtInsToDate.Value.Date < dtpInputDate.Value.Date)
            {
  ...
                {
        ...
        private void ThemLanKham()
        {
            ...
            string msg = "";
            errorProvider1.Clear();
            ActionResult actionResult = _kcbDangky.ThemmoiLuotkham(this.myTrace, objBenhnhan, _objLuotkham, objCongkham,objSokham,
            ...
            switch (actionResult)
            {
                case ActionResult.Success:
                   string newInfor = string.Format("Họ và tên: {0} - ngày sinh: {1} - Giới tính :{2} - Địa chỉ: {3} - Điện thoại: {4} - CCCD: {5} - Người liên hệ : {6} - ĐT liên hệ : {7} - ĐC liên hệ : {8} - Nguồn Gt: {9}@{10} - Đối tác: {11}@{12} - Ghi chú đối tác:{13}"
                    ...
                    if (objCongkham != null)
                    {
                        Utility.GotoNewRowJanus(grdRegExam, KcbDangkyKcb.Columns.IdKham, Utility.sDbnull(objCongkham.IdKham));
            ...
            if (!b_HasKham)
            {
               ...
               // KcbQm objQMS = KcbQm.FetchByID(IdQMS);
                ...
                if (objDichvuKcb != null)
                {
                    ...
                    objCongkham.SttKham = THU_VIEN_CHUNG.LaySothutuKCB(Utility.Int32Dbnull(objDichvuKcb.IdPhongkham, -1));
                    objCongkham.IdCha = -1;
        ...
        private void InsertPatient()
        {
            ...
            errorProvider1.Clear();
            ActionResult actionResult = _kcbDangky.ThemmoiBenhnhan(this.myTrace, objBenhnhan, _objLuotkham, objCongkham, objSokham,
                                                                            Utility.Int32Dbnull(cboKieuKham.Value, -1), ref v_id_kham, ref msg);
        ...
        private void UpdatePatient()
        {
            ...
            ActionResult actionResult = _kcbDangky.UpdateLanKham(this.myTrace, objBenhnhan, _objLuotkham, objCongkham, objSokham,
