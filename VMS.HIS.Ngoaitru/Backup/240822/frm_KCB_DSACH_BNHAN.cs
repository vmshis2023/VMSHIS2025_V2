...
namespace VNS.HIS.UI.NGOAITRU
{
    public partial class frm_KCB_DSACH_BNHAN : BaseForm
    {
            ...
            try
            {
                ...
                m_dtPatient = _KCB_DANGKY.KcbTiepdonTimkiemBenhnhan(theongay ? (chkByDate.Checked ? dtmFrom.Value.ToString("dd/MM/yyyy") : "01/01/1900") : "01/01/1900",
                    theongay ? (chkByDate.Checked ? dtmTo.Value.ToString("dd/MM/yyyy") : "01/01/1900") : "01/01/1900",
                                                     ...
                                                     Utility.sDbnull(txtPatientCode.Text), "",new DateTime(1900,1,1),100, "", globalVariables.MA_KHOA_THIEN, 0, (byte)100, this.Args.Split('-')[0]);
        ...
        void frm__OnActionSuccess(string ma_luotkham,action en_act)
        {
            try
            {
                DataTable dt_temp = _KCB_DANGKY.KcbTiepdonTimkiemBenhnhan("01/01/1900", "01/01/1900", -1, -1, "", -1, ma_luotkham, "", new DateTime(1900, 1, 1), 100, "", globalVariables.MA_KHOA_THIEN, 0, (byte)100, this.Args.Split('-')[0]);
            ...
            try
            {
                ...
                if (objCongkham != null)
                {
                    ...
                    if (objCongkham.TrangthaiThanhtoan >= 1)//Kiểm tra xem cùng đơn giá không
                    {
                        ...
                        if (ChuyenPhongkham.ChuyenPhong(objCongkham.IdKham, Utility.DoTrim(nhaplydohuythanhtoan.ten), objDichvuKCB) == ActionResult.Success)
                        {
