   ...
   /// </summary>
    public partial class frm_KCB_DANGKY : Form
    {
        ...
        void InitEvents()
        {
            ...
            txtLoaiBN._OnShowDataV1 += _OnShowDataV1;// new UCs.AutoCompleteTextbox_Danhmucchung.OnShowData(txtLoaiBN__OnShowData);
        ...
        void cmdThongtuyen_Click(object sender, EventArgs e)
        {
            try
            {
                if (THU_VIEN_CHUNG.IsBaoHiem(_idLoaidoituongKcb) || Utility.sDbnull(txtmathebhyt.Text) == "") return;
                ...
                Utility.Log(this.Name, globalVariables.UserName,
                    string.Format(
                        ...
                        string.Format("{0}{1}", txtNoiDongtrusoKCBBD.Text, txtNoiDKKCBBD.Text),
                        dtInsFromDate.Value.ToString("dd/MM/yyyy"), dtInsToDate.Value.ToString("dd/MM/yyyy")));
            }
        ...
        void chkCapCuu_CheckedChanged(object sender, EventArgs e)
        {
            if (chkCapCuu.Checked)
            {
                ...
                txtMaDoituongKCB.Init(m_dtDoiTuong_KCB, new System.Collections.Generic.List<string> { DmucChung.Columns.Ma, DmucChung.Columns.Ma, DmucChung.Columns.Ten });
            }
            LayLydoVaovien();
        }
        ...
        void chkDungtuyen_CheckedChanged(object sender, EventArgs e)
        {
            if (chkDungtuyen.Checked)
            {
                ...
                if (globalVariables.ACCOUNTCLINIC.Substring(0, 2) == txtNoiDongtrusoKCBBD.Text.Trim() &&
        ...
        void frm_KCB_DANGKY_Shown(object sender, EventArgs e)
        {
            ...
            uiGroupBox3.Enabled = !updateonly;
        }
                    ...
                    if (data.Length > 0)
                    {
                        if (data.EndsWith("$"))
                        {
                                ...
                                (arrayBhyt[7] != null))
                            {
                                ...
                                txtNoiDongtrusoKCBBD.Text = madk.Trim();
                                txtNoiDKKCBBD.Text = macso.Trim();
                                dtInsFromDate.Value = tungay;
        ...
        private bool BHYT_CheckCard_366(TheBHYT objApiTheBhyt, string sthongbao, ref string maketqua, bool sSave)
        {
            ...
            if (objLichSuKcb2018.maKetQua == "000")
            {
                try
                {
                    ...
                    dtInsFromDate.Value = Convert.ToDateTime(objLichSuKcb2018.gtTheTu, cultures);
                    dtInsToDate.Value = Convert.ToDateTime(objLichSuKcb2018.gtTheDen, cultures);
                    ...
                    string noidkkcbtrenthe = string.Format("{0}{1}", txtNoiDongtrusoKCBBD.Text.Trim(), txtNoiDKKCBBD.Text);
                    if (Utility.sDbnull(objLichSuKcb2018.maThe, "") != "")
                    {
                        ...
                        txtNoiDongtrusoKCBBD.Text = Utility.sDbnull(objLichSuKcb2018.maDKBD).Substring(0, 2);
                ...
                else
                {
                    ...
                    if (frm.Chapnhan)
                    {
                        ...
                        if (Utility.sDbnull(objLichSuKcb2018.maThe, "") != "")
                        {
                            ...
                            txtNoiDongtrusoKCBBD.Text = Utility.sDbnull(objLichSuKcb2018.maDKBD).Substring(0, 2);
                            txtNoiDKKCBBD.Text = Utility.sDbnull(objLichSuKcb2018.maDKBD).Substring(2, 3);
                            string noidkkcbtrenthe = string.Format("{0}{1}", txtNoiDongtrusoKCBBD.Text.Trim(),
                                txtNoiDKKCBBD.Text);
                            txtsosobhxh.Text = objLichSuKcb2018.maSoBHXH;
                ...
                else
                {
                    ...
                    if (frm.Chapnhan)
                    {
                        ...
                        if (Utility.sDbnull(objLichSuKcb2018.maTheMoi, "") != "")
                        {
                            ...
                            {
                                txtNoiDongtrusoKCBBD.Text = Utility.sDbnull(objLichSuKcb2018.maDKBDMoi).Substring(0, 2);
                        ...
                        {
                            dtInsFromDate.Value = Convert.ToDateTime(objLichSuKcb2018.gtTheTuMoi, cultures);
                        }
                        if (Utility.sDbnull(objLichSuKcb2018.gtTheDenMoi, "") != "")
                        {
                            dtInsToDate.Value = Convert.ToDateTime(objLichSuKcb2018.gtTheDenMoi, cultures);
                        }
                        if (Utility.sDbnull(objLichSuKcb2018.diaChi, "") != "")
                        {
                            txtDiachi_bhyt.Text = objLichSuKcb2018.diaChi;
        ...
        void chkGiayBHYT_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //    chkTraiTuyen.Checked = false;
            lbldu5nam.Enabled = dtpNgaydu5nam.Enabled = false;
            TinhPtramBhyt();
            if(chkGiayBHYT.Checked)
            {
                chkTraiTuyen.Checked = false;
                lbldu5nam.Enabled = dtpNgaydu5nam.Enabled = true;
        ...
        {
            dt_ngaydt_tuyentruoc_tu.Enabled = dt_ngaydt_tuyentruoc_den.Enabled = txtNoichuyenden.Enabled = chkChuyenVien.Checked;
            cmdGetBV.Enabled = chkChuyenVien.Checked;
            lblChandoantuyenduoi.Visible = txtchandoantuyenduoi.Visible = chkChuyenVien.Checked;
            //Tạm bỏ 2014-12-04
            //LoadClinicCode();
        }
        ...
        private void frm_KCB_DANGKY_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Utility.SetColor(lblDiachiBN, THU_VIEN_CHUNG.Laygiatrithamsohethong("TIEPDON_BATNHAP_DIACHI_BENHNHAN", "1", false) == "1" ? lblHoten.ForeColor : lblMatheBHYT.ForeColor);
            ...
            if (objBenhnhan != null)
            {
                ...
                if (_objLuotkham != null)
                {
                    ...
                    if (Utility.DoTrim(_objLuotkham.NoiGioithieu).Length > 0)
                        txtNguonGthieu.SetCode(_objLuotkham.NoiGioithieu);
                    txtNguonGthieu.RaiseEnterEvents();
                    txtDoitac.SetCode(_objLuotkham.MaDoitac);
                    ...
                    oldinfor = string.Format("Id bệnh nhân: {0} - Mã lượt khám: {1} - Họ và tên: {2} - ngày sinh: {3} - Giới tính :{4} - Địa chỉ: {5} - Điện thoại: {6} - CCCD: {7} - Người liên hệ : {8} - ĐT liên hệ : {9} - ĐC liên hệ : {10} - Nguồn Gt: {11}@{12} - Đối tác: {13}@{14}- trạng thái cấp cứu: {15} - Thu tiền khám sau:{16}"
                      , _objLuotkham.IdBenhnhan, _objLuotkham.MaLuotkham, txtTEN_BN.Text, dtpBOD.Text, cboPatientSex.Text, txtDiachi.Text, txtSDT.Text, txtCMT.Text, txtNguoiLienhe.Text, txtSDTLienhe.Text, autotxtdiachilienhe.Text, txtNguonGthieu.myCode, txtNguonGthieu.Text, txtDoitac.MyCode, txtDoitac.Text, chkCapCuu.Checked.ToString(), chkThutienkhamsau.Checked.ToString());
                    _allowAgeChanged = true;
                    ...
                    if (!string.IsNullOrEmpty(_objLuotkham.MatheBhyt))//Thông tin BHYT
                    {
                      ...
                      //  txtOthu4.TextChanged -= new EventHandler(txtOthu4_TextChanged);
                       ...
                       // txtOthu5.TextChanged -= new EventHandler(txtOthu5_TextChanged);
                        ...
                        txtMaDoituongKCB.SetCode(_objLuotkham.MaDoituongKcbBhyt);
        ...
        private bool IsValidTheBhyt()
        {
            ...
            {
                string maDiachinh = THU_VIEN_CHUNG.Laygiatrithamsohethong("KCB_DANGKY_CACHXACDINH_NOIDKKCBBD","1", true) == "0" ? txtNoiphattheBHYT.Text : txtNoiDongtrusoKCBBD.Text;
        ...
        {
            string SoBHYT = string.Format("{0}{1}{2}", Utility.sDbnull(txtmathebhyt.Text), txtNoiDongtrusoKCBBD.Text, txtNoiDKKCBBD.Text);
            GetSoBHYT = SoBHYT;
        }
        private string mathe_bhyt_full()
        {
            return string.Format("{0}{1}{2}", Utility.sDbnull(txtmathebhyt.Text), txtNoiDongtrusoKCBBD.Text, txtNoiDKKCBBD.Text);
        ...
        private bool KT_20_Ky_Tu_BHYT(string IdBenhnhan, string sobhyt)
        {
            ...
            if (patientExam != null)
            {
                ...
                if (txtNoiDongtrusoKCBBD.Text.ToUpper() != Utility.sDbnull(patientExam.NoiDongtrusoKcbbd).ToUpper()
               ...
               // lblClinicName.Visible = dataTable.Rows.Count > 0;
                ...
                if (!chkCapCuu.Checked) //Nếu không phải trường hợp cấp cứu
                {
                    ...
                    if (globalVariables.gv_blnThongTuyen)
                    {
                        ...
                        else if (globalVariables.ACCOUNTCLINIC.Substring(0, 2) == txtNoiDongtrusoKCBBD.Text.Trim() &&
                        ...
                        else if (globalVariables.ACCOUNTCLINIC.Substring(0, 2) != txtNoiDongtrusoKCBBD.Text.Trim())
                        {
                            ...
                            {
                                chkTraiTuyen.Checked = !(THU_VIEN_CHUNG.KiemtraDungtuyenTraituyen(txtNoiDongtrusoKCBBD.Text.Trim() + txtNoiDKKCBBD.Text.Trim()) ||
                                                       (!THU_VIEN_CHUNG.KiemtraDungtuyenTraituyen(txtNoiDongtrusoKCBBD.Text.Trim() + txtNoiDKKCBBD.Text.Trim()) && chkChuyenVien.Checked));
                            }
                            chkThongtuyen.Checked = false;
                ...
                else //Nếu là BN cấp cứu
                {
                    if (globalVariables.gv_intBHYT_TUDONGCHECKTRAITUYEN == 1)
                        //Nếu có chế độ tự động kiểm tra trái tuyến đúng tuyến
                        chkTraiTuyen.Checked =
                            (!(THU_VIEN_CHUNG.KiemtraDungtuyenTraituyen(txtNoiDongtrusoKCBBD.Text.Trim() + txtNoiDKKCBBD.Text.Trim()) ||
                               (!THU_VIEN_CHUNG.KiemtraDungtuyenTraituyen(txtNoiDongtrusoKCBBD.Text.Trim() + txtNoiDKKCBBD.Text.Trim()) &&
        ...
        private void NapThongtinDichvuKcb()
        {
            ...
            try
            {
                ...
                m_dtDanhsachDichvuKCB =THU_VIEN_CHUNG.LayDsach_Dvu_KCB(objecttypeCode,this.Args.Split('-')[1], -1);
            ...
            try
            {
                    ...
                    && !chknothe.Checked )
                {
                    ...
                    if (m_enAct != action.Update
                       ...
                       && globalVariables.ACCOUNTCLINIC.Substring(0, 2) != txtNoiDongtrusoKCBBD.Text.Trim()
                       && globalVariables.ACCOUNTCLINIC.Substring(2, 3) != txtNoiDKKCBBD.Text.Trim())
                    {
                        if (!Utility.AcceptQuestion(string.Format("Nơi đăng ký KCBBĐ: {0}{1} không phải tại bệnh viện (Mã KCBBĐ của viện: {2}). \nBạn có muốn tiếp tục?", txtNoiDongtrusoKCBBD.Text, txtNoiDKKCBBD.Text, globalVariables.ACCOUNTCLINIC), "Nơi ĐK KCB ban đầu không phải tại bệnh viện", true))
                        {
                            return;
                        }
                        else
                            Utility.Log(this.Name, globalVariables.UserName, string.Format("Người dùng {0} đồng ý tiếp đón bệnh nhân {1} có nơi đăng ký KCBBĐ: {2}{3} không phải tại bệnh viện", globalVariables.UserName, txtTEN_BN.Text, txtNoiDongtrusoKCBBD.Text, txtNoiDKKCBBD.Text));
                    }
                }
        ...
        private bool IsValidCard_bak()
        {
            ...
            //objApiTheBhyt.maCSKCB = string.Format("{0}{1}", txtNoiDongtrusoKCBBD.Text.Trim(), txtNoiDKKCBBD.Text.Trim());
        ...
        private bool IsValidData()
        {
            ...
            if (m_enAct==action.Insert && dtCreateDate.Value.ToString("dd/MM/yyyy") != globalVariables.SysDate.ToString("dd/MM/yyyy"))
            {
            ...
            if (THU_VIEN_CHUNG.IsBaoHiem(_objDoituongKcb.IdLoaidoituongKcb))
            {
                ...
                if (Utility.DoTrim(txtMaDTsinhsong.Text) != "" && txtMaDTsinhsong.myCode == "-1")
                {
                    ...
                    errorProvider1.SetError(txtMaDTsinhsong, "Mã đối tượng sinh sống chưa đúng. Mời bạn nhập lại");
            ...
            if (txtNguonGthieu.MyCode == "-1")
            {
                ...
                errorProvider1.SetError(txtNguonGthieu, uiStatusBar1.Panels["MSG"].Text);
                txtNguonGthieu.SelectAll();
                txtNguonGthieu.Focus();
                return false;
            }

            if (PropertyLib._KCBProperties.Hoikhikhongdangkyphongkham)
                if (grdRegExam.GetDataRows().Length <= 0 && cboKieuKham.SelectedIndex < 0 && pnlChonCongkham.Visible)
            ...
            if (grdRegExam.GetDataRows().Length <= 0 && Utility.Int32Dbnull(txtKieuKham.MyID, -1) < 0 && !pnlChonCongkham.Visible)
                if (Utility.AcceptQuestion("Bệnh nhân chưa đăng ký dịch vụ CKB. " +
                                           "Bạn có muốn tạm dừng để đăng ký dịch vụ KCB cho bệnh nhân không?\n Nhấn Yes để tạm dừng việc Ghi và chọn lại phòng khám.", "Cảnh báo", true))
                {
                    txtKieuKham.Focus();
        ...
        /// <summary>
        /// hàm thực hiện viecj kiểm tra thông tin cảu đối tượng bảo hiểm. 20240508 REM các dòng liên quan đến nhập theo từng ô, vì thẻ bhyt   không cố định 15 ký tự như trước mà nó có thể nhập 10 số hoặc 12 
        /// </summary>
        /// <returns></returns>
        private bool IsValidBhyt()
        {
            //if (string.IsNullOrEmpty(txtMaDtuong_BHYT.Text))
            //{
            //    Utility.ShowMsg("Bạn phải nhập Mã đối tượng tham gia BHYT", "Thông báo",
            //                    MessageBoxIcon.Information);
            //    txtMaDtuong_BHYT.Focus();
            //    return false;
            //}
            ...
            //{
            //    Utility.ShowMsg("Bạn phải nhập mã quyền lợi(mức hưởng) BHYT", "Thông báo");
            //    txtMaQuyenloi_BHYT.Focus();
            //    return false;
            //}
            if (string.IsNullOrEmpty(txtNoiDongtrusoKCBBD.Text))
            ...
            //if (string.IsNullOrEmpty(txtNoiphattheBHYT.Text))
            //{
            //    Utility.ShowMsg("Bạn phải nhập mã tỉnh, thành phố trực thuộc Trung ương, nơi cơ sở KCB ban đầu đóng trụ sở", "Thông báo",
            //                    MessageBoxIcon.Information);
            //    txtNoiphattheBHYT.Focus();
            //    return false;
            //}
            if (string.IsNullOrEmpty(txtNoiDKKCBBD.Text))
            {
                Utility.ShowMsg("Bạn phải nhập số thứ tự cơ sở KCB BHYT",
                                "Thông báo");
                txtNoiDKKCBBD.Focus();
                return false;
            }
        ...
        {
            return txtMaDtuong_BHYT.Text.Trim() + txtMaQuyenloi_BHYT.Text.Trim() +
  ...
                {
        ...
        private void CauHinhKCB()
        {
            ...
            if (PropertyLib._KCBProperties != null)
            {
                ...
                grdRegExam.RootTable.Columns["colThanhtoan"].Visible = blnChophepthanhtoan &&
                                                                       (PropertyLib._KCBProperties.Kieuhienthi ==
                                                                        Kieuhienthi.Trenluoi ||
                                                                        PropertyLib._KCBProperties.Kieuhienthi ==
                                                                        Kieuhienthi.Cahai);
                grdRegExam.RootTable.Columns["colDelete"].Visible = PropertyLib._KCBProperties.Kieuhienthi ==
                                                                    Kieuhienthi.Trenluoi ||
                                                                    PropertyLib._KCBProperties.Kieuhienthi ==
                                                                    Kieuhienthi.Cahai;
                grdRegExam.RootTable.Columns["colIn"].Visible = PropertyLib._KCBProperties.Kieuhienthi ==
                                                                Kieuhienthi.Trenluoi ||
                                                                PropertyLib._KCBProperties.Kieuhienthi ==
                                                                Kieuhienthi.Cahai;
        ...
        private void InPhieuKCB()
        {
                ...
                objRegExam = KcbDangkyKcb.FetchByID(reg_id);
                    ...
                    "Thông báo", true))
                {
                    ...
                    switch (actionResult)
                    {
                        case ActionResult.Success:
                            string newInfor = string.Format("Xóa công khám {0} cho người bệnh  Mã khám: {1},Tên: {2}", grdRegExam.GetValue("ten_dichvukcb").ToString(), _objLuotkham.MaLuotkham, objBenhnhan.TenBenhnhan);
            ...
            try
            {
                ...
                if (v_intIdThanhtoan != -1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            case ActionResult.Success:
                                 string newInfor = string.Format("Hủy hanh toán công khám {0} cho người bệnh  Mã khám: {1},Tên: {2}", grdRegExam.GetValue("ten_dichvukcb").ToString(), _objLuotkham.MaLuotkham, objBenhnhan.TenBenhnhan);
        ...
        void Thanhtoan(bool askbeforepayment)
        {
            try
            {
                ...
                string ErrMsg = "";
                ActionResult actionResult = new KCB_THANHTOAN().ThanhtoanChiphiDvuKcb(objPayment, _objLuotkham, Taodulieuthanhtoanchitiet(ref lstRegID).ToList<KcbThanhtoanChitiet>(),null,
                                                   ref Payment_Id, -1, false, false, "", ref TTBN_Chitrathucsu, ref ErrMsg);

                switch (actionResult)
                {
                    case ActionResult.Success:
                        string newInfor = string.Format("Thanh toán công khám {0} cho người bệnh  Mã khám: {1},Tên: {2}", grdRegExam.GetValue("ten_dichvukcb").ToString(), _objLuotkham.MaLuotkham, objBenhnhan.TenBenhnhan);
        ...
        void ThanhtoanSoKham(bool askbeforepayment)
        {
            try
            {
                ...
                string ErrMsg = "";
                ActionResult actionResult = new KCB_THANHTOAN().ThanhtoanChiphiDvuKcb(objPayment, _objLuotkham, new List<KcbThanhtoanChitiet>() { objTemp },null,
                                                    ref Payment_Id, -1, false, false, "", ref TTBN_Chitrathucsu, ref ErrMsg);
        ...
        private void ThemMoiLanKhamVaoLuoi()
        {
            ...
            dr[KcbLuotkham.Columns.MaDoitac] = txtDoitac.MyCode;
            dr["ten_doitac"] = Utility.sDbnull(txtDoitac.Text);
            dr[KcbLuotkham.Columns.NoiGioithieu] = txtNguonGthieu.MyCode;
            dr["ten_nguongioithieu"] = Utility.sDbnull(txtNguonGthieu.Text);
            ...
            switch (actionResult)
            {
                case ActionResult.Success:
                   string newInfor = string.Format("Họ và tên: {0} - ngày sinh: {1} - Giới tính :{2} - Địa chỉ: {3} - Điện thoại: {4} - CCCD: {5} - Người liên hệ : {6} - ĐT liên hệ : {7} - ĐC liên hệ : {8} - Nguồn Gt: {9}@{10} - Đối tác: {11}@{12} - Ghi chú đối tác:{13}"
                        , txtTEN_BN.Text, dtpBOD.Text, cboPatientSex.Text, txtDiachi.Text, txtSDT.Text, txtCMT.Text, txtNguoiLienhe.Text, txtSDTLienhe.Text, autotxtdiachilienhe.Text, txtNguonGthieu.myCode, txtNguonGthieu.Text, txtDoitac.MyCode, txtDoitac.Text,txtGhichudoitac.Text);
            ...
            if (!b_HasKham)
            {
               ...
               // KcbQm objQMS = KcbQm.FetchByID(IdQMS);
                ...
                if (objDichvuKcb != null)
                {
                    ...
                    objRegExam.DonGia = Utility.DecimaltoDbnull(objDichvuKcb.DonGia, 0) * (1 + Utility.DecimaltoDbnull(_objDoituongKcb.MotaThem, 0) / 100);
                    ...
                    objRegExam.IdBenhnhan = Utility.Int32Dbnull(txtIdBenhnhan.Text, -1);
                    ...
                    if (pnlBHYT.Enabled && chkTraiTuyen.Checked && THU_VIEN_CHUNG.Laygiatrithamsohethong("BHYT_TRAITUYENNGOAITRU_GIADICHVU", false) == "1")
                        objRegExam.TuTuc = 1;
                    objRegExam.MaKhoaThuchien = objdepartment.MaKhoaphong;
            ...
            switch (actionResult)
            {
                case ActionResult.Success:
                    ...
                    if (objRegExam != null)
                    {
                        ...
                        //_KCB_QMS.QmsPhongkhamInsert((int)objRegExam.SttKham.Value, objRegExam.MaPhongStt, DateTime.Now, objRegExam.NgayTiepdon.Value, objRegExam.MaLuotkham, objBenhnhan.IdBenhnhan, objBenhnhan.TenBenhnhan, (int)objBenhnhan.NamSinh,Utility.Int32Dbnull( txtTuoi.Text,0), objBenhnhan.GioiTinh, (int)objRegExam.IdKhoakcb, (int)objRegExam.IdPhongkham, objRegExam.IdKham, (int)objRegExam.IdDichvuKcb, objRegExam.TenDichvuKcb);
                        Utility.GotoNewRowJanus(grdRegExam, KcbDangkyKcb.Columns.IdKham, Utility.sDbnull(objRegExam.IdKham));
        ...
        private KcbLuotkham TaoLuotkham()
        {
            try
            {
                ...
                _objLuotkham.NguoiLienhe = txtNguoiLienhe.Text;
                _objLuotkham.DiachiLienhe = autotxtdiachilienhe.Text;
                ...
                _objLuotkham.NoiGioithieu = txtNguonGthieu.myCode;
                ...
                if (txtNguonGthieu.myCode != "-1")
                {
                    DmucChung objNguon = new Select().From(DmucChung.Schema).Where(DmucChung.Columns.Ma).IsEqualTo(txtNguonGthieu.myCode).And(DmucChung.Columns.Loai).IsEqualTo(txtNguonGthieu.LOAI_DANHMUC).ExecuteSingle<DmucChung>();
                    if (objNguon != null)
                    {
                ...
                _objLuotkham.MaDoitac = txtDoitac.MyCode;
                ...
                _objLuotkham.MaDoituongKcbBhyt = txtMaDoituongKCB.myCode;
                DmucDoituongkcb objectType = DmucDoituongkcb.FetchByID(_idDoituongKcb);
                if (objectType != null)
                {
