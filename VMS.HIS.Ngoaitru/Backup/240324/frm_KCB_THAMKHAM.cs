...
namespace VNS.HIS.UI.NGOAITRU
{
    ...
    public partial class frm_KCB_THAMKHAM : Form
    {
        ...
        {
            Utility.SaveValue2Lines(SplitterPath,new List<string>(){ splitContainer1.SplitterDistance.ToString(),splitContainer3.SplitterDistance.ToString()});
        ...
        bool isvalidKhamsobo()
        {
            try
            {
                ...
                if (objkcbdangky.TrangThai == 1 && objLuotkham.TthaiChuyendi == 1)
                {
                        ...
                        else
                        {
                                ...
                                if (savedType == 0)
                                {
                                    KcbChandoanKetluan objCompare = new Select().From(KcbChandoanKetluan.Schema)
                                                         .Where(KcbChandoanKetluan.Columns.IdKham).IsEqualTo(objkcbdangky.IdKham).ExecuteSingle<KcbChandoanKetluan>();
                                    if (objCompare != null &&
                            ...
                            ActionResult act = _KCB_THAMKHAM.LuuHoibenhvaChandoan(_KcbChandoanKetluan, objLuotkham, null, false);
                            if (act == ActionResult.Success)
                            {
                                if (savedType !=1)
                                {
                                    string log_UI = string.Format("mạch={0}, nhiệt độ={1}, Huyết áp={2}, Nhịp thở={3}, Cân nặng={4}, Chiều cao={5},para={6}, quai bị={7}, nhóm máu={8}, BMI={9}, chẩn đoán sơ bộ={10}, chẩn đoán phụ ={11}, Dị ứng thuốc={12}, QTBL={13},TS bệnh={14}",
                                        txtMach.Text, txtNhietDo.Text, txtHa.Text, txtNhipTho.Text, txtCannang.Text, txtChieucao.Text, txtPara.Text, chkQuaibi.Checked.ToString(), txtNhommau.Text, txtibm.Text, txtChanDoan.Text, txtChanDoanKemTheo.Text, txtNhanxet.Text, txtQuatrinhbenhly.Text, txtTiensubenh.Text);
                                    string log_OBJ = "";
        ...
        {
            if (RowCLS == null || objLuotkham == null || objkcbdangky == null) return;
            frm_PdfViewer _PdfViewer = new frm_PdfViewer(0);
            _PdfViewer.txtMaluotkham.Text = "";
            _PdfViewer.txtmachidinh.Text =Utility.sDbnull( RowCLS.Cells[KcbChidinhcl.Columns.MaChidinh].Value);
        ...
        void Them_ChuyenPK(bool chuyenPK)
        {
            try
            {
                ...
                if (objkcbdangky == null || objLuotkham == null || !Utility.isValidGrid(grdList))
                {
                    Utility.ShowMsg(string.Format("Bạn cần chọn bệnh nhân trước khi thực hiện {0} phòng khám",them_chuyen), "Thông báo");
                    return;
                }
                if (objkcbdangky != null && chuyenPK &&  Utility.Byte2Bool(objkcbdangky.DachidinhCls))
                {
                    Utility.ShowMsg("Đã chỉ định cận lâm sàng nên không thể đổi sang phòng khám khác", "Thông báo");
                    return;
                }
                if (objkcbdangky != null && chuyenPK && Utility.Byte2Bool(objkcbdangky.DakeDonthuoc))
                {
                    Utility.ShowMsg("Đã kê đơn nên không thể đổi sang phòng khám khác", "Thông báo");
                    return;
                }
                ////Bỏ theo ý Viet 230615
                if (chuyenPK && objkcbdangky != null && chuyenPK && Utility.Byte2Bool(objkcbdangky.DakeDonthuoc))
                {
                ...
                chuyenPhongkham.dongia = objkcbdangky.TrangthaiThanhtoan > 0 ? objkcbdangky.DonGia : -1;
                chuyenPhongkham.txtPhonghientai.Text = txtPhongkham.Text;
                chuyenPhongkham.txtDvukham.Text = txtTenDvuKham.Text;
                chuyenPhongkham.optChange.Checked = chuyenPK;
        ...
        private void ModifyCommmands()
        {
            try
            {
                ...
                bool _ketthuckham = objkcbdangky != null && objkcbdangky.TrangThai == 1;
                bool khamnoitru = objkcbdangky != null && objkcbdangky.Noitru == 1;
                autoHuongdieutri.Enabled =objLuotkham!=null && objLuotkham.TrangthaiNoitru <= 0;
                pnlother.Enabled =pnlKetluan.Enabled=cmdchucnang.Enabled= this.objLuotkham != null && objkcbdangky != null;
                if (!khamnoitru)//Nếu không phải công khám nội trú
                {
                    cmdUpdatePres.Enabled = cmdDeletePres.Enabled = grdPresDetail.RowCount > 0 && objLuotkham != null && objkcbdangky != null && !_ketthuckham;// && !trang_thaikhoa;
                    //Vật tư
                    cmdXoaphieuVT.Enabled = cmdSuaphieuVT.Enabled = grdVTTH.RowCount > 0 && objLuotkham != null && objkcbdangky != null && !_ketthuckham;//&& !trang_thaikhoa;
                    //Cận lâm sàng
                    cmdUpdate.Enabled = cmdFileAttach.Enabled = cmdDelteAssign.Enabled = grdAssignDetail.RowCount > 0 && objLuotkham != null && objkcbdangky != null && !_ketthuckham;// && !trang_thaikhoa;
                    cmdCreateNewPres.Enabled = cmdInsertAssign.Enabled = cmdThemphieuVT.Enabled = objLuotkham != null && objkcbdangky != null && !_ketthuckham;//&& !trang_thaikhoa;

                }
                else//Là khám nội trú. cho phép kê đơn,chỉ định không quan tâm bệnh nhân đã khóa hay chưa
                {
                    //Đơn thuốc
                    cmdUpdatePres.Enabled = cmdDeletePres.Enabled = grdPresDetail.RowCount > 0 && objLuotkham != null && objkcbdangky != null && !_ketthuckham;
                    //Vật tư
                    cmdXoaphieuVT.Enabled =
                    cmdSuaphieuVT.Enabled = grdVTTH.RowCount > 0 && objLuotkham != null && objkcbdangky != null && !_ketthuckham;
                    //Cận lâm sàng
                    cmdUpdate.Enabled = cmdFileAttach.Enabled = cmdDelteAssign.Enabled = grdAssignDetail.RowCount > 0 && objLuotkham != null && objkcbdangky!=null && !_ketthuckham;
                    cmdCreateNewPres.Enabled = cmdInsertAssign.Enabled = cmdThemphieuVT.Enabled = objLuotkham != null && objkcbdangky != null && !_ketthuckham;
                }
                cmdPrintAssign.Enabled=cmdIntachPhieu.Enabled= objLuotkham != null && objkcbdangky != null && grdAssignDetail.RowCount>0;
                cmdPrintPres.Enabled = objLuotkham != null && objkcbdangky != null && grdPresDetail.RowCount > 0;
                cmdInphieuVT.Enabled = objLuotkham != null && objkcbdangky != null && grdVTTH.RowCount > 0;
                cmdChuyenPhong.Enabled = mnuThemPK.Enabled = mnuChuyenPK.Enabled = objLuotkham != null && objkcbdangky != null && !_ketthuckham && !trangthai_noitru;
                cmdInphieukham.Enabled = grdList.RowCount > 0;
                cmdLuuChandoan_sobo.Enabled = cmdLuuChandoan.Enabled = objLuotkham != null && objkcbdangky != null && objkcbdangky.TrangThai == 0;
                ...
                //if (objLuotkham != null)
                //{
                //    if ((objLuotkham.Locked == 1 || objLuotkham.TrangthaiNoitru >= 1) && objkcbdangky.Noitru==0 )
                //    {
                ...
                //    }
                //}
                cmdNhapVien.Enabled = mnuNhapvien.Enabled =  objkcbdangky != null && objLuotkham != null && !Utility.Byte2Bool( objLuotkham.TthaiChuyendi) && objkcbdangky.TrangThai == 1 && !Utility.Byte2Bool(objkcbdangky.Noitru);
                ...
                cmdNhapVien.Enabled = objkcbdangky != null && objkcbdangky.TrangThai == 1 && objLuotkham != null && objLuotkham.TrangthaiNoitru <=0 && !Utility.Byte2Bool(objLuotkham.TthaiChuyendi) && !Utility.Byte2Bool(objkcbdangky.Noitru);//&& objLuotkham.TrangthaiNoitru == 0);//Không cho nhập viện khi khám chuyên khoa vì bệnh nhân đã vào nội trú
                cmdHuyNhapVien.Enabled = mnuHuynhapvien.Enabled = objLuotkham !=null && objLuotkham.TrangthaiNoitru >= 1 && objLuotkham.IdRavien <= 0;
                cmdInphieuhen.Enabled = cmdInTTDieuTri.Enabled = mnuInphieuhenkham.Enabled = mnuIntomtatdieutri.Enabled =  objkcbdangky != null && objLuotkham!=null && objkcbdangky.TrangThai == 1;
                mnuHuynhapvien.Enabled = cmdHuyNhapVien.Enabled && objkcbdangky != null && objLuotkham != null && !Utility.Byte2Bool(objLuotkham.TthaiChuyendi) && Utility.ByteDbnull(objLuotkham.TrangthaiNoitru) <= 1;
                cmdInKQXN.Enabled = grdKetqua.RowCount > 0 && objkcbdangky != null && objLuotkham != null && grdAssignDetail.RowCount > 0;
                cmdNhapVien.Visible =  mnuNhapvien.Visible =(objLuotkham!=null && objLuotkham.TrangthaiNoitru > 0) || (objkcbdangky!=null && objkcbdangky.TrangThai == 1 && THU_VIEN_CHUNG.Laygiatrithamsohethong("KCB_MAHUONGDIEUTRI_NOITRU", false).ToUpper().Split(',').ToList<string>().Contains(autoHuongdieutri.myCode.ToUpper()));
            }
        ...
        private void Get_DanhmucChung()
        {
            ...
            { 
                txtTrieuChungBD.LOAI_DANHMUC, txtChanDoan.LOAI_DANHMUC, autoTrangthai.LOAI_DANHMUC, autoHuongdieutri.LOAI_DANHMUC ,
                autoKet_Luan.LOAI_DANHMUC, txtNhommau.LOAI_DANHMUC, txtNhanxet.LOAI_DANHMUC, txtChanDoanKemTheo.LOAI_DANHMUC ,
                txtCheDoAn.LOAI_DANHMUC
            }, true);
            txtTrieuChungBD.Init(THU_VIEN_CHUNG.LayDulieuDanhmucChung(dtData, txtTrieuChungBD.LOAI_DANHMUC));
        ...
        void InitQMS()
        {
            ...
            pnlQMS.Height = isEnable ? 67 : 0;
            pnlThongtinBNKCB.Height = isEnable ? 211 : 144;
        }
        ...
        private void txtMaBenhChinh_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (objLuotkham == null || objkcbdangky == null) return;
                hasMorethanOne = true;
                DataRow[] arrDr;
                isLike = false;
            ...
            {
                txtbenhan.Visible = HienthiLamBenhAn();// objkcbdangky.TrangThai != 0 && objLuotkham.TrangthaiNoitru == 0 && Utility.DoTrim(txtMaBenhChinh.Text) != "" && CanBA(Utility.DoTrim(txtMaBenhChinh.Text));
        ...
        {
            return objkcbdangky!=null && objLuotkham!=null &&  objkcbdangky.TrangThai != 0 && objLuotkham.TrangthaiNoitru == 0 && Utility.DoTrim(txtMaBenhChinh.Text) != "" && CanBA(Utility.DoTrim(txtMaBenhChinh.Text));
        }
        /// <summary>
        ...
        public void GetData()
        {
            try
            {
                ...
                if (objLuotkham != null)
                {
                    ...
                    if (!khamcheoCackhoa && globalVariables.MA_KHOA_THIEN != objkcbdangky.MaKhoaThuchien)
                    {
                    ...
                    if (objkcbdangky != null)
                    {
                        ...
                        cmdNhapVien.Enabled = objkcbdangky.TrangThai == 1 && objLuotkham.TrangthaiNoitru == 0;//Không cho nhập viện khi khám chuyên khoa vì bệnh nhân đã vào nội trú
        ...
        private void Huyketthuckham()
        {
            try
            {
                ...
                if (objkcbdangky == null)
                    objkcbdangky = KcbDangkyKcb.FetchByID(Utility.Int32Dbnull(txt_idchidinhphongkham.Text));
                if (Utility.Int16Dbnull(objkcbdangky.IdBacsikham, -1) > 0 && Utility.Int16Dbnull(objkcbdangky.IdBacsikham, -1) != Utility.Int16Dbnull(txtBacsi.MyID, -1))
                {
                    DmucNhanvien objNV = DmucNhanvien.FetchByID(Utility.Int32Dbnull(objkcbdangky.IdBacsikham, -1));
                ...
                if (objkcbdangky != null)
                {
                    objkcbdangky.TrangThai = 0;
                    //objkcbdangky.IdBacsikham = null;
                    objkcbdangky.MarkOld();
                    objkcbdangky.Save();
                }
                if (globalVariables.gv_intIDNhanvien <= 0)
                {
                ...
                {
                    txtBacsi.SetId(Utility.Int16Dbnull(objkcbdangky.IdBacsikham, -1) > 0 ? Utility.Int16Dbnull(objkcbdangky.IdBacsikham, -1) : globalVariables.gv_intIDNhanvien);
                }
        ...
        {
            RowCLS = findthelastChild(grdAssignDetail.CurrentRow);
            ModifyCommmands();
            HienThiChuyenCan();
            ShowResult();
            ResetNhominCLS();
        ...
        void ShowKQXN()
        {
            ...
            if (currRowIdx == -1 || currRowIdx != tempRowIdx)
            {
                ...
                ma_luotkham = Utility.GetValueFromGridColumn(grdAssignDetail, VKcbChidinhcl.Columns.MaLuotkham);
        ...
        private void AddMaBenh(string maBenh, string tenBenh)
        {
            ...
            if (!query.Any())
            {
                ...
                drv[KcbDangkyKcb.Columns.IdKham] = objkcbdangky.IdKham;
                    ...
                    try
                    {
                        ...
                        switch (actionResult)
                        {
                            case ActionResult.Success:
                                ModifyByLockStatus(Utility.ByteDbnull( objkcbdangky.TrangThai,0));//objLuotkham.Locked);
        ...
        private bool IN_TTAT_DTRI_NGOAITRU_2023()
        {
            try
            {
                ...
                string kqxn = "";
                string tomtatcls = "";
                DataSet dsData = _KCB_THAMKHAM.LaythongtinInphieuTtatDtriNgoaitru_2023(objkcbdangky.IdKham, objLuotkham.IdBenhnhan, objLuotkham.MaLuotkham, Utility.ByteDbnull(objBenhnhan.IdGioitinh));
        ...
        void Nhapvien()
        {
            try
            {
                ...
                if (objLuotkham == null || objkcbdangky == null || !Utility.isValidGrid(grdList))
                {
                    Utility.ShowMsg("Bạn chưa chọn người bệnh để thực hiện thăm khám. Đề nghị kiểm tra lại", "Thông Báo");
                    return;
                }
                ...
                frm.id_bskham =Utility.Int16Dbnull( objkcbdangky.IdBacsikham,-1);
        ...
        {
            cmdUnlock.Visible = objLuotkham.TrangthaiNoitru == 0 && Utility.Byte2Bool(objkcbdangky.TrangThai); //objLuotkham.Locked.ToString() == "1";
            cmdUnlock.Enabled = cmdUnlock.Visible &&
                                (Utility.Coquyen("quyen_mokhoa_tatca") || objkcbdangky.IdBacsikham == globalVariables.gv_intIDNhanvien);
                                // objLuotkham.NguoiKetthuc == globalVariables.UserName);
        }
        ...
        private bool IsValidCheckedAssignDetails()
        {
            ...
            {
                Utility.ShowMsg(
                    "Chỉ định bạn chọn đã nhập kết quả hoặc thanh toán nên không thể xóa. Đề nghị kiểm tra lại");
                return false;
            }
        ...
        private void ThemMoiDonThuoc()
        {
            try
            {
               // cmdLuuChandoan.PerformClick();
                ...
                frm.objkcbdangky = this.objkcbdangky;
        ...
        private List<int> GetIdChitiet(int IdDonthuoc, int id_thuoc, decimal don_gia, ref string s)
        {
            ...
            var _data = from p in m_dtPresDetail.AsEnumerable()
                    ...
                    && Utility.Int32Dbnull(p[KcbDonthuocChitiet.Columns.DonGia]) == don_gia
                    select p;
            if (_data.Any())
            {
        ...
        private void PrintPres(int presID, string forcedTitle)
        {
          ...
          //  THU_VIEN_CHUNG.CreateXML(v_dtData, "thamkham_InDonthuocA4.xml");
            ...
            {
                DataTable v_PrintData = v_dtData.Select(string.Format("(ma_tinhchat='{0}' or ma_tinhchat is null) and printed=0", ma_tinhchat)).CopyToDataTable();//Chắc chắn có dữ liệu nên hàm copy ko bị lỗi
        ...
        private string GetDanhsachBenhphu(bool isAll)
        {
            ...
            try
            {
                ...
                if (dt_ICD_PHU.Rows.Count > 0)
                {
                    ...
                    {
                        if (isAll || Utility.Int64Dbnull(row[KcbDangkyKcb.Columns.IdKham], -1) == objkcbdangky.IdKham)//Chỉ lấy mã bệnh phụ theo công khám
                        {
                            if (recordRow > 0)
                                sMaICDPHU.Append(",");
        ...
        private void PerformAction()
        {
            try
            {
                objLuotkham = Utility.getKcbLuotkham(objkcbdangky.IdBenhnhan, objkcbdangky.MaLuotkham);
                ...
                ActionResult actionResult =
                    _KCB_THAMKHAM.UpdateExamInfo(
                        _KcbChandoanKetluan, objkcbdangky, objLuotkham);
                switch (actionResult)
                {
                    case ActionResult.Success:
                        _KcbChandoanKetluan = new Select().From(KcbChandoanKetluan.Schema)
                        ...
                        lblBenhan.Visible = cmdbenhan.Visible = txtbenhan.Visible = HienthiLamBenhAn();//objkcbdangky.TrangThai != 0 && objLuotkham.TrangthaiNoitru == 0 && Utility.DoTrim(txtMaBenhChinh.Text) != "" && CanBA(Utility.DoTrim(txtMaBenhChinh.Text));
                        //   lblBenhan.Visible = cboChonBenhAn.Visible;
                        ...
                        if (THU_VIEN_CHUNG.Laygiatrithamsohethong("NOITRU", "0", false) == "1" && objkcbdangky != null && objLuotkham != null && objkcbdangky.TrangThai == 1 && !Utility.Byte2Bool(objkcbdangky.Noitru) &&
                        ...
                        else if (objkcbdangky != null && objLuotkham != null && objkcbdangky.TrangThai == 1 && !Utility.Byte2Bool(objkcbdangky.Noitru) &&
                           autoHuongdieutri.myCode.ToUpper() == THU_VIEN_CHUNG.Laygiatrithamsohethong("KCB_MAHUONGDIEUTRI_CHUYENVIEN", false).ToUpper() && !Utility.Byte2Bool( objLuotkham.TthaiChuyendi))
                        {
                            if (ChophepChuyenvien())
                            {
                                ...
                                _chuyenvien.idbacsikham =Utility.Int32Dbnull( objkcbdangky.IdBacsikham,-1);
        ...
        private void Inphieudinhduong()
        {
            try
            {
                ...
                decimal BMI = Utility.DecimaltoDbnull(txtibm.Text, 0);
                if (BMI < 18.5m)
                {
                ...
                List<string> Values = new List<string>()
               {
                    objBenhnhan.TenBenhnhan,objLuotkham.MaLuotkham,objBenhnhan.GioiTinh,objBenhnhan.NamSinh.ToString(),objBenhnhan.DiaChi, objLuotkham.Tuoi.ToString(),txtCannang.Text,(Utility.DecimaltoDbnull(txtChieucao.Text, 0) / 100).ToString(),txtibm.Text
               };
                List<string> fieldNames = new List<string>()
            {
        ...
        private void cmdchucnang_Click(object sender, EventArgs e)
        {
            ...
            //mnu.Name = "KHAMLAI";
            //mnu.Enabled = objkcbdangky.TrangThai == 1;
        ...
        private void mnuViewPdfTheoLuotkham_Click(object sender, EventArgs e)
        {
            ...
            frm_PdfViewer _PdfViewer = new frm_PdfViewer(0);
            _PdfViewer.txtMaluotkham.Text = Utility.sDbnull(RowCLS.Cells[KcbChidinhcl.Columns.MaLuotkham].Value);
            _PdfViewer.txtmachidinh.Text = "ALL";
            _PdfViewer.ShowDialog();
        }
        ...
        void InBarcode()
        {
            try
            {
                ...
                if (objluotkham != null)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        FrmBarCodePrint frm = new FrmBarCodePrint();
                        frm.m_dtReport = dt;
                        frm.ShowDialog();
                    }
                }
