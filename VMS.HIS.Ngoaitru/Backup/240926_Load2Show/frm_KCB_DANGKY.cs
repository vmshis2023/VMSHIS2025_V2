...
namespace VNS.HIS.UI.NGOAITRU
{
    ...
    public partial class frm_KCB_DANGKY : Form
    {
        ...
        void SinhMatheBHYT_DoituongNothe()
        {
            try
            {
                if (chknothe.Checked && THU_VIEN_CHUNG.IsBaoHiem(_objDoituongKcb.IdLoaidoituongKcb) && Utility.sDbnull(txtdoituongnothe.MyCode, "") != "")
                {
                    ...
                    txtNoiCaptheBHYT.Text = globalVariables.gv_strNoicapBHYT;
                    txtNoiDKKCBBD.Text = globalVariables.gv_strNoiDKKCBBD;
                }
                else
                {
       ...
       void dtpBOD_TextChanged(object sender, EventArgs e)
        ...
        private bool IsValidTheBhyt_more()
        {
            ...
            if (string.IsNullOrEmpty(txtTenNoidangkyKCBBD.Text))
            {
        ...
        private void LoadClinicCode()
        {
            try
            {
                ...
                if (dataTable.Rows.Count > 0)
                {
                    ...
                    txtTenNoidangkyKCBBD.Text = strClinicName.Trim();
  ...
                {
        ...
        private void ThemMoiLanKhamVaoLuoi()
        {
            ...
            dr[DmucNoiKCBBD.Columns.TenKcbbd] = txtTenNoidangkyKCBBD.Text;// lblClinicName.Text;
        ...
        private KcbLuotkham TaoLuotkham()
        {
            try
            {
                ...
                if (THU_VIEN_CHUNG.IsBaoHiem(_idLoaidoituongKcb))
                {
                    ...
                    _objLuotkham.NoiDongtrusoKcbbd = Utility.sDbnull(txtTenNoidangkyKCBBD.Text, "");
                    _objLuotkham.MaNoicapBhyt = Utility.sDbnull(txtNoiphattheBHYT.Text);
                    _objLuotkham.NoicapBhyt = Utility.sDbnull(txtNoiCaptheBHYT.Text);
