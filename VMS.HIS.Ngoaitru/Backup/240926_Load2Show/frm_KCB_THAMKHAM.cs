    ...
    public partial class frm_KCB_THAMKHAM : Form
    {
        ...
        void Them_ChuyenPK(bool chuyenPK)
        {
            try
            {
                ...
                chuyenPhongkham.objDangkyKcb_Cu = objCongkham;
        ...
        private void ModifyCommmands()
        {
            try
            {
                ...
                cmdNhapVien.Visible =  mnuNhapvien.Visible =(objLuotkham!=null && objLuotkham.TrangthaiNoitru > 0) || (objCongkham!=null && objCongkham.TrangThai == 1 && THU_VIEN_CHUNG.Laygiatrithamsohethong("KCB_MAHUONGDIEUTRI_NOITRU", false).ToUpper().Split(',').ToList<string>().Contains(autoHuongdieutri.myCode.ToUpper()));
            }
            catch (Exception exception)
            {
