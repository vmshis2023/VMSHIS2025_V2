...
namespace VNS.HIS.UI.NGOAITRU
{
   ...
   /// </summary>
    public partial class frm_KCB_DANGKY_240903 : Form
    {
        ...
        public frm_KCB_DANGKY_240903(string Args)
        {
            InitializeComponent();
        ...
        void InitEvents()
        {
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frm_KCB_DANGKY_240903_FormClosing);
            this.Load += new System.EventHandler(this.frm_KCB_DANGKY_240903_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frm_KCB_DANGKY_240903_KeyDown);
            this.Shown += frm_KCB_DANGKY_240903_Shown;
        ...
        //    chkGiayBHYT.CheckedChanged += chkGiayBHYT_CheckedChanged;
            ...
            //this.KeyUp += frm_KCB_DANGKY_240903_KeyUp;
            ...
            txtMaDoituongKCB._OnEnterMe += TxtMaDoituongKCB__OnEnterMe;
        }

        private void TxtMaDoituongKCB__OnEnterMe()
        {
            lastCode = txtMaDoituongKCB.MyCode;
        }
        ...
        void frm_KCB_DANGKY_240903_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        void chkCapCuu_CheckedChanged(object sender, EventArgs e)
        {
            if (chkCapCuu.Checked)
            {
                ...
                txtMaDoituongKCB.SetCode(lastCode);
            }
            LayLydoVaovien();
        }
        ...
        void frm_KCB_DANGKY_240903_Shown(object sender, EventArgs e)
        {
       ...
       void dtpBOD_TextChanged(object sender, EventArgs e)
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_KCB_DANGKY_240903_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_KCB_DANGKY_240903_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_KCB_DANGKY_240903_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
