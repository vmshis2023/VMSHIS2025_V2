    ...
    public partial class frm_lichsukcb : Form
    {
        ...
        void LoadCongkham()
        {
            try
            {
                ...
                DataTable dtData = _kcbThamkham.KcbLichsuKcbTimkiemphongkham(objLuotkham.MaLuotkham);
        ...
        private void Laythongtinchidinhngoaitru()
        {
            try
            {
                ...
                DataTable m_dtPresDetail = ds.Tables[1].Clone();
        ...
        void NapthongtinDonthuoc_Vtth()
        {
            try
            {
                ...
                DataTable m_dtPresDetail = ds.Tables[0].Clone();
                DataTable m_dtVTTH = ds.Tables[0].Clone();
                //Tạm Rem lại ko gom thuốc,vtth thành 1 đơn nữa. 230524
