...
{
    public partial class frm_KCB_KE_DONTHUOC_TAIQUAY_OLD : Form
    {
        ...
        public frm_KCB_KE_DONTHUOC_TAIQUAY_OLD(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        private void frm_KCB_KE_DONTHUOC_TAIQUAY_OLD_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!isSaved)
            {
                getdata4Save();
        ...
        private void frm_KCB_KE_DONTHUOC_TAIQUAY_OLD_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        int Slton_mausac = 50;
        private void frm_KCB_KE_DONTHUOC_TAIQUAY_OLD_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            base.Load += frm_KCB_KE_DONTHUOC_TAIQUAY_OLD_Load;
            base.KeyDown += frm_KCB_KE_DONTHUOC_TAIQUAY_OLD_KeyDown;
            base.FormClosing += frm_KCB_KE_DONTHUOC_TAIQUAY_OLD_FormClosing;
