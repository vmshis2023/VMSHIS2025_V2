...
{
	/// <summary>
	/// Strongly-typed collection for the QmsTiepdon class.
	/// </summary>
    [Serializable]
	public partial class QmsTiepdonCollection : ActiveList<QmsTiepdon, QmsTiepdonCollection>
	{	   
		public QmsTiepdonCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>QmsTiepdonCollection</returns>
		public QmsTiepdonCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the qms_tiepdon table.
	/// </summary>
	[Serializable]
	public partial class QmsTiepdon : ActiveRecord<QmsTiepdon>, IActiveRecord
	{
		...
		public QmsTiepdon(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public QmsTiepdon(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public QmsTiepdon(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("qms_tiepdon", TableType.Table, DataService.GetInstance("ORM"));
				...
				colvarMucUutien.IsNullable = true;
				...
				DataService.Providers["ORM"].AddSchema("qms_tiepdon",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varId,int? varSoQms,string varLoaiQms,byte? varMucUutien,byte? varUuTien,long? varIdBenhnhan,string varMaLankham,string varMaKhoakcb,string varMaQuay,byte? varTrangThai,DateTime? varNgayTao,bool? varTrangthaiIn,string varMaDoituongKcb,int? varIdKhoakcb,int? varIdPhongkham,int? varIdKieukham,int? varSttKham,int? varIdDichvukcb)
		{
			QmsTiepdon item = new QmsTiepdon();
