...
namespace VMS.QMS.DAL
{
	...
	public partial class QmsGoiLoa : ActiveRecord<QmsGoiLoa>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varSoKham,string varQuayGoi,string varMayGoi,string varMaKhoa,byte? varTrangThai,string varNguoiTao,DateTime? varNgayTao,string varMayTao,string varLoaGoi,string varNoiDung,byte? varLoaiQms)
		{
		...
		/// </summary>
		public static void Update(int varId,string varSoKham,string varQuayGoi,string varMayGoi,string varMaKhoa,byte? varTrangThai,string varNguoiTao,DateTime? varNgayTao,string varMayTao,string varLoaGoi,string varNoiDung,byte? varLoaiQms)
		{
			QmsGoiLoa item = new QmsGoiLoa();
