	...
	public partial class KcbDanhsachBenhnhan : ActiveRecord<KcbDanhsachBenhnhan>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarKieuBenhnhan.DefaultSetting = @"";
				colvarKieuBenhnhan.ForeignKeyTableName = "";
				...
				colvarSoTiemchungQg.DefaultSetting = @"";
				colvarSoTiemchungQg.ForeignKeyTableName = "";
				...
				colvarLastNoigioithieu.MaxLength = 50;
				colvarLastNoigioithieu.AutoIncrement = false;
				colvarLastNoigioithieu.IsNullable = true;
				colvarLastNoigioithieu.IsPrimaryKey = false;
				colvarLastNoigioithieu.IsForeignKey = false;
				colvarLastNoigioithieu.IsReadOnly = false;
				colvarLastNoigioithieu.DefaultSetting = @"";
				colvarLastNoigioithieu.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLastNoigioithieu);
				
				TableSchema.TableColumn colvarFirstNoigioithieu = new TableSchema.TableColumn(schema);
				colvarFirstNoigioithieu.ColumnName = "First_Noigioithieu";
				colvarFirstNoigioithieu.DataType = DbType.String;
				colvarFirstNoigioithieu.MaxLength = 50;
				colvarFirstNoigioithieu.AutoIncrement = false;
				colvarFirstNoigioithieu.IsNullable = true;
				colvarFirstNoigioithieu.IsPrimaryKey = false;
				colvarFirstNoigioithieu.IsForeignKey = false;
				colvarFirstNoigioithieu.IsReadOnly = false;
				colvarFirstNoigioithieu.DefaultSetting = @"";
				colvarFirstNoigioithieu.ForeignKeyTableName = "";
				schema.Columns.Add(colvarFirstNoigioithieu);
				...
				colvarMasoThue.ColumnName = "maso_thue";
				colvarMasoThue.DataType = DbType.String;
				colvarMasoThue.MaxLength = 30;
		...
		{
			get { return GetColumnValue<byte?>(Columns.KieuBenhnhan); }
			set { SetColumnValue(Columns.KieuBenhnhan, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.SoTiemchungQg); }
			set { SetColumnValue(Columns.SoTiemchungQg, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.LastNoigioithieu); }
			set { SetColumnValue(Columns.LastNoigioithieu, value); }
		}
		  
		[XmlAttribute("FirstNoigioithieu")]
		[Bindable(true)]
		public string FirstNoigioithieu 
		{
			get { return GetColumnValue<string>(Columns.FirstNoigioithieu); }
			set { SetColumnValue(Columns.FirstNoigioithieu, value); }
		}
		...
		public static void Insert(string varTenBenhnhan,string varDiaChi,string varMaTinhThanhpho,string varMaQuanhuyen,DateTime? varNgaySinh,short? varNamSinh,byte? varIdGioitinh,string varGioiTinh,string varNgheNghiep,string varCoQuan,string varCmt,string varMaQuocgia,string varDienThoai,string varEmail,DateTime varNgayTiepdon,string varNguoiTiepdon,string varDanToc,string varTonGiao,DateTime? varNgaySua,DateTime? varNgayTao,string varNguoiSua,string varNguoiTao,string varDiachiBhyt,string varNguonGoc,byte? varKieuBenhnhan,byte? varMacDinh,string varIpMaytao,string varIpMaysua,string varTenMaytao,string varTenMaysua,string varDiachiLienhe,string varDienthoaiLienhe,string varFax,string varNguoiLienhe,string varSoTiemchungQg,string varLastActionName,string varChucVu,string varMaBenhnhan,string varSoLo,string varLastNoigioithieu,string varFirstNoigioithieu,string varCanhBao,string varSonhaDuongpho,string varMaXaphuong,string varNhomMau,string varMasoThue)
		{
			...
			item.KieuBenhnhan = varKieuBenhnhan;
			...
			item.SoTiemchungQg = varSoTiemchungQg;
        ...
        public static TableSchema.TableColumn KieuBenhnhanColumn
        {
        ...
        public static TableSchema.TableColumn SoTiemchungQgColumn
        {
