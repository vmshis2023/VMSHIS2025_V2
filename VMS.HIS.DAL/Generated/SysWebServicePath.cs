...
namespace VMS.HIS.DAL
{
	...
	public partial class SysWebServicePath : ActiveRecord<SysWebServicePath>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varWebPathCode,string varMaCoSo,string varWebPathName)
		{
		...
		/// </summary>
		public static void Update(string varWebPathCode,string varMaCoSo,string varWebPathName)
		{
			SysWebServicePath item = new SysWebServicePath();
