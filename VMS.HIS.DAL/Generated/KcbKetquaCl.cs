	...
	public partial class KcbKetquaCl : ActiveRecord<KcbKetquaCl>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarTenThongso.MaxLength = 255;
		...
		/// </summary>
		public static void Insert(long varIdBenhnhan,string varMaLuotkham,string varMaChidinh,string varMaBenhpham,long varIdChidinh,long varIdChitietchidinh,int varIdDichvu,int varIdDichvuchitiet,long? varIdLab,long? varIdChitietLab,string varBarcode,int? varSttIn,string varKetQua,string varBtNu,string varBtNam,string varTenDonvitinh,string varTenThongso,string varTenKq,int? varLoaiKq,int? varChophepHienthi,int? varChophepIn,string varMotaThem,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua,byte? varTrangThai,string varNguoiXacnhan,DateTime? varNgayXacnhan,string varIpMaytao,string varIpMaysua,string varTenMaytao,string varTenMaysua)
		{
