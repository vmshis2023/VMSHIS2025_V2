...
namespace VMS.HIS.DAL
{
	...
	public partial class TThuockho : ActiveRecord<TThuockho>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int varIdKho,int varIdThuoc,DateTime varNgayHethan,decimal varGiaNhap,decimal varGiaBan,decimal varSoLuong,decimal varVat,string varSoLo,string varMaNhacungcap,int? varSttBan,long? varIdChuyen,DateTime? varNgayNhap,decimal? varGiaBhyt,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,byte? varChophepKetutruc,byte? varChophepKedon,string varKieuThuocvattu,string varSoDky,string varSoQdinhthau,long? varIdPhieu,long? varIdQdinh)
		{
