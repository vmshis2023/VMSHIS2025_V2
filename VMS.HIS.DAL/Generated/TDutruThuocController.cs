...
namespace VMS.HIS.DAL
{
    ...
    public partial class TDutruThuocController
    {
        ...
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(int IdThuoc,short IdKho,string KieuThuocVt,short IdKhonhan,int IdThuockho)
        {
            Query qry = new Query(TDutruThuoc.Schema);
            qry.QueryType = QueryType.Delete;
            qry.AddWhere("IdThuoc", IdThuoc).AND("IdKho", IdKho).AND("KieuThuocVt", KieuThuocVt).AND("IdKhonhan", IdKhonhan).AND("IdThuockho", IdThuockho);
            qry.Execute();
            return (true);
        }        
	    ...
	    public void Insert(int IdThuoc,short IdKho,string KieuThuocVt,int? SoluongDutru,short IdKhonhan,int IdThuockho,string NguoiTao,DateTime? NgayTao,string NguoiSua,DateTime? NgaySua)
	    {
	    ...
	    public void Update(int IdThuoc,short IdKho,string KieuThuocVt,int? SoluongDutru,short IdKhonhan,int IdThuockho,string NguoiTao,DateTime? NgayTao,string NguoiSua,DateTime? NgaySua)
	    {
		    TDutruThuoc item = new TDutruThuoc();
	        item.MarkOld();
	        item.IsLoaded = true;
