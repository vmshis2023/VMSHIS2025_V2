...
{
    /// <summary>
    /// Controller class for emr_ba_namkhoa
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class EmrBaNamkhoaController
    {
        // Preload our schema..
        EmrBaNamkhoa thisSchemaLoad = new EmrBaNamkhoa();
        ...
        public EmrBaNamkhoaCollection FetchAll()
        {
            EmrBaNamkhoaCollection coll = new EmrBaNamkhoaCollection();
            Query qry = new Query(EmrBaNamkhoa.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaNamkhoaCollection FetchByID(object IdBa)
        {
            EmrBaNamkhoaCollection coll = new EmrBaNamkhoaCollection().Where("id_ba", IdBa).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaNamkhoaCollection FetchByQuery(Query qry)
        {
            EmrBaNamkhoaCollection coll = new EmrBaNamkhoaCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (EmrBaNamkhoa.Delete(IdBa) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object IdBa)
        {
            return (EmrBaNamkhoa.Destroy(IdBa) == 1);
        }
