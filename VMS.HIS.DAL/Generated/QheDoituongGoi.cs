...
{
	/// <summary>
	/// Strongly-typed collection for the QheDoituongGoi class.
	/// </summary>
    [Serializable]
	public partial class QheDoituongGoiCollection : ActiveList<QheDoituongGoi, QheDoituongGoiCollection>
	{	   
		public QheDoituongGoiCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>QheDoituongGoiCollection</returns>
		public QheDoituongGoiCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                QheDoituongGoi o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the qhe_doituong_goi table.
	/// </summary>
	[Serializable]
	public partial class QheDoituongGoi : ActiveRecord<QheDoituongGoi>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public QheDoituongGoi()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public QheDoituongGoi(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public QheDoituongGoi(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public QheDoituongGoi(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("qhe_doituong_goi", TableType.Table, DataService.GetInstance("ORM"));
				...
				colvarIdBogia.AutoIncrement = false;
				colvarIdBogia.IsNullable = true;
				colvarIdBogia.IsPrimaryKey = false;
				...
				DataService.Providers["ORM"].AddSchema("qhe_doituong_goi",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(short varIdDoituongKcb,int varIdGoi,decimal? varTyleGiam,byte varKieuGiamgia,decimal? varTyleTt,decimal? varDonGia,decimal? varPhuthuDungtuyen,int? varIdLoaidoituongKcb,decimal? varPhuthuTraituyen,string varMaDoituongKcb,DateTime? varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua,string varMaKhoaThuchien,int? varIdBogia,DateTime? varNgayBatdau,DateTime? varNgayKetthuc,string varMotaThem)
		{
		...
		/// </summary>
		public static void Update(int varIdQuanhe,short varIdDoituongKcb,int varIdGoi,decimal? varTyleGiam,byte varKieuGiamgia,decimal? varTyleTt,decimal? varDonGia,decimal? varPhuthuDungtuyen,int? varIdLoaidoituongKcb,decimal? varPhuthuTraituyen,string varMaDoituongKcb,DateTime? varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua,string varMaKhoaThuchien,int? varIdBogia,DateTime? varNgayBatdau,DateTime? varNgayKetthuc,string varMotaThem)
		{
			QheDoituongGoi item = new QheDoituongGoi();
