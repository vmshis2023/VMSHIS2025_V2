	...
	public partial class TPhieuNhapxuatthuoc : ActiveRecord<TPhieuNhapxuatthuoc>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarLastActionName.MaxLength = 255;
				...
				TableSchema.TableColumn colvarTrongThau = new TableSchema.TableColumn(schema);
				colvarTrongThau.ColumnName = "trong_thau";
				colvarTrongThau.DataType = DbType.Byte;
				colvarTrongThau.MaxLength = 0;
				colvarTrongThau.AutoIncrement = false;
				colvarTrongThau.IsNullable = true;
				colvarTrongThau.IsPrimaryKey = false;
				colvarTrongThau.IsForeignKey = false;
				colvarTrongThau.IsReadOnly = false;
				
						colvarTrongThau.DefaultSetting = @"((0))";
				colvarTrongThau.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTrongThau);
		...
		[XmlAttribute("TrongThau")]
		[Bindable(true)]
		public byte? TrongThau 
		{
			get { return GetColumnValue<byte?>(Columns.TrongThau); }
			set { SetColumnValue(Columns.TrongThau, value); }
		}
		...
		/// </summary>
		public static void Update(long varIdPhieu,string varMaPhieu,string varSoHoadon,DateTime varNgayHoadon,short? varIdKhonhap,short? varIdKhoxuat,decimal? varVat,string varMaNhacungcap,string varMotaThem,string varNguoiGiao,string varNguoiNhan,string varNguoiHuy,short? varIdNhanvien,byte? varSttHthi,byte? varTrangThai,DateTime? varNgayTao,string varNguoiTao,string varNguoiSua,DateTime? varNgaySua,decimal? varTongTien,byte? varLoaiPhieu,string varTenLoaiphieu,short? varIdNhanvienXacnhan,string varNguoiXacnhan,DateTime? varNgayXacnhan,short? varIdKhoalinh,string varKieuThuocvattu,string varSoChungtuKemtheo,byte? varPhieuVay,string varTkNo,string varTkCo,byte? varDuTru,string varHoidongThanhly,string varDiadiemThanhly,string varYkienDexuat,DateTime? varThoigianThanhlyTu,DateTime? varThoigianThanhlyDen,byte? varNoiTru,string varLastActionName,DateTime? varNgayLap,byte? varTrongThau)
		{
			TPhieuNhapxuatthuoc item = new TPhieuNhapxuatthuoc();
        ...
        public static TableSchema.TableColumn TrongThauColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string TrongThau = @"trong_thau";
