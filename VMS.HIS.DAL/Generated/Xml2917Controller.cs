...
namespace VMS.HIS.DAL
{
    ...
    public partial class Xml2917Controller
    {
	    ...
	    public void Update(string MaLk,int? Stt,string MaThuoc,string MaNhom,string TenThuoc,string DonViTinh,string HamLuong,string DuongDung,string LieuDung,string SoDangKy,double? SoLuong,decimal? DonGia,int? TyleTt,decimal? ThanhTien,string MaKhoa,string MaBacSi,string MaBenh,string NgayYl,int? MaPttt,string TtThau,int? PhamVi,decimal? MucHuong,decimal? TNguonkhac,decimal? TBntt,decimal? TBhtt,decimal? TBncct,decimal? TNgoaids,long IdXML2)
	    {
		    Xml2917 item = new Xml2917();
	        item.MarkOld();
	        item.IsLoaded = true;
