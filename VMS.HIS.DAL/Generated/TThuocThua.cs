	...
	public partial class TThuocThua : ActiveRecord<TThuocThua>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarSoluongThua.DataType = DbType.Decimal;
		...
		[Bindable(true)]
		public decimal SoluongThua 
		{
			get { return GetColumnValue<decimal>(Columns.SoluongThua); }
		...
		/// </summary>
		public static void Insert(int varIdKho,int varIdThuoc,long varIdDonthuoc,long varIdChitietDonthuoc,decimal varSoluongThua)
		{
		...
		/// </summary>
		public static void Update(int varIdKho,int varIdThuoc,long varIdDonthuoc,long varIdChitietDonthuoc,decimal varSoluongThua)
		{
			TThuocThua item = new TThuocThua();
