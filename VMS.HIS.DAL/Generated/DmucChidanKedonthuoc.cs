...
namespace VMS.HIS.DAL
{
	...
	public partial class DmucChidanKedonthuoc : ActiveRecord<DmucChidanKedonthuoc>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(short varIdBacsi,int varIdThuoc,int varSoLuong,string varSoluongDung,string varSolanDung,string varCachDung,string varChidanThem,DateTime? varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua)
		{
		...
		/// </summary>
		public static void Update(long varId,short varIdBacsi,int varIdThuoc,int varSoLuong,string varSoluongDung,string varSolanDung,string varCachDung,string varChidanThem,DateTime? varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua)
		{
			DmucChidanKedonthuoc item = new DmucChidanKedonthuoc();
