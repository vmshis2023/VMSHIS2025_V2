...
{
	/// <summary>
	/// Strongly-typed collection for the TDsachHoidong class.
	/// </summary>
    [Serializable]
	public partial class TDsachHoidongCollection : ActiveList<TDsachHoidong, TDsachHoidongCollection>
	{	   
		public TDsachHoidongCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TDsachHoidongCollection</returns>
		public TDsachHoidongCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TDsachHoidong o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the t_dsach_hoidong table.
	/// </summary>
	[Serializable]
	public partial class TDsachHoidong : ActiveRecord<TDsachHoidong>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TDsachHoidong()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TDsachHoidong(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TDsachHoidong(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TDsachHoidong(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("t_dsach_hoidong", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("t_dsach_hoidong",schema);
			}
		}
		#endregion
		...
		{
			TDsachHoidong item = new TDsachHoidong();
