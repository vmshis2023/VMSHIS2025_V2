	...
	public partial class DmucChung : ActiveRecord<DmucChung>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarPhanloai = new TableSchema.TableColumn(schema);
				colvarPhanloai.ColumnName = "PHANLOAI";
				colvarPhanloai.DataType = DbType.String;
				colvarPhanloai.MaxLength = 50;
				colvarPhanloai.AutoIncrement = false;
				colvarPhanloai.IsNullable = true;
				colvarPhanloai.IsPrimaryKey = false;
				colvarPhanloai.IsForeignKey = false;
				colvarPhanloai.IsReadOnly = false;
				colvarPhanloai.DefaultSetting = @"";
        ...
        public static TableSchema.TableColumn PhanloaiColumn
        {
