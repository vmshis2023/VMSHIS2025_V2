...
namespace VMS.HIS.DAL
{
	...
	public partial class QheDoituongThuoc : ActiveRecord<QheDoituongThuoc>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int? varIdDoituongKcb,short? varIdLoaithuoc,int varIdThuoc,decimal varTyleGiamgia,string varKieuGiamgia,decimal? varTyleTt,string varMotaThem,decimal varDonGia,decimal? varPhuthuDungtuyen,int varIdLoaidoituongKcb,decimal? varPhuthuTraituyen,string varMaDoituongKcb,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua,string varMaKhoaThuchien,string varKieuThuocvt,decimal? varGiaCu)
		{
		...
		/// </summary>
		public static void Update(int varIdQuanhe,int? varIdDoituongKcb,short? varIdLoaithuoc,int varIdThuoc,decimal varTyleGiamgia,string varKieuGiamgia,decimal? varTyleTt,string varMotaThem,decimal varDonGia,decimal? varPhuthuDungtuyen,int varIdLoaidoituongKcb,decimal? varPhuthuTraituyen,string varMaDoituongKcb,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua,string varMaKhoaThuchien,string varKieuThuocvt,decimal? varGiaCu)
		{
			QheDoituongThuoc item = new QheDoituongThuoc();
