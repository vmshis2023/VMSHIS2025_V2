...
namespace VMS.HIS.DAL
{
	...
	public partial class TPhieuXuatthuocBenhnhanChitiet : ActiveRecord<TPhieuXuatthuocBenhnhanChitiet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long varIdPhieu,short? varIdKho,int varIdThuoc,decimal varSoLuong,decimal varDonGia,decimal varGiaNhap,decimal? varGiaBan,decimal? varGiaBhyt,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,string varSoLo,int varVat,DateTime varNgayHethan,long varIdChitietdonthuoc,long? varIdDonthuoc,string varChiDan,long? varIdThuockho,string varMaNhacungcap,DateTime? varNgayNhap,string varSoDky,string varSoQdinhthau)
		{
		...
		/// </summary>
		public static void Update(long varIdPhieuChitiet,long varIdPhieu,short? varIdKho,int varIdThuoc,decimal varSoLuong,decimal varDonGia,decimal varGiaNhap,decimal? varGiaBan,decimal? varGiaBhyt,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,string varSoLo,int varVat,DateTime varNgayHethan,long varIdChitietdonthuoc,long? varIdDonthuoc,string varChiDan,long? varIdThuockho,string varMaNhacungcap,DateTime? varNgayNhap,string varSoDky,string varSoQdinhthau)
		{
			TPhieuXuatthuocBenhnhanChitiet item = new TPhieuXuatthuocBenhnhanChitiet();
