...
namespace VMS.HIS.DAL
{
	...
	public partial class TBiendongThuoc : ActiveRecord<TBiendongThuoc>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaPhieu,short? varIdKho,int varIdThuoc,DateTime? varNgayHethan,decimal? varSoLuong,decimal? varSluongChia,decimal? varDonGia,decimal? varThanhTien,decimal? varPhuThu,int? varIdPhieuChitiet,int? varIdPhieu,int? varVat,string varSoHoadon,string varMaNhacungcap,byte? varMaLoaiphieu,string varTenLoaiphieu,DateTime? varNgayHoadon,DateTime? varNgayBiendong,short? varIdNhanvien,string varNguoiTao,DateTime? varNgayTao,short? varIdKhoaLinh,decimal? varGiaBan,decimal? varGiaNhap,string varSoLo,long? varIdThuockho,long? varIdChuyen,string varKieuThuocvattu,string varMotaThem,string varSoChungtuKemtheo,byte? varNoitru,byte? varQuayThuoc,decimal? varGiaBhyt,decimal? varGiaBhytCu,decimal? varGiaPhuthuDungtuyen,decimal? varGiaPhuthuTraituyen,byte? varDuTru,DateTime? varNgayNhap,string varKieuBiendong,byte? varThuocVay,long? varIdBenhnhan,short? varIdDoituongKcb,string varMaLuotkham,string varSoDky,string varSoQdinhthau,long? varIdPhieuchi,long? varIdQdinh)
		{
		...
		/// </summary>
		public static void Update(long varIdBiendong,string varMaPhieu,short? varIdKho,int varIdThuoc,DateTime? varNgayHethan,decimal? varSoLuong,decimal? varSluongChia,decimal? varDonGia,decimal? varThanhTien,decimal? varPhuThu,int? varIdPhieuChitiet,int? varIdPhieu,int? varVat,string varSoHoadon,string varMaNhacungcap,byte? varMaLoaiphieu,string varTenLoaiphieu,DateTime? varNgayHoadon,DateTime? varNgayBiendong,short? varIdNhanvien,string varNguoiTao,DateTime? varNgayTao,short? varIdKhoaLinh,decimal? varGiaBan,decimal? varGiaNhap,string varSoLo,long? varIdThuockho,long? varIdChuyen,string varKieuThuocvattu,string varMotaThem,string varSoChungtuKemtheo,byte? varNoitru,byte? varQuayThuoc,decimal? varGiaBhyt,decimal? varGiaBhytCu,decimal? varGiaPhuthuDungtuyen,decimal? varGiaPhuthuTraituyen,byte? varDuTru,DateTime? varNgayNhap,string varKieuBiendong,byte? varThuocVay,long? varIdBenhnhan,short? varIdDoituongKcb,string varMaLuotkham,string varSoDky,string varSoQdinhthau,long? varIdPhieuchi,long? varIdQdinh)
		{
			TBiendongThuoc item = new TBiendongThuoc();
