...
namespace VMS.HIS.DAL
{
    ...
    public partial class Xml3917Controller
    {
	    ...
	    public void Update(string MaLk,int? Stt,string MaDichVu,string MaVatTu,string MaNhom,string TenDichVu,string DonViTinh,decimal? SoLuong,decimal? DonGia,int? TyleTt,decimal? ThanhTien,string MaKhoa,string MaBacSi,string MaBenh,string NgayYl,string NgayKq,int? MaPttt,long IdXML3,string GoiVtyt,string TenVatTu,int? PhamVi,string TtThau,decimal? TTrantt,int? MucHuong,decimal? TNguonkhac,decimal? TBntt,decimal? TBhtt,decimal? TBncct,decimal? TNgoaids,string MaGiuong)
	    {
		    Xml3917 item = new Xml3917();
	        item.MarkOld();
	        item.IsLoaded = true;
