	...
	public partial class TThuocCapphatChitiet : ActiveRecord<TThuocCapphatChitiet>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarIdCtiet.DataType = DbType.Int64;
		...
		public long IdCtiet 
		{
			get { return GetColumnValue<long>(Columns.IdCtiet); }
		...
		/// </summary>
		public static void Insert(long varIdCapphat,int varIdThuoc,decimal varSoLuong)
		{
		...
		/// </summary>
		public static void Update(long varIdCtiet,long varIdCapphat,int varIdThuoc,decimal varSoLuong)
		{
			TThuocCapphatChitiet item = new TThuocCapphatChitiet();
