...
{
	/// <summary>
	/// Strongly-typed collection for the ThuocLichsuTralaithuoctaiquay class.
	/// </summary>
    [Serializable]
	public partial class ThuocLichsuTralaithuoctaiquayCollection : ActiveList<ThuocLichsuTralaithuoctaiquay, ThuocLichsuTralaithuoctaiquayCollection>
	{	   
		public ThuocLichsuTralaithuoctaiquayCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ThuocLichsuTralaithuoctaiquayCollection</returns>
		public ThuocLichsuTralaithuoctaiquayCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ThuocLichsuTralaithuoctaiquay o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the thuoc_lichsu_tralaithuoctaiquay table.
	/// </summary>
	[Serializable]
	public partial class ThuocLichsuTralaithuoctaiquay : ActiveRecord<ThuocLichsuTralaithuoctaiquay>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ThuocLichsuTralaithuoctaiquay()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ThuocLichsuTralaithuoctaiquay(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ThuocLichsuTralaithuoctaiquay(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ThuocLichsuTralaithuoctaiquay(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("thuoc_lichsu_tralaithuoctaiquay", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("thuoc_lichsu_tralaithuoctaiquay",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(long varIdChitietThanhtoan,long varIdChitietThanhtoanGoc,long varIdPhieuchi,byte varIdLoaithanhtoan,int varSoLuong,decimal varDonGia,long varIdDonthuoc,long varIdChitietdonthuoc,int varIdThuoc,string varNguoiTao,DateTime varNgayTao)
		{
			ThuocLichsuTralaithuoctaiquay item = new ThuocLichsuTralaithuoctaiquay();
		...
		/// </summary>
		public static void Update(long varId,long varIdChitietThanhtoan,long varIdChitietThanhtoanGoc,long varIdPhieuchi,byte varIdLoaithanhtoan,int varSoLuong,decimal varDonGia,long varIdDonthuoc,long varIdChitietdonthuoc,int varIdThuoc,string varNguoiTao,DateTime varNgayTao)
		{
			ThuocLichsuTralaithuoctaiquay item = new ThuocLichsuTralaithuoctaiquay();
