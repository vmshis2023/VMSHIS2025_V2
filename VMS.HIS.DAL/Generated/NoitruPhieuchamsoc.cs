...
namespace VMS.HIS.DAL
{
	...
	public partial class NoitruPhieuchamsoc : ActiveRecord<NoitruPhieuchamsoc>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaLuotkham,long varIdBenhnhan,short? varIdKhoa,int? varIdNvien,DateTime? varNgayThuchien,string varGioThuchien,string varDienBien,string varXuTri,string varDanhGia,bool? varTthaiIn,DateTime varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua,bool? varTthaiKyso,string varNguoiKyso,DateTime? varNgayKyso,bool? varTthaiKydientu,string varNguoiKydientu,DateTime? varNgayKydientu)
		{
		...
		/// </summary>
		public static void Update(int varId,string varMaLuotkham,long varIdBenhnhan,short? varIdKhoa,int? varIdNvien,DateTime? varNgayThuchien,string varGioThuchien,string varDienBien,string varXuTri,string varDanhGia,bool? varTthaiIn,DateTime varNgayTao,string varNguoiTao,DateTime? varNgaySua,string varNguoiSua,bool? varTthaiKyso,string varNguoiKyso,DateTime? varNgayKyso,bool? varTthaiKydientu,string varNguoiKydientu,DateTime? varNgayKydientu)
		{
			NoitruPhieuchamsoc item = new NoitruPhieuchamsoc();
