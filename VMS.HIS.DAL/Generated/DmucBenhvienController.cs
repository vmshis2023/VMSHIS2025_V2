...
namespace VMS.HIS.DAL
{
    ...
    public partial class DmucBenhvienController
    {
	    ...
	    public void Insert(string MaBenhvien,string TenBenhvien,string MaThanhpho,short? SttHthi,string Tuyen,string Ghichu,bool? Trangthai)
	    {
	    ...
	    public void Update(int IdBenhvien,string MaBenhvien,string TenBenhvien,string MaThanhpho,short? SttHthi,string Tuyen,string Ghichu,bool? Trangthai)
	    {
		    DmucBenhvien item = new DmucBenhvien();
	        item.MarkOld();
	        item.IsLoaded = true;
