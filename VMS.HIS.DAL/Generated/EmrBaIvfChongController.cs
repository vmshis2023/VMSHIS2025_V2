...
{
    /// <summary>
    /// Controller class for emr_ba_ivf_chong
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class EmrBaIvfChongController
    {
        // Preload our schema..
        EmrBaIvfChong thisSchemaLoad = new EmrBaIvfChong();
        ...
        public EmrBaIvfChongCollection FetchAll()
        {
            EmrBaIvfChongCollection coll = new EmrBaIvfChongCollection();
            Query qry = new Query(EmrBaIvfChong.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaIvfChongCollection FetchByID(object IdBa)
        {
            EmrBaIvfChongCollection coll = new EmrBaIvfChongCollection().Where("id_ba", IdBa).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaIvfChongCollection FetchByQuery(Query qry)
        {
            EmrBaIvfChongCollection coll = new EmrBaIvfChongCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (EmrBaIvfChong.Delete(IdBa) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object IdBa)
        {
            return (EmrBaIvfChong.Destroy(IdBa) == 1);
        }
