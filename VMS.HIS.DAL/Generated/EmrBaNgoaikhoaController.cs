...
{
    /// <summary>
    /// Controller class for emr_ba_ngoaikhoa
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class EmrBaNgoaikhoaController
    {
        // Preload our schema..
        EmrBaNgoaikhoa thisSchemaLoad = new EmrBaNgoaikhoa();
        ...
        public EmrBaNgoaikhoaCollection FetchAll()
        {
            EmrBaNgoaikhoaCollection coll = new EmrBaNgoaikhoaCollection();
            Query qry = new Query(EmrBaNgoaikhoa.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaNgoaikhoaCollection FetchByID(object IdBa)
        {
            EmrBaNgoaikhoaCollection coll = new EmrBaNgoaikhoaCollection().Where("id_ba", IdBa).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaNgoaikhoaCollection FetchByQuery(Query qry)
        {
            EmrBaNgoaikhoaCollection coll = new EmrBaNgoaikhoaCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (EmrBaNgoaikhoa.Delete(IdBa) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object IdBa)
        {
            return (EmrBaNgoaikhoa.Destroy(IdBa) == 1);
        }
