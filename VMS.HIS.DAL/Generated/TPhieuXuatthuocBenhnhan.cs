...
namespace VMS.HIS.DAL
{
	...
	public partial class TPhieuXuatthuocBenhnhan : ActiveRecord<TPhieuXuatthuocBenhnhan>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long? varIdDonthuoc,long? varIdBenhnhan,string varMaLuotkham,string varMaPhieu,DateTime? varNgayXacnhan,DateTime? varNgayChot,long? varIdChot,DateTime? varNgayHuychot,string varNguoiHuychot,string varLydoHuychot,DateTime? varNgayKedon,string varTenBenhnhan,string varTenKhongdau,string varGioiTinh,string varChanDoan,string varMabenhChinh,string varDiaChi,int? varNamSinh,string varMatheBhyt,short? varIdDoituongKcb,string varMaDoituongKcb,int? varIdCapphat,short? varIdNhanvien,short? varIdKhoaChidinh,short? varIdPhongChidinh,short? varIdBacsiKedon,short? varIdKho,byte? varNoitru,string varNguoiPhatthuoc,string varNguoiTao,DateTime? varNgayTao,byte? varLoaiPhieu,string varTenLoaiphieu,byte? varQuayThuoc,string varKieuThuocvattu,long? varIdThanhtoan)
		{
		...
		/// </summary>
		public static void Update(long varIdPhieu,long? varIdDonthuoc,long? varIdBenhnhan,string varMaLuotkham,string varMaPhieu,DateTime? varNgayXacnhan,DateTime? varNgayChot,long? varIdChot,DateTime? varNgayHuychot,string varNguoiHuychot,string varLydoHuychot,DateTime? varNgayKedon,string varTenBenhnhan,string varTenKhongdau,string varGioiTinh,string varChanDoan,string varMabenhChinh,string varDiaChi,int? varNamSinh,string varMatheBhyt,short? varIdDoituongKcb,string varMaDoituongKcb,int? varIdCapphat,short? varIdNhanvien,short? varIdKhoaChidinh,short? varIdPhongChidinh,short? varIdBacsiKedon,short? varIdKho,byte? varNoitru,string varNguoiPhatthuoc,string varNguoiTao,DateTime? varNgayTao,byte? varLoaiPhieu,string varTenLoaiphieu,byte? varQuayThuoc,string varKieuThuocvattu,long? varIdThanhtoan)
		{
			TPhieuXuatthuocBenhnhan item = new TPhieuXuatthuocBenhnhan();
