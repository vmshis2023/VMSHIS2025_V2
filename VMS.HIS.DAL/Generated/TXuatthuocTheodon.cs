	...
	public partial class TXuatthuocTheodon : ActiveRecord<TXuatthuocTheodon>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarIdPhieuXuat.DataType = DbType.Int64;
		...
		{
			get { return GetColumnValue<long>(Columns.IdPhieuXuat); }
		...
		/// </summary>
		public static void Insert(long varIdPhieuXuat,int varIdThuoc,decimal varSoLuong,decimal varDonGia,decimal varPhuThu,decimal varBnhanChitra,decimal varBhytChitra,int? varPtramBhyt,string varChiDan,string varCachDung,string varChidanThem,string varSolanDung,string varSoluongDung,DateTime? varNgayTao,string varNguoiTao,long varIdChitietdonthuoc,long varIdDonthuoc,long varIdThuockho)
		{
		...
		/// </summary>
		public static void Update(long varIdPhieu,long varIdPhieuXuat,int varIdThuoc,decimal varSoLuong,decimal varDonGia,decimal varPhuThu,decimal varBnhanChitra,decimal varBhytChitra,int? varPtramBhyt,string varChiDan,string varCachDung,string varChidanThem,string varSolanDung,string varSoluongDung,DateTime? varNgayTao,string varNguoiTao,long varIdChitietdonthuoc,long varIdDonthuoc,long varIdThuockho)
		{
			TXuatthuocTheodon item = new TXuatthuocTheodon();
