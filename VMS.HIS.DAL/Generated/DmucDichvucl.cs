...
namespace VMS.HIS.DAL
{
	...
	public partial class DmucDichvucl : ActiveRecord<DmucDichvucl>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarCdhaTenphieu.IsReadOnly = false;
						...
						colvarCdhaTenphieu.DefaultSetting = @"(N'Tên phiếu trả kết quả CĐHA')";
				colvarCdhaTenphieu.ForeignKeyTableName = "";
				...
				colvarInTachphieu.IsReadOnly = false;
						...
						colvarInTachphieu.DefaultSetting = @"((0))";
		...
		{
			get { return GetColumnValue<string>(Columns.CdhaTenphieu); }
			set { SetColumnValue(Columns.CdhaTenphieu, value); }
		}
        ...
        public static TableSchema.TableColumn CdhaTenphieuColumn
        {
        ...
        public static TableSchema.TableColumn InTachphieuColumn
        {
