...
namespace VMS.HIS.DAL
{
	...
	public partial class KcbDmucLuotkham : ActiveRecord<KcbDmucLuotkham>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int varStt,string varMaLuotkham,short varNam,byte varTrangThai,byte varLoai,string varUsedBy,DateTime? varStartTime,DateTime? varEndTime,string varUnlockBy,DateTime? varUnlockTime)
		{
		...
		/// </summary>
		public static void Update(int varStt,string varMaLuotkham,short varNam,byte varTrangThai,byte varLoai,string varUsedBy,DateTime? varStartTime,DateTime? varEndTime,string varUnlockBy,DateTime? varUnlockTime)
		{
			KcbDmucLuotkham item = new KcbDmucLuotkham();
