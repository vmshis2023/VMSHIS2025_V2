...
{
    /// <summary>
    /// Controller class for emr_ba_noikhoa
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class EmrBaNoikhoaController
    {
        // Preload our schema..
        EmrBaNoikhoa thisSchemaLoad = new EmrBaNoikhoa();
        ...
        public EmrBaNoikhoaCollection FetchAll()
        {
            EmrBaNoikhoaCollection coll = new EmrBaNoikhoaCollection();
            Query qry = new Query(EmrBaNoikhoa.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaNoikhoaCollection FetchByID(object IdBa)
        {
            EmrBaNoikhoaCollection coll = new EmrBaNoikhoaCollection().Where("id_ba", IdBa).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaNoikhoaCollection FetchByQuery(Query qry)
        {
            EmrBaNoikhoaCollection coll = new EmrBaNoikhoaCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (EmrBaNoikhoa.Delete(IdBa) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object IdBa)
        {
            return (EmrBaNoikhoa.Destroy(IdBa) == 1);
        }
