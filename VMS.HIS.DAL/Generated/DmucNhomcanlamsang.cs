...
namespace VMS.HIS.DAL
{
	...
	public partial class DmucNhomcanlamsang : ActiveRecord<DmucNhomcanlamsang>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaNhom,string varTenNhom,string varMotaThem,string varNguoiTao,DateTime varNgayTao,string varNguoiSua,DateTime? varNgaySua,string varMaLoainhom,byte? varLoaiNhom,byte? varSharedX)
		{
		...
		/// </summary>
		public static void Update(short varId,string varMaNhom,string varTenNhom,string varMotaThem,string varNguoiTao,DateTime varNgayTao,string varNguoiSua,DateTime? varNgaySua,string varMaLoainhom,byte? varLoaiNhom,byte? varSharedX)
		{
			DmucNhomcanlamsang item = new DmucNhomcanlamsang();
