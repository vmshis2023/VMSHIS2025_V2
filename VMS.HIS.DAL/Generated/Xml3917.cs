...
namespace VMS.HIS.DAL
{
	...
	public partial class Xml3917 : ActiveRecord<Xml3917>, IActiveRecord
	{
		...
		/// </summary>
		public static void Update(string varMaLk,int? varStt,string varMaDichVu,string varMaVatTu,string varMaNhom,string varTenDichVu,string varDonViTinh,decimal? varSoLuong,decimal? varDonGia,int? varTyleTt,decimal? varThanhTien,string varMaKhoa,string varMaBacSi,string varMaBenh,string varNgayYl,string varNgayKq,int? varMaPttt,long varIdXML3,string varGoiVtyt,string varTenVatTu,int? varPhamVi,string varTtThau,decimal? varTTrantt,int? varMucHuong,decimal? varTNguonkhac,decimal? varTBntt,decimal? varTBhtt,decimal? varTBncct,decimal? varTNgoaids,string varMaGiuong)
		{
			Xml3917 item = new Xml3917();
