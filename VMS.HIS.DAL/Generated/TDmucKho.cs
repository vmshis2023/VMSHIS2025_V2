	...
	public partial class TDmucKho : ActiveRecord<TDmucKho>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarSongayNhaton.DefaultSetting = @"";
				colvarSongayNhaton.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSongayNhaton);
				
				TableSchema.TableColumn colvarLoaibothuocHethan = new TableSchema.TableColumn(schema);
				colvarLoaibothuocHethan.ColumnName = "loaibothuoc_hethan";
				colvarLoaibothuocHethan.DataType = DbType.Boolean;
				colvarLoaibothuocHethan.MaxLength = 0;
				colvarLoaibothuocHethan.AutoIncrement = false;
				colvarLoaibothuocHethan.IsNullable = true;
				colvarLoaibothuocHethan.IsPrimaryKey = false;
				colvarLoaibothuocHethan.IsForeignKey = false;
				colvarLoaibothuocHethan.IsReadOnly = false;
				colvarLoaibothuocHethan.DefaultSetting = @"";
				colvarLoaibothuocHethan.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLoaibothuocHethan);
				
				TableSchema.TableColumn colvarKhongTinhgia = new TableSchema.TableColumn(schema);
				colvarKhongTinhgia.ColumnName = "khong_tinhgia";
				colvarKhongTinhgia.DataType = DbType.Boolean;
				colvarKhongTinhgia.MaxLength = 0;
				colvarKhongTinhgia.AutoIncrement = false;
				colvarKhongTinhgia.IsNullable = true;
				colvarKhongTinhgia.IsPrimaryKey = false;
				colvarKhongTinhgia.IsForeignKey = false;
				colvarKhongTinhgia.IsReadOnly = false;
				colvarKhongTinhgia.DefaultSetting = @"";
				colvarKhongTinhgia.ForeignKeyTableName = "";
				schema.Columns.Add(colvarKhongTinhgia);
				
				TableSchema.TableColumn colvarCapCuu = new TableSchema.TableColumn(schema);
				colvarCapCuu.ColumnName = "cap_cuu";
				colvarCapCuu.DataType = DbType.Byte;
		...
		[XmlAttribute("LoaibothuocHethan")]
		[Bindable(true)]
		public bool? LoaibothuocHethan 
		{
			get { return GetColumnValue<bool?>(Columns.LoaibothuocHethan); }
			set { SetColumnValue(Columns.LoaibothuocHethan, value); }
		}
		  
		[XmlAttribute("KhongTinhgia")]
		[Bindable(true)]
		public bool? KhongTinhgia 
		{
			get { return GetColumnValue<bool?>(Columns.KhongTinhgia); }
			set { SetColumnValue(Columns.KhongTinhgia, value); }
		}
		...
		public byte? CapCuu 
		{
			get { return GetColumnValue<byte?>(Columns.CapCuu); }
		...
		public static void Insert(string varMaKho,string varTenKho,int? varSttHthi,string varKieuKho,string varKhoThuocVt,short varIdKhoaphong,string varMotaThem,byte? varLaQuaythuoc,byte? varKtraTon,DateTime? varNgaySua,DateTime? varNgayTao,string varNguoiSua,string varNguoiTao,byte? varLaTuthuoc,string varLoaiBnhan,byte? varTrangThai,byte? varTuTuc,byte? varChophepChongia,string varKieuBiendong,byte? varLoaiKho,double? varSongayNhaton,bool? varLoaibothuocHethan,bool? varKhongTinhgia,byte? varCapCuu,string varMaCoso)
		{
			...
			item.LoaibothuocHethan = varLoaibothuocHethan;
			
			item.KhongTinhgia = varKhongTinhgia;
        ...
        public static TableSchema.TableColumn LoaibothuocHethanColumn
        {
        ...
        public static TableSchema.TableColumn KhongTinhgiaColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string LoaibothuocHethan = @"loaibothuoc_hethan";
