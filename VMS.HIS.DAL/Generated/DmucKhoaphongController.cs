...
namespace VMS.HIS.DAL
{
    ...
    public partial class DmucKhoaphongController
    {
	    ...
	    public void Insert(string MaKhoaphong,string TenKhoaphong,short? MaCha,short SttHthi,string MotaThem,decimal? DonGia,decimal? TamUng,string NoitruNgoaitru,byte? LaKhoacapcuu,string KieuKhoaphong,byte? PhongChucnang,string MaDonvitinh,string ChiDan,string MaPhongStt,string MaXml,decimal? SogiuongKehoach,decimal? SogiuongThucte,short? ManTinh,string MaLoaikcb,string BanKham,int? Giuong2015,int? GiuongHstc,int? GiuongHscc,int? Ldlk,int? LienKhoa,string MaCoso,bool? TrangThai,string NguoiTao,DateTime? NgayTao,string NguoiSua,DateTime? NgaySua,int? IdTruongkhoa,byte? HoatdongTheotang,bool? AnhxaBhyt)
	    {
            ...
            item.SogiuongKehoach = SogiuongKehoach;
            
            item.SogiuongThucte = SogiuongThucte;
            
            item.ManTinh = ManTinh;
            
            item.MaLoaikcb = MaLoaikcb;
            
            item.BanKham = BanKham;
            
            item.Giuong2015 = Giuong2015;
            
            item.GiuongHstc = GiuongHstc;
            
            item.GiuongHscc = GiuongHscc;
            
            item.Ldlk = Ldlk;
            
            item.LienKhoa = LienKhoa;
            ...
            item.HoatdongTheotang = HoatdongTheotang;
