...
{
    /// <summary>
    /// Controller class for emr_ba_bak
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class EmrBaBakController
    {
        // Preload our schema..
        EmrBaBak thisSchemaLoad = new EmrBaBak();
        ...
        public EmrBaBakCollection FetchAll()
        {
            EmrBaBakCollection coll = new EmrBaBakCollection();
            Query qry = new Query(EmrBaBak.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaBakCollection FetchByID(object IdBa)
        {
            EmrBaBakCollection coll = new EmrBaBakCollection().Where("id_ba", IdBa).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaBakCollection FetchByQuery(Query qry)
        {
            EmrBaBakCollection coll = new EmrBaBakCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (EmrBaBak.Delete(IdBa) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object IdBa)
        {
            return (EmrBaBak.Destroy(IdBa) == 1);
        }
