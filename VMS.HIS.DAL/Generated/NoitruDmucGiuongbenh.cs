	...
	public partial class NoitruDmucGiuongbenh : ActiveRecord<NoitruDmucGiuongbenh>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarThueNguyenbuong = new TableSchema.TableColumn(schema);
				colvarThueNguyenbuong.ColumnName = "thue_nguyenbuong";
				colvarThueNguyenbuong.DataType = DbType.Boolean;
				colvarThueNguyenbuong.MaxLength = 0;
				colvarThueNguyenbuong.AutoIncrement = false;
				colvarThueNguyenbuong.IsNullable = true;
				colvarThueNguyenbuong.IsPrimaryKey = false;
				colvarThueNguyenbuong.IsForeignKey = false;
				colvarThueNguyenbuong.IsReadOnly = false;
				
						colvarThueNguyenbuong.DefaultSetting = @"((0))";
				colvarThueNguyenbuong.ForeignKeyTableName = "";
				schema.Columns.Add(colvarThueNguyenbuong);
		...
		[XmlAttribute("ThueNguyenbuong")]
		[Bindable(true)]
		public bool? ThueNguyenbuong 
		{
			get { return GetColumnValue<bool?>(Columns.ThueNguyenbuong); }
			set { SetColumnValue(Columns.ThueNguyenbuong, value); }
		}
		...
		/// </summary>
		public static void Insert(string varMaGiuong,string varMaBhyt,string varTenGiuong,string varTenBhyt,short varIdKhoanoitru,short varIdBuong,decimal varGiaDichvu,decimal? varGiaBhyt,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,decimal? varGiaKhac,short varSonguoiToida,string varMotaThem,string varMaDonvitinh,byte? varTrangThai,byte? varTthaiTunguyen,byte? varDangSudung,short? varSttHthi,bool? varThueNguyenbuong)
		{
			...
			item.ThueNguyenbuong = varThueNguyenbuong;
		...
		/// </summary>
		public static void Update(short varIdGiuong,string varMaGiuong,string varMaBhyt,string varTenGiuong,string varTenBhyt,short varIdKhoanoitru,short varIdBuong,decimal varGiaDichvu,decimal? varGiaBhyt,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,decimal? varGiaKhac,short varSonguoiToida,string varMotaThem,string varMaDonvitinh,byte? varTrangThai,byte? varTthaiTunguyen,byte? varDangSudung,short? varSttHthi,bool? varThueNguyenbuong)
		{
			NoitruDmucGiuongbenh item = new NoitruDmucGiuongbenh();
        ...
        public static TableSchema.TableColumn ThueNguyenbuongColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string ThueNguyenbuong = @"thue_nguyenbuong";
