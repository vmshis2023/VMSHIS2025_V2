...
{
	/// <summary>
	/// Strongly-typed collection for the EmrLoaibaGayPhieu class.
	/// </summary>
    [Serializable]
	public partial class EmrLoaibaGayPhieuCollection : ActiveList<EmrLoaibaGayPhieu, EmrLoaibaGayPhieuCollection>
	{	   
		public EmrLoaibaGayPhieuCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>EmrLoaibaGayPhieuCollection</returns>
		public EmrLoaibaGayPhieuCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                EmrLoaibaGayPhieu o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the emr_loaiba_gay_phieu table.
	/// </summary>
	[Serializable]
	public partial class EmrLoaibaGayPhieu : ActiveRecord<EmrLoaibaGayPhieu>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public EmrLoaibaGayPhieu()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public EmrLoaibaGayPhieu(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public EmrLoaibaGayPhieu(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public EmrLoaibaGayPhieu(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("emr_loaiba_gay_phieu", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("emr_loaiba_gay_phieu",schema);
			}
		}
		#endregion
