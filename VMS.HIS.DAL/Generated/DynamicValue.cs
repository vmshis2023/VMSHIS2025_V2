	...
	public partial class DynamicValue : ActiveRecord<DynamicValue>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarGiatri.MaxLength = 1073741823;
		...
		/// </summary>
		public static void Insert(string varMa,string varGiatri,long? varIdChidinhchitiet)
		{
		...
		/// </summary>
		public static void Update(long varId,string varMa,string varGiatri,long? varIdChidinhchitiet)
		{
			DynamicValue item = new DynamicValue();
