	...
	public partial class DmucBenh : ActiveRecord<DmucBenh>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarTenQuocte = new TableSchema.TableColumn(schema);
				colvarTenQuocte.ColumnName = "ten_quocte";
				colvarTenQuocte.DataType = DbType.String;
				colvarTenQuocte.MaxLength = 300;
				colvarTenQuocte.AutoIncrement = false;
				colvarTenQuocte.IsNullable = true;
				colvarTenQuocte.IsPrimaryKey = false;
				colvarTenQuocte.IsForeignKey = false;
				colvarTenQuocte.IsReadOnly = false;
				colvarTenQuocte.DefaultSetting = @"";
				colvarTenQuocte.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTenQuocte);
		...
		[XmlAttribute("TenQuocte")]
		[Bindable(true)]
		public string TenQuocte 
		{
			get { return GetColumnValue<string>(Columns.TenQuocte); }
			set { SetColumnValue(Columns.TenQuocte, value); }
		}
		...
		/// </summary>
		public static void Insert(string varMaBenh,string varMaLoaibenh,string varTenBenh,string varMotaThem,string varViettat,string varTenQuocte)
		{
		...
		/// </summary>
		public static void Update(short varIdBenh,string varMaBenh,string varMaLoaibenh,string varTenBenh,string varMotaThem,string varViettat,string varTenQuocte)
		{
			DmucBenh item = new DmucBenh();
        ...
        public static TableSchema.TableColumn TenQuocteColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string TenQuocte = @"ten_quocte";
