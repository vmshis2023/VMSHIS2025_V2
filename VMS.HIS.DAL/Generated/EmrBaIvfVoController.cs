...
{
    /// <summary>
    /// Controller class for emr_ba_ivf_vo
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class EmrBaIvfVoController
    {
        // Preload our schema..
        EmrBaIvfVo thisSchemaLoad = new EmrBaIvfVo();
        ...
        public EmrBaIvfVoCollection FetchAll()
        {
            EmrBaIvfVoCollection coll = new EmrBaIvfVoCollection();
            Query qry = new Query(EmrBaIvfVo.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaIvfVoCollection FetchByID(object IdBa)
        {
            EmrBaIvfVoCollection coll = new EmrBaIvfVoCollection().Where("id_ba", IdBa).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public EmrBaIvfVoCollection FetchByQuery(Query qry)
        {
            EmrBaIvfVoCollection coll = new EmrBaIvfVoCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (EmrBaIvfVo.Delete(IdBa) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object IdBa)
        {
            return (EmrBaIvfVo.Destroy(IdBa) == 1);
        }
