...
namespace VMS.HIS.DAL
{
    ...
    public partial class NoitruDmucGiuongbenhController
    {
	    ...
	    public void Insert(string MaGiuong,string MaBhyt,string TenGiuong,string TenBhyt,short IdKhoanoitru,short IdBuong,decimal GiaDichvu,decimal? GiaBhyt,decimal? PhuthuDungtuyen,decimal? PhuthuTraituyen,decimal? GiaKhac,short SonguoiToida,string MotaThem,string MaDonvitinh,byte? TrangThai,byte? TthaiTunguyen,byte? DangSudung,short? SttHthi,bool? ThueNguyenbuong)
	    {
            ...
            item.ThueNguyenbuong = ThueNguyenbuong;
